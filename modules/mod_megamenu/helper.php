<?php
/**
* @version		$Id: /depot/hubzero/branches/zooley/modules/mod_mainmenu/helper.php 4 2008-04-15T21:36:59.704872Z nkissebe  $
* @package		Joomla
	...
	function render(&$params, $callback)
	{
		switch ( $params->get( 'menu_style', 'list' ) )
		{
			...
			default :
				...
				$xml = modMegaMenuHelper::getXML($params->get('menutype'), $params, $callback);
				if ($xml) {
 ...
 * @since		1.5
 */
class MegaMenuTree extends JTree
{
	/**
	...
	{
		$this->_params		=& $params;
		$this->_root		= new MegaMenuNode(0, 'ROOT');
	...
	function addNode($item)
	{
		...
		$node = new MegaMenuNode($item->id, $item->name, $item->access, $data);
 ...
 * @since		1.5
 */
class MegaMenuNode extends JNode
{
	/**
	 * Node Title
	 */
