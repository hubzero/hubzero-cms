...
?>
			<div id="xflash-container">
				<!-- Image slideshow -->
               <?php if ($noflash_link) { ?><a href="<?php echo $noflash_link; ?>"><?php } ?><img src="<? echo $noflash_file; ?>" width="<? echo $width; ?>" height="<? echo $height; ?>" id="noflashimg" alt="" /><?php if ($noflash_link) { ?></a><?php } ?>
			</div>
<?php
