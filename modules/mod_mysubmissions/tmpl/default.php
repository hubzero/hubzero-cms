...
?>
	<div class="submission">
		<h4>
			...
			<a class="edit" href="<?php echo JRoute::_('index.php?option=com_contribute&step=1&id=' . $row->id); ?>">
...
?>
				<tr>
					...
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_contribute&step=' . $i . '&amp;id=' . $row->id); ?>">
							<?php echo JText::_('MOD_MYSUBMISSIONS_EDIT'); ?>
						</a>
					</td>
				</tr>
...
?>
		...
		<p class="discrd">
			<a href="<?php echo JRoute::_('index.php?option=com_contribute&task=discard&id=' . $row->id); ?>">
				<?php echo JText::_('MOD_MYSUBMISSIONS_DELETE'); ?>
			</a>
		</p>
		<p class="review">
			<a href="<?php echo JRoute::_('index.php?option=com_contribute&step=' . $laststep . '&id=' . $row->id); ?>">
