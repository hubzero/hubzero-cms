...
// Joomla module
// "Wish Voters"
//    This module displays a list of most active wish voters
//    among wish list owners.
// Wish List component "com_wishlist" REQUIRED
//-------------------------------------------------------------

if (!class_exists('modWishVoters')) {
	class modWishVoters
	{
			private $params;
...
$modwishvoters = new modWishVoters( $params );

require( JModuleHelper::getLayoutPath('mod_wishvoters') );
?>
