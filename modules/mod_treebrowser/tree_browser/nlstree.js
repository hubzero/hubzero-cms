...
function DefRenderer(tId) {
  ...
  this.initRender = function() {
    ...
    this.rat["mn"]=["<table style='width:10%' cellspacing=0 cellpadding=0><tr><td width='0%' nowrap>","</td><td width='0%' nowrap>", "</td><td width='0%' nowrap>","</td><td width='0%' nowrap>", "</td><td width='0%'>", "</td></tr></table>"];
    this.rat["ics"]=ex[2];
    ...
    this.rat["ac"]=["<a class=\"@nstyle\" style='display:block; border-bottom-color:#ffffff;' href=\"javascript:void(0);\" "+ev+" >@capt</a>", "<a class=\"@nstyle\" style='display:block; border-bottom-color:#ffffff;' target='@trg' "+ev+" href=\""];
