	...
	<form action="" method="post">
		<ol>
				...
				<?php if (isset($row['countryorigin'])): ?> 
					<li>
						<?php $country = isset($_POST['countryorigin']) ? $_POST['countryorigin'] : \Hubzero\Geo::ipcountry(JRequest::ip()); ?>
							...
							<div class="indented">
								...
								<?php
									$countries = \Hubzero\Geo::getcountries();
									if (!$countries) {
				...
				<?php if (isset($row['countryresident'])): ?> 
					<li>
						<?php $country = isset($_POST['countryresident']) ? $_POST['countryresident'] : \Hubzero\Geo::ipcountry(JRequest::ip()); ?>
