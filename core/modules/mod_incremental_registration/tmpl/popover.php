        ...
        <ol>
                    ...
                    <ol id="name-inp">
                        <li>
                            <label for="inc_name-first">
                                <span>First:</span>
                                <input type="text" id="inc_name-first" value="<?php if (isset($_POST['name']['first'])) {
                                    echo str_replace('"', '&quot;', $_POST['name']['first']);
                                                                              } ?>" name="name[first]">
                            </label>
                        </li>
                        <li>
                            <label for="inc_name-middle">
                                <span>Middle:</span>
                                <input type="text" id="inc_name-middle" value="<?php if (isset($_POST['name']['middle'])) {
                                    echo str_replace('"', '&quot;', $_POST['name']['middle']);
                                                                               } ?>" name="name[middle]">
                            </label>
                        </li>
                        <li>
                            <label for="inc_name-last">
                                <span>Last:</span>
                                <input type="text" id="inc_name-last" value="<?php if (isset($_POST['name']['last'])) {
                                    echo str_replace('"', '&quot;', $_POST['name']['last']);
                                                                             } ?>" name="name[last]">
                            </label>
                    </li>
                    </ol>
                ...
                <?php if (isset($row['gender'])) : ?>
                    <li>
                        ...
                        <div class="indented">
                            ...
                            <label><input <?php if ($gender == 'male') {
                                echo 'checked="checked" ';
                                          } ?>type="radio" class="option" value="male" name="gender"> Male</label>
                            <label><input <?php if ($gender == 'female') {
                                echo 'checked="checked" ';
                                          } ?>type="radio" class="option" value="female" name="gender"> Female</label>
                            <label><input <?php if ($gender == 'refused') {
                                echo 'checked="checked" ';
                                          } ?>type="radio" class="option" value="refused" name="gender"> Do not wish to reveal</label>
                        </div>
                    </li>
                <?php endif; ?>
                    ...
                    <li>
                        <?php $country = isset($_POST['countryorigin']) ? $_POST['countryorigin'] : \Hubzero\Geocode\Geocode::ipcountry(Request::ip()); ?>
                            ...
                            <div class="indented">
                                ...
                                <?php endif; ?>
                                <label><input type="radio" class="option" name="countryorigin_us" id="corigin_usyes" value="yes" <?php if (strtolower($country) == 'us' || (isset($_POST['countryorigin_us']) && $_POST['countryorigin_us'] == 'yes')) {
                                    echo 'checked="checked"';
                                                                                                                                 } ?> />Yes</label>
                                <label><input type="radio" class="option" name="countryorigin_us" id="corigin_usno" value="no" <?php if (!empty($_POST['countryorigin']) && strtolower($country) != 'us' || (isset($_POST['countryorigin_us']) && $_POST['countryorigin_us'] == 'no')) {
                                    echo 'checked="checked"';
                                                                                                                               } ?> />No</label>
                            </div>
                    ...
                    <li>
                        <?php $country = isset($_POST['countryresident']) ? $_POST['countryresident'] : \Hubzero\Geocode\Geocode::ipcountry(Request::ip()); ?>
                            ...
                            <div class="indented">
                                ...
                                <?php endif; ?>
                                <label><input type="radio" class="option" name="countryresident_us" id="cores_usyes" value="yes" <?php if (strtolower($country) == 'us' || (isset($_POST['countryresident_us']) && $_POST['countryresident_us'] == 'yes')) {
                                    echo 'checked="checked"';
                                                                                                                                 } ?> />Yes</label>
                                <label><input type="radio" class="option" name="countryresident_us" id="cores_usno" value="no" <?php if (!empty($_POST['countryresident']) && strtolower($country) != 'us' || (isset($_POST['countryresident_us']) && $_POST['countryresident_us'] == 'no')) {
                                    echo 'checked="checked"';
                                                                                                                               } ?> />No</label>
                            </div>
                ...
                <?php if (isset($row['race'])) : ?>
                    ...
                    <li>
                            ...
                            <?php endif; ?>
                            <div class="indented">
                                <label><input type="checkbox" class="option" name="race[]" id="racenativeamerican" value="nativeamerican" <?php if (in_array('nativeamerican', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                                          } ?>/>American Indian or Alaska Native</label>
                                <div class="indented">
                                    <label class="indent">
                                        Tribal Affiliation(s)
                                        <input name="racenativetribe" id="racenativetribe" type="text" value="<?php if (isset($_POST['racenativetribe'])) {
                                            echo str_replace('"', '&quot;', $_POST['racenativetribe']);
                                                                                                              } ?>" />
                                    </label>
                                </div>

                                <label><input type="checkbox" class="option" name="race[]" id="raceasian" value="asian" <?php if (in_array('asian', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                        } ?> />Asian</label>

                                <label><input type="checkbox" class="option" name="race[]" id="raceblack" value="black" <?php if (in_array('black', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                        } ?> />Black or African American</label>
                                <label><input type="checkbox" class="option" name="race[]" id="racehawaiian" value="hawaiian" <?php if (in_array('hawaiian', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                              } ?> />Native Hawaiian or Other Pacific Islander</label>
                                <label><input type="checkbox" class="option" name="race[]" id="racewhite" value="white" <?php if (in_array('white', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                        } ?> />White</label>
                                <label><input type="checkbox" class="option" name="race[]" id="racerefused" value="refused" <?php if (in_array('refused', $race)) {
                                    echo 'checked="checked" ';
                                                                                                                            } ?> />Do not wish to reveal</label>
                    </li>
                <?php endif; ?>
                <?php if (isset($row['disability'])) : ?>
                    <li>
                            ...
                            <?php endif; ?>
                            <div class="indented">
                                <label><input <?php if (isset($_POST['disability']) && $_POST['disability'] == 'yes') {
                                    echo 'checked="checked" ';
                                              } ?>type="radio" value="yes" id="disabilityyes" name="disability" class="option"> Yes</label>
                                ...
                                <label><input <?php if (isset($_POST['disability']) && $_POST['disability'] == 'no') {
                                    echo 'checked="checked" ';
                                              } ?>type="radio" value="no" id="disabilityno" name="disability" class="option"> No (none)</label><br />
                                <label><input <?php if (isset($_POST['disability']) && $_POST['disability'] == 'refused') {
                                    echo 'checked="checked" ';
                                              } ?>type="radio" value="refused" id="disabilityrefused" name="disability" class="option"> Do not wish to reveal</label>
                            </div>
                    </li>
                <?php endif; ?>
