{{--
  mod_quickicon — admin dashboard quick-action icons

  Renders a responsive grid of shortcut buttons for common admin tasks.
  Each button checks user authorization before displaying.

  Variables: $buttonList, $params, $module
...
--}}
@php
  // SVG icon map keyed by button id suffix
  $icons = [
    'article-add' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/>',
    ...
    'menumgr'     => '<line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/>',
    ...
    'extension'   => '<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',
    ...
    'themes'      => '<path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/>',
    'user-profile'=> '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  ];

  $fallbackIcon = '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/>';
@endphp
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
    @foreach ($buttonList as $button)
      @php
        ...
        $idSuffix = str_replace('icon-', '', $button['id'] ?? '');
        $svgPaths = $icons[$idSuffix] ?? $fallbackIcon;
      @endphp
      <a href="{{ $button['link'] }}"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
             ...
             class="opacity-60 group-hover:opacity-100 transition-opacity text-primary">
          {!! $svgPaths !!}
        </svg>
        <span class="text-xs leading-tight">{{ $button['text'] ?? '' }}</span>
      </a>
    @endforeach
  </div>
@endif
