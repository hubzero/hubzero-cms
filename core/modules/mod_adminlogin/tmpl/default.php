            ...
            <div class="options">
                ...
                foreach ($authenticators as $a) :
                    ...
                    if ($refl[$a['name']]->hasMethod('onRenderOption')) :
                        ...
                        ?>
                        <a class="<?php echo $a['name']; ?> account"
                            href="<?php echo $authUrl; ?>"
                        >
                            <div class="signin">
                                <?php echo Lang::txt('COM_LOGIN_SIGN_IN_WITH_METHOD', $a['display']); ?>
                            </div>
                        </a>
                        <?php
                    endif;
            ...
            <form action="<?php echo Route::url('index.php', true, true); ?>" method="post" class="login_form">
                <label id="mod-login-username-lbl" for="mod-login-username">
                    ...
                    <input name="username" id="mod-login-username"
                        class="input-username" type="text" size="15"
                        placeholder="<?php echo Lang::txt('JGLOBAL_USERNAME'); ?>" />
                </label>
                ...
                <label id="mod-login-password-lbl" for="mod-login-password">
                    ...
                    <input name="passwd" id="mod-login-password"
                        class="input-password" type="password" size="15"
                        placeholder="<?php echo Lang::txt('JGLOBAL_PASSWORD'); ?>" />
                </label>
