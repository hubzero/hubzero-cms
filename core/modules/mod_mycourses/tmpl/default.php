            ...
            foreach ($this->courses as $course) {
                if ($i < $this->limit) {
                    ...
                    <li class="course">
                        ...
                        switch ($course->state) {
                            case 3:
                                ?><small><?php echo Lang::txt('MOD_MYCOURSES_COURSE_STATE_DRAFT'); ?></small><?php
                                break;
                            case 2:
                                ?><small><?php echo Lang::txt('MOD_MYCOURSES_COURSE_STATE_DELETED'); ?></small><?php
                                break;
                            case 1:
                                ?><small><?php echo Lang::txt('MOD_MYCOURSES_COURSE_STATE_PUBLISHED'); ?></small><?php
                                break;
                            case 0:
                                ?><small><?php echo Lang::txt('MOD_MYCOURSES_COURSE_STATE_UNPUBLISHED'); ?></small><?php
                                break;
                        }
                        ?>
                        <span>
