 ...
 */
class Randomquote extends Module
{
    protected $charlimit;
    protected $quote;
    ...
    public function run()
    {
        ...
        if ($quote) {
            if ($quotesrc == 'miniquote') {
                $this->quote_to_show = stripslashes($quote->get('miniquote'));
            } else {
                $this->quote_to_show = stripslashes($quote->get('short_quote'));
            }
        } else {
            $this->quote_to_show = '';
        }
