	...
	<form action="<?php echo Route::url('index.php?option=com_installer&controller=manage');?>" method="post" name="adminForm" id="adminForm">
		...
		<fieldset id="filter-bar">
			...
			<div class="filter-select fltrt">
				...
				<label for="filter_location"><?php echo Lang::txt('COM_INSTALLER_VALUE_CLIENT_SELECT');?></label>
				...
				<label for="filter_status"><?php echo Lang::txt('COM_INSTALLER_VALUE_STATE_SELECT');?></label>
				...
				<label for="filter_type"><?php echo Lang::txt('COM_INSTALLER_VALUE_TYPE_SELECT');?></label>
