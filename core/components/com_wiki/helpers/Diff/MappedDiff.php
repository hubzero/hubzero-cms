...
class MappedDiff extends Diff
{
     ...
     * @param   array  $mapped_from_lines   This array should have the same size number of elements as
     *                                      $from_lines. The elements in $mapped_from_lines and
     *                                      $mapped_to_lines are what is actually compared when
     *                                      computing the diff.
