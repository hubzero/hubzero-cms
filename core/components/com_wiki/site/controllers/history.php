...
class History extends SiteController
{
    ...
    public function compareTask()
    {
        ...
        $result = $formatter->format(new \Components\Wiki\Helpers\Diff($ota, $nta));
        ...
        Event::trigger('system.logActivity', [
            'activity' => [
                ...
                'description' => Lang::txt(
                    'COM_WIKI_ACTIVITY_REVISION_DELETED',
                    $revision->get('id'),
    ...
    public function approveTask()
    {
        ...
        Event::trigger('system.logActivity', [
            'activity' => [
                ...
                'scope_id'    => $this->page->get('id'),
                'description' => Lang::txt(
                    'COM_WIKI_ACTIVITY_REVISION_APPROVED',
                    $revision->get('id'),
                    '<a href="' . Route::url($this->page->link()) . '">'
                        . $this->page->title . '</a>'
                ),
    ...
    public function setcurrentrevisionTask()
    {
        ...
        Event::trigger('system.logActivity', [
            'activity' => [
                ...
                'scope_id'    => $this->page->get('id'),
                'description' => Lang::txt(
                    'COM_WIKI_ACTIVITY_PAGE_UPDATED',
                    '<a href="' . Route::url($this->page->link()) . '">'
                        . $this->page->title . '</a>'
                ),
                'details'     => array(
