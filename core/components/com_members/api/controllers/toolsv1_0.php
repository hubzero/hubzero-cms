...
class Toolsv1_0 extends ApiController
{
    ...
    public function sessionsTask()
    {
        ...
        $cmd = "/bin/sh " . Component::path('com_tools') . "/scripts/mw screenshot "
            . $result->get('username') . " 2>&1 </dev/null";
        ...
        $accepted_ordering = array(
            'id_asc', 'id_desc', 'started_asc', 'started_desc', 'accessed_asc', 'accessed_desc'
        );
    ...
    public function recenttoolsTask()
    {
        ...
        $sql = "SELECT r.alias, tv.toolname, tv.title, tv.description, "
