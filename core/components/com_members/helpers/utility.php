...
class Utility
{
     ...
     * @param   bool    $allowNumericFirstCharacter  Whether or not to allow first character
     *                                               as number (used for grandfathered accounts)
     * @return  integer
     */
    ...
    {
        // php5 in debian etch returns negative values if we
        // don't subtract 1 from this max
