        ...
        <tr>
            <td width="100%" style="padding: 18px 8px 8px 8px; border-top: 2px solid #e9e9e9;">
                ...
                <p>
                    ...
                    A request has been made to reset your <?php echo $val; ?> account password.
                    To reset your password, you will need to submit this verification code in order to verify that the
                ...
                <p>
                    Click or copy the URL below to enter the verification code and proceed with resetting your
                    password.
                </p>
