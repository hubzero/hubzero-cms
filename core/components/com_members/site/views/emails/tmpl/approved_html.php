                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    ...
                                    width="100%"
                                    align="left"><?php echo $this->user->get('registerDate'); ?> (UTC)</td>
                            </tr>
                            <tr>
                                <th
                                    style="text-align: right; padding: 0 0.5em; font-weight: bold; white-space: nowrap;"
                                ...
                                <td
                                    style="text-align: left; padding: 0 0.5em;"
                                    width="100%"
                                    align="left"><?php echo $this->user->get('name'); ?></td>
                            </tr>
                            <tr>
                                <th
                                    style="text-align: right; padding: 0 0.5em; font-weight: bold; white-space: nowrap;"
                                ...
                                <td
                                    style="text-align: left; padding: 0 0.5em;"
                                    width="100%"
                                    align="left"><?php echo $this->user->get('username'); ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: left; padding: 1em 0.5em 0 0.5em;" align="left">
                                    <?php $val = Lang::txt('COM_MEMBERS_EMAIL_APPROVED_MESSAGE', $this->sitename); ?>
                                    <?php
