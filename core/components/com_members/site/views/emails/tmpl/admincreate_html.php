...
<table
    ...
    cellspacing="3"
    border="0"
    style="border-collapse: collapse; border-top: 2px solid #e1e1e1;">
    <tbody>
        <tr>
    ...
    <tbody>
        <tr style="border-collapse: collapse;">
            <td
                ...
                style="
                    border-collapse: collapse;
                    color: #fff !important"><div style="height: 30px !important; visibility: hidden;">----</div></td>
        </tr>
    </tbody>
</table>
<!-- End Footer Spacer -->