				...
				foreach (array_keys($users) as $userkey)
				{
					...
					switch ($users[$userkey]['orgtype'])
					{
						...
						case 'precollegefacultystaff':
							$html .= Lang::txt('PRECOLLEGE_STAFF');
							break;
						case 'precollegestudent':
							$html .= Lang::txt('PRECOLLEGE_STUDENT');
							break;
						case 'educational':
							$html .= Lang::txt('EDUCATIONAL');
							break;
						case 'nationallab':
							$html .= Lang::txt('NATIONALLAB');
							break;
						case 'industry':
							$html .= Lang::txt('INDUSTRY');
							break;
						case 'government':
							$html .= Lang::txt('GOVERNMENT');
							break;
						case 'military':
							$html .= Lang::txt('MILITARY');
							break;
						case 'personal':
							$html .= Lang::txt('PERSONAL');
							break;
						case 'unemployed':
