            ...
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        size="20"
                        maxlength="250"
                        value="<?php echo $this->escape($this->row->uid); ?>"/>
                ...
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        size="20"
                        maxlength="250"
                        value="<?php echo $this->escape($this->row->balance); ?>"/>
                </div>
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        size="20"
                        maxlength="250"
                        value="<?php echo $this->escape($this->row->earnings); ?>"/>
                </div>
            </fieldset>
            <fieldset class="adminform">
                ...
                <div
                    class="input-wrap"
                    data-hint="<?php echo Lang::txt('E.g. answers, store, survey, general etc.'); ?>">
            ...
            <table class="adminlist">
                ...
                if (count($this->history) > 0) {
                    foreach ($this->history as $item) {
                        ?>
                    <tr>
                        <td><?php echo Date::of($item->created)->toLocal(Lang::txt('DATE_FORMAT_HZ1') . ' ' .
                            Lang::txt('TIME_FORMAT_HZ1')); ?></td>
                        ...
                        <?php if ($item->type == 'withdraw') { ?>
                            <?php $val = $this->escape($item->amount); ?>
                            <td class="aRight"><span class="points-subtract">-<?php echo $val; ?></span></td>
                        <?php } elseif ($item->type == 'hold') { ?>
                            <?php $val = $this->escape($item->amount); ?>
                            <td class="aRight"><span class="points-hold"> <?php echo $val; ?></span></td>
                        <?php } else { ?>
                            <?php $val = $this->escape($item->amount); ?>
                            <td class="aRight"><span class="points-add">+<?php echo $val; ?></span></td>
                        <?php } ?>
                    ...
                    ?>
                    <tr>
                        <?php $text = Lang::txt('There is no information available on this user\'s transactions.'); ?>
