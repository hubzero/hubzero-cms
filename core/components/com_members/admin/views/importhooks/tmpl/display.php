        ...
        <table class="admintable">
            <thead>
                <tr>
                    ...
                    <th
                        scope="col"
                        class="priority-3"><?php echo Lang::txt('COM_MEMBERS_IMPORTHOOK_DISPLAY_FIELD_NAME'); ?></th>
                    <th
                        scope="col"
                        class="priority-2"><?php echo Lang::txt('COM_MEMBERS_IMPORTHOOK_DISPLAY_FIELD_TYPE'); ?></th>
                    ...
                    <?php foreach ($this->hooks as $i => $hook) : ?>
                        <tr>
                            <td>
                                ...
                                <label
                                    for="cb<?php echo $i; ?>"
                                    class="sr-only visually-hidden"><?php echo $hook->get('id'); ?></label>
                            </td>
                            <td class="priority-3">
                            ...
                            <td>
                                ...
                                <?php $rawUrl = Route::url('index.php?option=' . $this->option . '&controller=' .
                                    $this->controller . '&task=raw&id=' . $hook->get('id')); ?>
                                <a rel="noopener" target="_blank" href="<?php echo $rawUrl; ?>">
