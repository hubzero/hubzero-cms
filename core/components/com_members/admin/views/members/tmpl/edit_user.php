                ...
                <select id="field_approved" name="fields[approved]">
                    <option value="0"<?php if ($this->profile->get('approved') == 0) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('Not approved'); ?></option>
                    <option value="1"<?php if ($this->profile->get('approved') == 1) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('Manually approved'); ?></option>
                    <option value="2"<?php if ($this->profile->get('approved') == 2) {
                        echo ' selected="selected"';
