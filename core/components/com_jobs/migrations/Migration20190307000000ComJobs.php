...
/**
 * Migration script for changing DATETIME fields default to NULL for com_jobs
 **/
class Migration20190307000000ComJobs extends Base
{
    /**
    ...
    public static $tables = array(
        '#__jobs_applications' => array(
            'applied',
            'withdrawn'
        ),
        '#__jobs_employers' => array(
            'added'
        ),
        '#__jobs_openings' => array(
            'added',
            'edited',
            'closedate',
            'expiredate',
        ...
        '#__jobs_resumes' => array(
            'created'
        ),
        '#__jobs_seekers' => array(
            'updated'
        )
    );
        ...
        foreach (self::$tables as $table => $fields) {
            foreach ($fields as $field) {
                if (
                    ...
                    $query .= "DATETIME  NOT NULL  DEFAULT '0000-00-00 00:00:00'";
