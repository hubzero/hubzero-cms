...
<section class="main section">
    <form id="hubForm" method="post" action="<?php echo Route::url('index.php?option=' . $this->option); ?>">
            ...
            <label for="companyLocationCountry">
                ...
                <select name="companyLocationCountry" id="companyLocationCountry">
                    ...
                    foreach ($countries as $country) {
                        ...
                        ?>
                        <option value="<?php echo $this->escape($country->name); ?>"<?php if (strtoupper($country->name) == strtoupper($selected)) {
        ...
        <p class="submit">
            ...
            <a class="btn" href="<?php echo Route::url('index.php?option=' . $this->option . '&task=dashboard'); ?>"><?php echo Lang::txt('JCANCEL'); ?></a>
        </p>
    </form>
</section>
