...
defined('_HZEXEC_') or die();
	...
	/* Job Posting */
	$job        = $this->job;
	$jobcat     = !empty($this->jobcat) ? $this->jobcat : 'Unspecified';
	$jobtype    = !empty($this->jobtype) ? $this->jobtype : 'Unspecified';
