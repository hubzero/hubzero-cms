...
<div class="logout<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?>
		...
		<?php if (($this->params->get('logout_image')!='')) :?>
			<img src="<?php echo $this->escape($this->params->get('logout_image')); ?>" class="logout-image" alt="<?php echo Lang::txt('COM_USERS_LOGOUT_IMAGE_ALT')?>"/>
		<?php endif; ?>
	...
	<form action="<?php echo Route::url('index.php?option=' . $this->option . '&task=user.logout'); ?>" method="post">
		<div>
