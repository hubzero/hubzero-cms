...
<section class="section">
	<div class="prompt-wrap">
		<div class="prompt-container prompt1 <?php echo ($step === 1) ? 'block': 'none'; ?>">
			...
			<div class="responses">
				<a href="<?php echo Route::url('index.php?option=' . $this->option . '&view=link&step=2'); ?>">
		...
		<div class="prompt-container prompt2 <?php echo ($step === 2) ? 'block': 'none'; ?>">
			...
			<div class="responses">
				<a href="<?php echo Route::url('index.php?option=' . $this->option . '&view=link&step=3'); ?>">
		...
		<div class="prompt-container prompt3 <?php echo ($step === 3) ? 'block': 'none'; ?>">
			...
			<div class="responses">
				<a href="<?php echo Route::url('index.php?option=' . $this->option . '&view=logout&return=' .
					base64_encode(
						Route::url('index.php?option=' . $this->option . '&view=login&reset=1&return=' .
							base64_encode(
								Route::url('index.php?option=' . $this->option . '&view=login&authenticator=' . $this->hzad->authenticator, false)
							),
						false)
					)); ?>">
