...
<section class="main section">
	...
	<p>
		<a class="logout btn" href="<?php echo Route::url('index.php?option=' . $this->option . '&task=user.logout&sso=all&authenticator=' . $this->authenticator); ?>">
			<?php echo Lang::txt('End all %s account sessions!', $this->display_name); ?>
		</a>
	</p>
	<p>
		<a class="home btn" href="<?php echo Route::url('index.php?option=' . $this->option . '&task=user.logout&sso=none&authenticator=' . $this->authenticator .'&return=' . Request::base()); ?>">
