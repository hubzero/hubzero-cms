...
$urlLogoutAll = Route::url(
    ...
    . '&task=user.logout&sso=all&authenticator=' . $this->authenticator
);
$urlLogoutNone = Route::url(
    'index.php?option=' . $this->option
    . '&task=user.logout&sso=none&authenticator=' . $this->authenticator
    . '&return=' . Request::base()
);
?>
...
<section class="main section">
    ...
    <p>
        <a class="logout btn" href="<?php echo $urlLogoutAll; ?>">
            <?php echo Lang::txt('End all %s account sessions!', $this->display_name); ?>
        </a>
    </p>
    <p>
        <a class="home btn" href="<?php echo $urlLogoutNone; ?>">
