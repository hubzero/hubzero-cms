...
$script .= "\t\t\t".'alert("'.Lang::txt('COM_USERS_MAIL_PLEASE_FILL_IN_THE_SUBJECT', true).'");'."\n";
$script .= "\t\t".'} else if (getSelectedValue(\'adminForm\',\'jform[group]\') < 0){'."\n";
$script .= "\t\t\t".'alert("'.Lang::txt('COM_USERS_MAIL_PLEASE_SELECT_A_GROUP', true).'");'."\n";
...
<form action="<?php echo Route::url('index.php?option=com_users&view=mail'); ?>" name="adminForm" method="post" id="adminForm">
	...
	<div class="width-30 fltlft">
		<fieldset class="adminform">
			<legend><?php echo Lang::txt('COM_USERS_MAIL_DETAILS'); ?></legend>
	...
	<div class="width-70 fltrt">
		<fieldset class="adminform">
			<legend><?php echo Lang::txt('COM_USERS_MAIL_MESSAGE'); ?></legend>
			<ul class="adminformlist">
