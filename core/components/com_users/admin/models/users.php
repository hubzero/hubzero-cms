...
class UsersModelUsers extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		if ($layout = Request::getCmd('layout', 'default'))
		{
			$this->context .= '.'.$layout;
		}
		...
		$groups = json_decode(base64_decode(Request::getString('groups', '')));
		if (isset($groups))
		{
		...
		$excluded = json_decode(base64_decode(Request::getString('excluded', '')));
		if (isset($excluded))
		{
