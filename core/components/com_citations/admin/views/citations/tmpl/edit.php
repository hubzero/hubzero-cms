    ...
    <div class="grid">
        ...
        <div class="col span5">
            ...
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    <input type="checkbox" name="citation[affiliated]" id="affiliated" value="1"<?php if ($this->row->affiliated) {
                        echo ' checked="checked"';
                                                                                                } ?> />
                    <label for="affiliated"><?php echo Lang::txt('AFFILIATED_WITH_YOUR_ORG'); ?></label>
                </div>
                <div class="input-wrap">
                    <input type="checkbox" name="citation[fundedby]" id="fundedby" value="1"<?php if ($this->row->fundedby) {
                        echo ' checked="checked"';
                                                                                            } ?> />
