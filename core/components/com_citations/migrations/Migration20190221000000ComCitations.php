...
/**
 * Migration script for changing DATETIME fields default to NULL for com_citations
 **/
// phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace
class Migration20190221000000ComCitations extends Base
{
    /**
        ...
        foreach (self::$tables as $table => $fields) {
            foreach ($fields as $field) {
                if (
                    ...
                    $query = "ALTER TABLE `$table` CHANGE `$field` `$field` DATETIME  NOT NULL  "
