...
function dv_data_definition()
{
    ...
    <script>
        ...
        var db_back_link = '/administrator/index.php?option=com_<?php
            echo $com_name; ?>&task=dataview_list&db=<?php echo $db_id; ?>';
    </script>
    ...
    if ($full_screen) {
        $close = $host . '/administrator/index.php?option=com_' . $com_name
            . '&task=data_definition&db=' . $db_id . '&dd=' . $dd_name;
        $backLink = $host . '/administrator/index.php?option=com_' . $com_name
        ...
        $fs = $host . '/administrator/index.php?option=com_' . $com_name
    ...
    <?php
    $formAction = '/administrator/index.php?option=com_' . $com_name . '&task=data_definition_update';
    ?>
