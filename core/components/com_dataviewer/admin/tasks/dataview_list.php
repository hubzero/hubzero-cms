...
function dv_dataview_list()
{
    ...
    if (count($files) < 1) {
        ...
        foreach ($files as $file) {
            if (substr($file, -4) === '.php') {
                ...
                $viewLink = '/' . $com_name . "/view/$db_id:db/" . $dd_name . '/';
    ...
    <!-- Remove Table form -->
    <?php
    $removeAction = '/administrator/index.php?option=com_' . $com_name
    ...
    <?php
    $newAction = '/administrator/index.php?option=com_' . $com_name
