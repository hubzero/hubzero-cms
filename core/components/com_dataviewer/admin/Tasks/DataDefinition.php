...
class DataDefinition
{
    public static function execute()
    {
        ...
        $dv_link = '/' . DvConfig::$com_name . "/view/$db_id:db/$dd_name/";
        ?>
        ...
        <script>
            ...
            var db_back_link = '/administrator/index.php?option=com_<?php
                echo DvConfig::$com_name; ?>&task=dataview_list&db=<?php echo $db_id; ?>';
        </script>
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                <iframe seamless src="<?php echo $dv_link . '?tmpl=component'; ?>"
                    id="db-tables-dv-iframe" style="width: 100%; min-width: 1000px;" height="650px;"
                    marginWidth="0" marginHeight="0" frameBorder="0" scrolling="auto">
                    IFRAMES not supported by the browser</iframe>
            </div>

            <div id="tabs-2">
                <textarea id="db-dd-source-php" style="display: none;">
                    <?php echo $dd_php; ?>
                </textarea>
                <?php $editorHeight = $full_screen ? 600 : 500; ?>
                <div id="db-dd-editor-php"
                    style="height: <?php echo $editorHeight; ?>px; width: 100%;"></div>
                <input id="db-dd-update" type="button" value="Update Dataview"
                    style="color: blue; position: absolute; top: 60px; right: 60px;" />
                <br />
            </div>

            <div id="tabs-3">
                <?php $editorHeight = $full_screen ? 600 : 500; ?>
                <div id="db-dd-editor" style="height: <?php echo $editorHeight; ?>px; width: 100%;">
                    <?php echo htmlspecialchars($dd_json); ?>
                </div>
            </div>
        ...
        if ($full_screen) {
            $close = $host . '/administrator/index.php?option=com_' . DvConfig::$com_name
                . '&task=data_definition&db=' . $db_id . '&dd=' . $dd_name;
            $backLink = $host . '/administrator/index.php?option=com_' . DvConfig::$com_name
                . '&task=dataview_list&db=' . $db_id;
            ?>
                [<a href="<?php echo $backLink; ?>" title="Go back to Dataview list">
                    &nbsp;<span class="ui-icon ui-icon-arrowthick-1-w"
                        style="display: inline-block; margin-bottom: -4px;"></span>&nbsp;
                </a>] &nbsp;
            ...
            $fs = $host . '/administrator/index.php?option=com_' . DvConfig::$com_name
                . '&task=data_definition&db=' . $db_id . '&dd=' . $dd_name . '&tmpl=component';
            ?>
        ...
        <?php
        $formAction = '/administrator/index.php?option=com_' . DvConfig::$com_name . '&task=data_definition_update';
        ?>
        <form id="db-dd-update-form" method="post" action="<?php echo $formAction; ?>">
