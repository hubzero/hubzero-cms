...
class DataDefinitionNew
{
    public static function execute()
    {
        ...
        foreach ($dd['cols'] as $col => $val) {
            $dd_text .= "\t" . '$dd[\'cols\'][\'' . $col . '\'] = ' . self::formatVar(var_export($val, true)) . "\n";
        }
        ...
        $phpDir = $base . '/' . $db_id . '/applications/'
        ...
        \Components\Dataviewer\Admin\Libs\Messages::dbMsg('New Dataview Added', 'message');
