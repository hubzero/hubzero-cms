...
class Spreadsheet
{
    public static function render($dd = false)
    {
        ...
        if ($dd) {
            $showFilter = isset($dd['filter_options']) ? $dd['filter_options'] : true;
    ...
    <div id="dv-spreadsheet">
        ...
        <div id="dv-spreadsheet-toolbar" class="ui-corner-top">
                <?php $dlMenu = $dd['top_menu']['download']['show'] ?? null; ?>
                <?php $showDl = !isset($dlMenu) || $dlMenu != false; ?>
                <?php if ($showDl) : ?>
            ...
            <button id="dv-btn-filter-clear-all" class="btn btn-mini"
                ...
                <?php $wrapMenu = $dd['top_menu']['no_wrap']['show'] ?? null; ?>
                <?php $showWrap = !isset($wrapMenu) || $wrapMenu != false; ?>
                <?php if ($showWrap) : ?>
