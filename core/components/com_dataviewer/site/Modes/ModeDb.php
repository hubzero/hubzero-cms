...
class ModeDb
{
	public static function get_conf($db_id)
	{
		...
		// A missing or malformed database.json is a normal condition - the
		// database may simply not be published - so return rather than fail on
		// a null file_get_contents() or an absent database_ro key.
