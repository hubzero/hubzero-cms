...
class DvConfig
{
	...
	public static function init()
	{
		...
		static::$dv_conf['settings']['num_rows'] = array('labels' => array(5, 10, 25, 50, 100), 'values' => array(5, 10, 25, 50, 100));
		static::$dv_conf['settings']['limit'] = $params->get('record_display_limit') == '' ? 10 : $params->get('record_display_limit');
