                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden"
                                name="fields[item_id]"
                                value="<?php echo $this->escape($this->row->item_id); ?>" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden"
                                ...
                                value="<?php echo $this->escape($this->row->item_type); ?>" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <time datetime="<?php echo $this->escape($this->row->created); ?>">
                                <?php echo Date::of($this->row->created)->toLocal(); ?>
                            </time>
                            <input type="hidden"
                                name="fields[created]"
                                id="field-created"
                                value="<?php echo $this->escape($this->row->created); ?>" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            echo ($editor)
                                ? $this->escape(stripslashes($editor->get('name')))
                                : Lang::txt('unknown');
                            ?>
                            <input type="hidden"
                                name="fields[created_by]"
                                id="field-created_by"
                                value="<?php echo $this->escape($this->row->created_by); ?>" />
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    <input type="checkbox"
                        ...
                        id="field-anonymous"
                        value="1"
                        <?php echo $this->row->anonymous ? 'checked="checked"' : ''; ?> />
