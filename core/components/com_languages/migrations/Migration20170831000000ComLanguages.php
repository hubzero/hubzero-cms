...
namespace Components\Languages\Migrations;
 ...
 **/
class Migration20170831000000ComLanguages extends Base
{
    /**
     * Up
     **/
    public function up()
    {
        ...
        // com_languages is purposely separate from the 'components' list.
        //
        ...
        $this->addComponentEntry('languages', null, 1, '', false);
    }
    ...
    {
        $this->deleteComponentEntry('languages');
    }
}
