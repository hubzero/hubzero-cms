...
/**
 * Migration script for adding component entry for com_login
 **/
class Migration20170831000000ComLogin extends Base
{
	/**
	 * Up
	 **/
	public function up()
	{
		...
		// com_login is purposely separate from the 'components' list.
		//
		...
		$this->addComponentEntry('login', null, 1, '', false);
	}
	...
	{
		$this->deleteComponentEntry('login');
	}
}
