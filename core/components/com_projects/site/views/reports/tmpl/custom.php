                ...
                <div class="grid">
                    <div class="col span3 form-group">
                        <label for="from-date">
                            ...
                            <?php $fromPlaceholder = $this->escape(Date::of('-1 month')->toLocal('Y-m')); ?>
                            <input
                                type="text"
                                class="form-input datepicker"
                                value="<?php echo $this->escape($from); ?>"
                                id="from-date"
                                name="fromdate"
                    ...
                    <div class="col span3 form-group">
                        <label for="to-date">
                            ...
                            <?php $toPlaceholder = $this->escape(Date::of('now')->toLocal('Y-m')); ?>
                            <input
                                type="text"
                                class="form-input datepicker"
                                value="<?php echo $this->escape($to); ?>"
                                id="to-date"
                                name="todate"
                    ...
                    <div class="col span6 omega form-group">
                        <label for="searchterm">
                            ...
                            $tf = Event::trigger(
                                ...
                                array(array('tags', 'searchterm', 'searchterm', '', $filter))
                            );
                            $tf = implode('', $tf);

                            if (empty($tf)) :
                                $tf = '<textarea name="searchterm" id="searchterm"'
                                    . ' class="form-input" rows="6" cols="35">'
            ...
            <p class="submit">
                <span class="button-wrapper icon-download-alt">
                    <input
                        ...
                        value="<?php echo Lang::txt('Download report (CSV)'); ?>"
                    />
                </span>
            </p>
        </form>
