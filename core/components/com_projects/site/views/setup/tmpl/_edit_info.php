    ...
    <div class="form-group">
        <label for="field-access">
            ...
            <select class="form-control" name="access" id="field-access">
                ...
                <?php else : ?>
                    <option value="1"<?php if ($this->model->get('access') == 1) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('COM_PROJECTS_PRIVACY_EDIT_PUBLIC'); ?></option>
                    <option value="2"<?php if ($this->model->get('access') == 2) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('COM_PROJECTS_PRIVACY_EDIT_REGISTERED'); ?></option>
                    <option value="5"<?php if ($this->model->get('access') == 5) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('COM_PROJECTS_PRIVACY_EDIT_PRIVATE'); ?></option>
                <?php endif; ?>
            </select>
        </label>
    </div>

    <fieldset id="access-public"<?php if ($this->model->get('access') == 5) {
        echo ' class="hidden"';
                                } ?>>
        ...
        <div class="form-group form-check">
            <label for="params-allow_membershiprequest" class="form-check-label">
                ...
                <input type="checkbox" class="option form-check-input" name="params[allow_membershiprequest]" id="params-allow_membershiprequest" value="1" <?php if ($this->model->params->get('allow_membershiprequest')) {
                    echo ' checked="checked"';
                                                                                                                                                            } ?> /> <?php echo Lang::txt('COM_PROJECTS_MEMBERSHIPREQUEST'); ?>
            </label>
        </div>
        ...
        <div class="form-group form-check">
            <label for="params-team_public" class="form-check-label">
                ...
                <input type="checkbox" class="option form-check-input" name="params[team_public]" id="params-team_public" value="1" <?php if ($this->model->params->get('team_public')) {
                    echo ' checked="checked"';
                                                                                                                                    } ?> /> <?php echo Lang::txt('COM_PROJECTS_TEAM_PUBLIC'); ?>
            </label>
        </div>
        ...
        <?php if ($this->publishing) : ?>
            <div class="form-group form-check">
                <label for="params-publications_public" class="form-check-label">
                    ...
                    <input type="checkbox" class="option form-check-input" name="params[publications_public]" id="params-publications_public" value="1" <?php if ($this->model->params->get('publications_public')) {
                        echo ' checked="checked"';
                                                                                                                                                        } ?> /> <?php echo Lang::txt('COM_PROJECTS_PUBLICATIONS_PUBLIC'); ?>
                </label>
            </div>
        <?php endif; ?>
        ...
        if ($pparams->get('enable_publinks')) : ?>
            <div class="form-group form-check">
                <label for="params-notes_public" class="form-check-label">
                    ...
                    <input type="checkbox" class="option form-check-input" name="params[notes_public]" id="params-notes_public" value="1" <?php if ($this->model->params->get('notes_public')) {
                        echo ' checked="checked"';
                                                                                                                                          } ?> /> <?php echo Lang::txt('COM_PROJECTS_NOTES_PUBLIC'); ?>
                </label>
            </div>
        <?php endif; ?>
        ...
        if ($pparams->get('enable_publinks')) : ?>
            <div class="form-group form-check">
                <label for="params-files_public" class="form-check-label">
                    ...
                    <input type="checkbox" class="option form-check-input" name="params[files_public]" id="params-files_public" value="1" <?php if ($this->model->params->get('files_public')) {
                        echo ' checked="checked"';
                                                                                                                                          } ?> /> <?php echo Lang::txt('COM_PROJECTS_FILES_PUBLIC'); ?>
                </label>
            </div>
        <?php endif; ?>
    </fieldset>
