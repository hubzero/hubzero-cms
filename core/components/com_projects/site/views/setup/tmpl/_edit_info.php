...
<?php if (isset($this->fields) && !empty($this->fields)) : ?>
    <fieldset>
        ...
        // Create a new form
        Hubzero\Form\Form::addFieldPath(Component::path('com_projects')
            . DS
            . 'models'
            . DS
            . 'orm'
        ...
        <div class="form-group form-check">
            <label for="params-allow_membershiprequest" class="form-check-label">
                ...
                <input
                    ...
                    value="1"
                    <?php if ($this->model->params->get('allow_membershiprequest')) {
        ...
        <div class="form-group form-check">
            <label for="params-team_public" class="form-check-label">
                ...
                <input
                    ...
                    value="1"
                    <?php if ($this->model->params->get('team_public')) {
                        echo ' checked="checked"';
                    } ?>
            ...
            <div class="form-group form-check">
                <label for="params-publications_public" class="form-check-label">
                    ...
                    <input
                        ...
                        value="1"
                        <?php if ($this->model->params->get('publications_public')) {
                            echo ' checked="checked"';
                        } ?>
            ...
            <div class="form-group form-check">
                <label for="params-notes_public" class="form-check-label">
                    ...
                    <input
                        ...
                        value="1"
                        <?php if ($this->model->params->get('notes_public')) {
                            echo ' checked="checked"';
                        } ?>
            ...
            <div class="form-group form-check">
                <label for="params-files_public" class="form-check-label">
                    ...
                    <input
                        ...
                        value="1"
                        <?php if ($this->model->params->get('files_public')) {
                            echo ' checked="checked"';
                        } ?>
...
<p class="submitarea">
    ...
    <span>
        ...
        ?>
        <a href="<?php echo $routeUrl; ?>" class="btn btn-secondary btn-cancel">
