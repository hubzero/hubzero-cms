...
<ul class="projecttools">
    ...
    foreach ($this->tabs as $tab) {
                                    ...
                                    <ul>
                                        <?php foreach ($aTab['children'] as $item) { ?>
                                            <li<?php if ($item['class']) { echo ' class="' . $item['class'] . '"'; } ?>>
                                                <a class="tab-<?php echo $aTab['name']; ?>"
                                                    data-icon="&#x<?php echo $item['icon']; ?>"
                                                    href="<?php echo Route::url($item['url']); ?>">
        ...
        ?>
        <li<?php if ($tab['name'] == $this->active) {
            echo ' class="active"';
           } ?>>
            <?php
            $tabUrl = Route::url(
            ...
            <a
                ...
                data-icon="&#x<?php echo $tab['icon']; ?>"
                href="<?php echo $tabUrl; ?>"
                title="<?php echo $tabTitle; ?>"
            >
                ...
                <ul>
                    <?php foreach ($tab['children'] as $item) { ?>
                        <li<?php if ($item['class']) {
                            ...
                            <a class="tab-<?php echo $item['name']; ?>" data-icon="&#x
                                <?php echo $item['icon']; ?>" href="<?php echo Route::url($item['url']); ?>">
                                <span><?php echo $item['title']; ?></span>
                            </a>
                        </li>
                    <?php } ?>
