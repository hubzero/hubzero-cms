...
class Compiler extends Obj
{
    ...
    public function compileTex(
        ...
        $outputDir   = $outputDir ? $outputDir : $this->outputFolder;
        ...
        chdir($cacheFolder);
        $command = $texpath . DS . 'pdflatex -output-directory=' . $outputDir
            . ' -interaction=batchmode ' . escapeshellarg($texFile . '.tex');
        exec($command, $out);
