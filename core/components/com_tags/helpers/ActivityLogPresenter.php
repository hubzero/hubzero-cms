        ...
        if ($comments) {
            ...
            switch ($action) {
                ...
                case 'substitute_moved':
                    $class = 'moved';
                    $activityDescription = Lang::txt(
                        'COM_TAGS_LOG_ALIAS_MOVED',
                        $entriesCount,
                        $oldId,
                        $timestamp,
                        $actor
            ...
            $class = 'edited';
            $actionText = str_replace('_', ' ', $action);
            $activityDescription = Lang::txt('COM_TAGS_LOG_TAG_EDITED', $actionText, $timestamp, $actor);
        }
