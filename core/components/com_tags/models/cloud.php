...
class Cloud extends \Hubzero\Base\Obj
{
     ...
     * @return  object
     */
    public static function getInstance($scope_id = 0, $scope = '')
    {
        static $instances;
            ...
            default:
                ...
                if (!$this->_cache['tags.list'] || $clear) {
                    ...
                    if (isset($filters['sort']) && $filters['sort'] != '') {
                        ...
                        $sortDir = (isset($filters['sort_Dir']) && $filters['sort_Dir']) ? $filters['sort_Dir'] : "ASC";
        ...
        switch (strtolower($rtrn)) {
            ...
            default:
                if (!isset($this->_cache['tags.cloud']) || $clear) {
                    ...
                    $view->set('config', \Hubzero\Facades\Component::params('com_tags'))
