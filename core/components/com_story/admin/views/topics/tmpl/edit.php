...
Toolbar::title(Lang::txt($this->row->isNew() ? 'COM_STORY_TOPIC_NEW' : 'COM_STORY_TOPIC_EDIT'), 'story.png');
Toolbar::apply();
Toolbar::save();
Toolbar::cancel();
...
<form action="<?php echo Route::url('index.php?option=' . $this->option . '&controller=topics'); ?>" method="post" name="adminForm" id="item-form" class="main section">

	<fieldset class="adminform">
		<legend><?php echo Lang::txt('COM_STORY_TOPIC_DETAILS'); ?></legend>
