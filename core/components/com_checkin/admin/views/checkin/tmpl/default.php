    ...
    <table id="global-checkin" class="adminlist">
        <thead>
            <tr>
                ...
                <th scope="col">
                    <?php echo Html::grid('sort', 'COM_CHECKIN_DATABASE_TABLE', 'table', $listDirn, $listOrder); ?>
                </th>
                <th scope="col">
                    <?php echo Html::grid('sort', 'COM_CHECKIN_ITEMS_TO_CHECK_IN', 'count', $listDirn, $listOrder); ?>
                </th>
            </tr>
        </thead>
        <tbody>
