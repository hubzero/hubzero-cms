...
class Product extends \Hubzero\Component\SiteController
{
    ...
    public function displayTask()
    {
        ...
        /*
            Find if there is a need to display a product quantity dropdown on the initial view load.
            It will be only displayed for single SKU that allows multiple items.
        ...
        */
        ...
        //build pathway
        $this->buildPathway($product->pName);
     ...
     * @return  void
     */
    private function buildPathway($product)
    {
        if (Pathway::count() <= 0) {
            Pathway::append(
