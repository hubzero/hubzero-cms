            ...
            <td width="100%" style="padding: 18px 8px 8px 8px; border-top: 2px solid #e9e9e9;">
                ...
                >
                    <tbody>
                        <tr>
                            <th
                                style="text-align: right; padding: 0 0.5em; font-weight: bold;
                        ...
                        <tr>
                            ...
                            <td
                                style="text-align: left; padding: 0 0.5em;"
                                align="left"
                            ><?php echo $this->publication->get('version_label'); ?>
                        </tr>
                        <tr>
                            <th
                                style="text-align: right; padding: 0 0.5em; font-weight: bold;
    ...
    <tbody>
        <tr>
            <td align="left" valign="bottom">
                    <span>
                        <?php $unsubUrl = $base . $this->unsubscribeLink; ?>
                        <?php $privacyUrl = Request::base() . '/legal/privacy'; ?>
                        <?php $supportUrl = Request::base() . '/support'; ?>
                        This email was sent to you on behalf of <?php echo $base; ?>
                        because you are subscribed to watch this publication.
                        To unsubscribe, please follow the
                        <a href="<?php echo $unsubUrl; ?>">unsubscribe link</a>.
                        Visit our <a href="<?php echo $privacyUrl; ?>">Privacy Policy</a>
                        and <a href="<?php echo $supportUrl; ?>">Support Center</a>
