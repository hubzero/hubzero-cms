...
<header id="content-header">
    ...
    <div id="content-header-extra">
        <ul id="useroptions">
            ...
            <?php $langTxt2 = Lang::txt('COM_PUBLICATIONS_CURATION_LIST'); ?>
...
<section class="main section">
    ...
    >
        ...
        <input
            ...
            name="id"
            id="pid"
            value="<?php echo $this->pub->id; ?>"
            data-route="<?php echo $saveRoute; ?>"
        />
            ...
            <p class="instruct">
                <span class="pubimage">
                    ...
                    $thumbUrl = Route::url(
                        ...
                        . $this->pub->id . '&v=' . $this->pub->version_id
                    ) . '/Image:thumb';
                    ?>
                ...
                <strong class="block">
                    ...
                    echo ' ' . Date::of($this->pub->submitted)->toLocal('M d, Y') . ' '
                        . Lang::txt('COM_PUBLICATIONS_CURATION_BY', $name);
                    ?>
                </strong>
                <?php if ($this->pub->curator()) : ?>
                    <span class="block">
                        <?php echo Lang::txt('COM_PUBLICATIONS_CURATION_ASSIGNED_CURATOR') . ' <strong>'
                            . $this->pub->curator('name') . ' (' . $this->pub->curator('username') . ')</strong>';  ?>
                    </span>
                <?php endif; ?>
                <?php echo Lang::txt('COM_PUBLICATIONS_CURATION_REVIEW_AND_ACT'); ?>
                <span class="legend">
                    <?php $langTxt = Lang::txt('COM_PUBLICATIONS_CURATION_LEGEND_NONE'); ?>
                    <span class="legend-checker-none"><?php echo $langTxt; ?></span>
                    <?php $langTxt = Lang::txt('COM_PUBLICATIONS_CURATION_LEGEND_PASS'); ?>
                    <span class="legend-checker-pass"><?php echo $langTxt; ?></span>
                    <?php $langTxt = Lang::txt('COM_PUBLICATIONS_CURATION_LEGEND_FAIL'); ?>
                    <span class="legend-checker-fail"><?php echo $langTxt; ?></span>
                    <?php $langTxt = Lang::txt('COM_PUBLICATIONS_CURATION_LEGEND_UPDATE'); ?>
                    <span class="legend-checker-update"><?php echo $langTxt; ?></span>
                </span>
            </p>
            <div class="clear"></div>
            <div class="submit-curation">
                <p>
                    <span class="button-wrapper icon-kickback">
                        <input
                            type="submit"
                            value="<?php echo Lang::txt('COM_PUBLICATIONS_CURATION_LOOKS_BAD'); ?>"
                    ...
                    <span class="button-wrapper icon-apply">
                        <input
                            type="submit"
                            value="<?php echo Lang::txt('COM_PUBLICATIONS_CURATION_LOOKS_GOOD'); ?>"
    ...
    <div class="hidden">
        <div id="addnotice" class="addnotice">
            <?php $routeUrl = Route::url('index.php?option=' . $this->option . '&controller=' . $this->controller); ?>
            <form id="notice-form" name="noticeForm" action="<?php echo $routeUrl; ?>" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="notice-review">
                            <?php $langTxt = Lang::txt('COM_PUBLICATIONS_CURATION_NOTICE_LABEL'); ?>
                            <span class="block"><?php echo $langTxt; ?></span>
                            <textarea
                                name="review"
                                id="notice-review"
                                class="form-control"
                ...
                <p class="submitarea">
                    <input
                        ...
                        id="notice-submit"
                        class="btn"
                        value="<?php echo Lang::txt('COM_PUBLICATIONS_CURATION_MARK_AS_FAIL'); ?>"
                    />
                </p>
            </form>
        </div>
