        ...
        <?php foreach ($block->elements as $elementId => $element) { ?>
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    ...
                    <?php } else { ?>
                        <input type="<?php echo ($paramname == 'min' || $paramname == 'max') ? 'number' : 'text'; ?>" name="curation[blocks][<?php echo $blockId; ?>][elements][<?php echo $elementId; ?>][params][<?php echo $paramname; ?>]" value="<?php echo $paramvalue;  ?>" <?php if ($paramname == 'min' || $paramname == 'max') {
                            echo ' min="0" ';
                                     } ?> />
                    <?php } ?>
                </div>
