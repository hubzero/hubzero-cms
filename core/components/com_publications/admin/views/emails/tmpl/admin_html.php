                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                width="100%"
                                align="left"
                            ><?php echo $this->model->get('version_label'); ?>
                        </tr>
                        <tr>
                            <th
                                style="text-align: right; padding: 0 0.5em; font-weight: bold; white-space: nowrap;"
                            ...
                            <td style="text-align: left; padding: 0 0.5em;" width="100%" align="left">
                                @ <?php echo $this->model->created('time'); ?>
                                on <?php echo $this->model->created('date'); ?>
                            </td>
                        </tr>
                        <tr>
                            <th
                            ...
                            <td style="text-align: left; padding: 0 0.5em;" align="left">
                                ...
                                (<?php echo $this->project->get('alias'); ?>
                                <?php echo $this->project->isProvisioned() ? ' - ' . Lang::txt('provisioned') : ''; ?>)
                            </td>
                        </tr>
                        <tr>
                            <th
                            ...
                            <td
                                ...
                                width="100%"
                                align="left"
                            ><a href="<?php echo $pubLink; ?>"><?php echo $pubLink; ?></a>
                        </tr>
                    </tbody>
                </table>
