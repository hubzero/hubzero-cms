                        ...
                        <?php foreach ($attachments as $attach) { ?>
                            <div class="input-wrap withdivider">
                                ...
                                <?php if ($attach->role == 3) { ?>
                                    ...
                                    <textarea name="attachments[<?php echo $attach->id; ?>][attribs]" rows="10" cols="60" maxlength="5000" value="<?php echo $attach->attribs; ?>" placeholder="Enter up to 5000 characters..."><?php echo $attach->attribs;
                                    ; ?></textarea>
                                <?php } ?>
                            </div>
                        <?php } ?>
