    ...
    <fieldset class="adminform">
        <fieldset>
            ...
            <div class="input-wrap">
                <input type="radio" name="lock" id="cfg-lock-yes" value="1"<?php if ($this->item->get('lock', 0)) {
            ...
            <div class="input-wrap">
                <input type="radio" name="lock" id="cfg-lock-no" value="0"<?php if ($this->item->get('lock', 0)) {
                    echo ' checked="checked"';
                                                                          } ?> />
        ...
        <fieldset>
            ...
            <div class="input-wrap">
                <input type="radio" name="mail_on_new" id="cfg-mail_on_new-yes" value="1"<?php if ($this->item->get('mail_on_new', 1)) {
                    echo ' checked="checked"';
                                                                                         } ?> />
            ...
            <div class="input-wrap">
                <input type="radio" name="mail_on_new" id="cfg-mail_on_new-no" value="0"<?php if ($this->item->get('mail_on_new', 1)) {
                    echo ' checked="checked"';
                                                                                        } ?> />
