...
class MessagesModelMessage extends JModelAdmin
{
	...
	*/
	...
	public function getItem($pk = null)
	{
		if (!isset($this->item))
		{
			if ($this->item = parent::getItem($pk))
			{
				...
				elseif ($this->item->user_id_to != \User::get('id'))
				{
	...
	protected function loadFormData()
	{
		...
		$data = User::getState('com_messages.edit.message.data', array());
	...
	public function save($data)
	{
		...
		{
			$this->setError(\Lang::txt('COM_MESSAGES_ERR_SEND_FAILED'));
			return false;
		}
