...
$resetConfirm = Lang::txt('COM_DEVELOPER_RESET_CLIENT_SECRET_CONFIRM');
$revokeConfirm = Lang::txt('COM_DEVELOPER_REVOKE_TOKENS_CONFIRM');
...
<form
    ...
    name="adminForm"
    id="adminForm"
    data-confirmreset="<?php echo $resetConfirm; ?>"
    data-confirmrevoke="<?php echo $revokeConfirm; ?>"
>
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th scope="col" class="priority-4">
                    <?php echo Html::grid('sort', 'COM_DEVELOPER_COL_ID', 'id', $sortDir, $sort); ?>
                </th>
                <th scope="col">
                    <?php echo Html::grid('sort', 'COM_DEVELOPER_COL_NAME', 'name', $sortDir, $sort); ?>
                </th>
                <th scope="col"><?php echo Lang::txt('COM_DEVELOPER_COL_STATE'); ?></th>
                <th scope="col" class="priority-5">
                    <?php echo Html::grid('sort', 'COM_DEVELOPER_COL_CREATED', 'created', $sortDir, $sort); ?>
                </th>
                <th scope="col" class="priority-4">
                    <?php echo Html::grid('sort', 'COM_DEVELOPER_COL_CREATED_BY', 'created_by', $sortDir, $sort); ?>
                </th>
                <th scope="col" class="priority-3">
                    <?php echo Lang::txt('COM_DEVELOPER_COL_HUB_ACCOUNT'); ?>
                </th>
            </tr>
        </thead>
        <tfoot>
        ...
        foreach ($this->rows as $row) {
            ...
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td class="priority-3">
                    <?php
                    $hubLabel = Lang::txt('COM_DEVELOPER_COL_HUB_ACCOUNT');
                    echo ($row->isHubAccount())
                        ? '<span class="state default"><span>' . $hubLabel . '</span></span>'
                        : '';
                    ?>
                </td>
            </tr>
