...
<div class="doc-section collapsed">
    <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Authentication (OAuth2)</h3>
    <div class="endpoint-content">
        ...
        <div class="doc-section collapsed" id="oauth-authorizationcode">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Web Application Flow</h3>
	...
	"refresh_token": "57c96d8372f7281572cb8063f0c9ad561ba8e903"
        ...
        <div class="doc-section collapsed" id="oauth-usercredentials">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">User Credentials Flow</h3>
            <div class="endpoint-content collapsed">
	...
	"refresh_token": "57c96d8372f7281572cb8063f0c9ad561ba8e903"
        ...
        <div class="doc-section collapsed" id="oauth-refreshtoken">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Refresh Token Flow</h3>
            <div class="endpoint-content collapsed">
	...
	"refresh_token": "57c96d8372f7281572cb8063f0c9ad561ba8e903"
        ...
        <div class="doc-section collapsed" id="oauth-sessiontoken">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Session Token Flow</h3>
            <div class="endpoint-content collapsed">
	...
	"scope": null
        ...
        <div class="doc-section collapsed" id="oauth-toolsessiontoken">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Tool Session Token Flow</h3>
            <div class="endpoint-content collapsed">
	...
	"scope": null
        ...
        <div class="doc-section collapsed" id="oauth-authenticating">
            <h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Authenticating</h3>
            <div class="endpoint-content collapsed">
