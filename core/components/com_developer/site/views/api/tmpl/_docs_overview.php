...
<div class="doc-section collapsed" id="overview-schema">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Schema</h3>
...
<div class="doc-section collapsed" id="overview-errormessages">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Errors</h3>
	<div class="endpoint-content collapsed">
...
<div class="doc-section collapsed" id="overview-httpverbs">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">HTTP Verbs</h3>
	<div class="endpoint-content collapsed">
...
<div class="doc-section collapsed" id="overview-versioning">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Versioning</h3>
	<div class="endpoint-content collapsed">
...
<div class="doc-section collapsed" id="overview-ratelimiting">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Rate Limiting</h3>
	<div class="endpoint-content collapsed">
...
<div class="doc-section collapsed" id="overview-jsonp">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">JSON-P</h3>
	<div class="endpoint-content collapsed">
...
<div class="doc-section collapsed" id="overview-expanding">
	<h3 class="endpoint-header collapsed" role="button" tabindex="0" aria-expanded="false">Expanding Objects</h3>
	<div class="endpoint-content collapsed">
