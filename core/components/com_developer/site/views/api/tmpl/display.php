...
<section class="main section">
	<div class="grid">
		...
		<div class="col span3">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=applications'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_MANAGE'); ?></a>
		</div>
		<div class="col span3">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=applications#authorized'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_MANAGE'); ?></a>
		</div>
		<div class="col span3 omega">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=applications&task=new'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_CREATE'); ?></a>
		</div>
	</div>
	<div class="grid">
		<div class="col span3">
		...
		<div class="col span3">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=api&task=docs'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_MANAGE'); ?></a>
		</div>
		<div class="col span3">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=api&task=console'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_MANAGE'); ?></a>
		</div>
		<div class="col span3 omega">
			...
			<a href="<?php echo Route::url('index.php?option=com_developer&controller=api&task=status'); ?>"><?php echo Lang::txt('COM_DEVELOPER_API_CREATE'); ?></a>
		</div>
	</div>
</section>