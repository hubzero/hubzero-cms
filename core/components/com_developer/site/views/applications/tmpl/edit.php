            ...
            >
                <fieldset>
                    ...
                    <label for="field-name">
                        <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_NAME'); ?>:
                        <span class="required"><?php echo $requiredLabel; ?></span>
                        <input
                            type="text"
                            name="application[name]"
                            id="field-name"
                            value="<?php echo $this->escape($this->application->get('name')); ?>"
                        />
                    </label>

                    <label for="field-description">
                        <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_DESCRIPTION'); ?>:
                        <span class="required"><?php echo $requiredLabel; ?></span>
                        <textarea
                            name="application[description]"
                            id="field-description"
                            rows="8"
                        ><?php echo $this->escape($this->application->get('description')); ?></textarea>
                    </label>
                    ...
                    <label for="field-redirect_uri">
                        ...
                        ?>
                        <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_REDIRECT_URI'); ?>:
                        <span class="required"><?php echo $requiredLabel; ?></span>
                        <textarea
                            name="application[redirect_uri]"
                            id="field-redirect_uri"
                            rows="3"
                        ><?php echo $this->escape($uris); ?></textarea>
                        <span class="hint">
                            <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_REDIRECT_URI_HINT'); ?>
                        </span>
                    </label>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <?php else : ?>
                        <p class="info">
                            <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_TEAM_DONT_ADD_YOURSELF'); ?>
                        </p>
                    <?php endif;?>

                    <label for="whoknows">
                        <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_TEAM_ADD'); ?>:
                        <span class="optional"><?php echo Lang::txt('OPTIONAL'); ?></span>
                        <?php
                            $mc = Event::trigger(
                                'hubzero.onGetMultiEntry',
                                array(array('members', 'team', 'acmembers'))
                            );
                            if (count($mc) > 0) {
                                echo $mc[0];
                            } else { ?>
                            ...
                            <?php } ?>
                        <span class="hint">
                            <?php echo Lang::txt('COM_DEVELOPER_API_APPLICATION_TEAM_ADD_HINT'); ?>
                        </span>
                    </label>
                </fieldset>
                ...
                <p class="submit">
                    <input
                        ...
                        type="submit"
                        value="<?php echo Lang::txt('COM_DEVELOPER_SAVE'); ?>"
                    >
                ...
                <input
                    type="hidden"
                    name="application[id]"
                    value="<?php echo $this->application->get('id'); ?>"
                />
        ...
        <?php if ($this->application->get('id')) : ?>
            <div class="aside">
                <form action="<?php echo $formAction; ?>" method="post">
                    ...
                    <?php $resetConfirm = Lang::txt('COM_DEVELOPER_API_APPLICATION_RESET_CLIENT_SECRET_CONFIRM'); ?>
                    <button
                        type="submit"
                        class="btn btn-warning confirm"
                        data-txt-confirm="<?php echo $resetConfirm; ?>"
                    >
                ...
                <form action="<?php echo $formAction; ?>" method="post">
                    ...
                    <?php $deleteConfirm = Lang::txt('COM_DEVELOPER_API_APPLICATION_DELETE_CONFIRM'); ?>
                    <button
                        type="submit"
                        class="btn btn-danger confirm"
                        data-txt-confirm="<?php echo $deleteConfirm; ?>"
                    >
