...
/**
 * Developer authorization code table class
 */
class AuthorizationCode extends \JTable
{
	/**
	 * Constructor
	 * 
	...
	{
		parent::__construct('#__developer_authorization_codes', 'id', $db);
	}
	...
	public function _buildQuery($filters = array())
	{
		...
		// auth code
		if (isset($filters['authorization_code']))
		{
			$where[] = "authorization_code=" . $this->_db->quote( $filters['authorization_code'] );
		}
