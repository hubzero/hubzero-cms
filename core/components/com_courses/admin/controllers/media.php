...
class Media extends AdminController
{
    ...
    private function buildUploadPath($listdir, $subdir = '')
    {
        ...
        $uploadpath = trim($this->config->get('uploadpath', '/site/courses'), DS);
        $path = PATH_APP . DS . $uploadpath . DS . $course_id . DS . $listdir;
        if ($subdir) {
    ...
    public function uploadTask()
    {
        ...
        if ($foldername != '') {
            ...
            if ($file['size'] > $sizeLimit) {
                $msg = Lang::txt(
                    'COM_COLLECTIONS_ERROR_UPLOADING_FILE_TOO_BIG',
