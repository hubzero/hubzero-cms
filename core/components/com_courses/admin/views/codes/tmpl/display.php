        ...
        <div class="grid">
            ...
            <div class="col span6">
                ...
                <select name="redeemed" id="filter-redeemed" class="filter filter-submit">
                    <option value="-1"<?php if ($this->filters['redeemed'] == -1) {
                        echo ' selected="selected"';
                                      } ?>><?php echo Lang::txt('COM_COURSES_ALL_STATES'); ?></option>
                    <option value="1"<?php if ($this->filters['redeemed'] == 1) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('COM_COURSES_FILTER_REDEEMED'); ?></option>
                    <option value="0"<?php if ($this->filters['redeemed'] == 0) {
                        echo ' selected="selected"';
                                     } ?>><?php echo Lang::txt('COM_COURSES_FILTER_UNREDEEMED'); ?></option>
                </select>
            </div>
        </div>
    </fieldset>
