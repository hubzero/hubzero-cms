        ...
        <div class="col span7">
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    ...
                    <select
                        name="fields[offering_id]"
                        id="field-offering_id"
                        class="required"
                        onchange="changeDynaList('section_id',
                            offeringsections,
                            document.getElementById('offering_id')
                                .options[document.getElementById('offering_id')
                ...
                <div class="input-wrap">
                    ...
                    <input
                        ...
                        name="fields[token]"
                        id="field-token"
                        value="<?php echo $this->escape($this->row->get('token')); ?>" />
                </div>
            </fieldset>
        </div>
        <div class="col span5">
