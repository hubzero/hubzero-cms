...
<section id="introduction" class="section">
    <?php
        ...
        ?>
    <form class="section-inner" action="<?php echo $routeUrl; ?>" method="get">
        <div class="grid">
            <div class="col span8">
                <div class="container data-entry">
                    ...
                    <fieldset class="entry-search">
                        <?php $txt = Lang::txt('COM_COURSES_SEARCH_INTRO_LABEL'); ?>
                        ...
                        <input
                            ...
                            value=""
                            placeholder="<?php echo Lang::txt('COM_COURSES_SEARCH_INTRO_PLACEHOLDER'); ?>" />
                    </fieldset>
                </div><!-- / .container -->
                ...
                <p><a
                    class="popup"
                    href="<?php echo $routeUrl; ?>"><?php echo Lang::txt('COM_COURSES_HOW_COURSES_WORK'); ?></a></p>
            </div>
            <div class="col span3 offset1 omega">
                <div>
                    <?php
                        ...
                        ?>
                    <a class="btn icon-browse" href="<?php echo $routeUrl; ?>">
