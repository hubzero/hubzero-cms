...
class Handler
{
    ...
    private function getHandlersThatRespondToType($fileType)
    {
        ...
        // @FIXME: also include files from template override directory
        // (override if same name, or add to the list if different name)
    ...
    public function doEdit($id)
    {
        ...
        } elseif ($class != $space && class_exists($class) && method_exists($class, 'edit')) {
