...
class Record extends \Hubzero\Content\Import\Model\Record
{
    ...
    private function mapEntryData()
    {
        ...
        } elseif (isset($this->raw->cn) && $this->raw->cn) {
        ...
        /*foreach (array('members', 'tags', 'projects') as $key)
        {
            if (isset($this->raw->$key))
            {
                ...
                $this->_description[$key] = $this->multiValueField($this->_description[$key]);
            }
        }*/
        ...
        if ($this->record->entry->get('gidNumber')) {
            ...
            if ($cn && isset($this->raw->cn) && $cn != $this->raw->cn) {
                ...
                $message = Lang::txt(
                    'Group aliases (CNs) for existing groups cannot be changed at this time.'
                );
                array_push($this->record->notices, $message);
            }
        } elseif (isset($this->raw->cn) && $this->raw->cn) {
