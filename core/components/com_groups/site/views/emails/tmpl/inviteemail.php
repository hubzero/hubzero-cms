...
$register = $base .
    '/' .
    ltrim(Route::url('index.php?option=com_members&controller=register'), '/') .
    '?return=' .
    base64_encode($group);
?>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: left; padding: 1em 0.5em 0 0.5em;" align="left">
                                    <?php if ($this->msg) { ?>
                                        <p style="font-size: 1em; line-height: 1.6em;
                                            margin: 0 auto 1rem; max-width: 100%;
                                    ...
                                    <div style="text-align: center; margin: 2rem 0 1rem;">
                                        ...
                                        <p style="font-size: 1em; line-height: 1.6em;
                                            margin: 1rem auto 1rem; color: #AAA;
                                        ...
                                        <p style="font-size: 1em; line-height: 1.6em;
                                            ...
                                            <a
                                                ...
                                                style="
                                                    font-weight: bold; 
                                                    text-decoration: none; 
                                                    word-break: break-word;"><?php echo $register; ?></a>
                                        </p>
                                    </div>
                                </td>
                            </tr>
        ...
        <tbody>
            <tr>
                <td align="left" valign="bottom">
                    ...
                    <span>
                        <?php echo Config::get('sitename'); ?>
                        sent this email because you are a group manager
                        for this group. Visit our
