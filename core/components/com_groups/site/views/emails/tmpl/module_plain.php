...
$message .= Lang::txt('Created:') .
    ' @ ' .
    Date::of($this->object->get('created'))->toLocal(Lang::txt('TIME_FORMAT_HZ1')) .
    ' on ' .
    Date::of($this->object->get('created'))->toLocal(Lang::txt('DATE_FORMAT_HZ1')) .
    "\n";
...
$message .= Lang::txt('Status:') .
    ' ' .
    ($this->object->get('approved') == 1) ? Lang::txt('Approved') : Lang::txt('Unapproved') .
    "\n";
