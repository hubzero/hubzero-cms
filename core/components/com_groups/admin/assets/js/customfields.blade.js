...
/* Blade version of customfields.js — removes jQuery UI tabs() calls
 * that are not available in daisyUI mode. The form-builder library
 * manages its own multi-page interface internally.
 */
...
jQuery(document).ready(function($){
	...
	var data = JSON.parse(document.getElementById('schema').content.textContent);
	options1.defaultFields = data;
