...
class ImportHooks extends AdminController
{
    ...
    public function saveTask()
    {
        ...
        if ($isNew) {
            ...
            $this->createImportFilespace($hook);
        }
        ...
        Notify::success(Lang::txt('COM_GROUPS_IMPORTHOOK_CREATED'));
    ...
    public function removeTask()
    {
        ...
        if ($i) {
            Notify::success(Lang::txt('COM_GROUPS_IMPORTHOOK_REMOVED'));
        }
     ...
     * @return  boolean
     */
    private function createImportFilespace(Hook $hook)
    {
        // upload path
