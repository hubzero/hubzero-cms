...
<div class="input-wrap">
    <?php $val = Lang::txt('COM_RESOURCES_FIELD_TYPE'); ?>
    <label><?php echo $val; ?>: <span class="required"><?php echo Lang::txt('JOPTION_REQUIRED'); ?></span></label><br />
...
?></option>
        ...
        <div class="col span6">
            <div class="input-wrap">
                ...
                <input type="text"
                       ...
                       id="attrib-location"
                       maxlength="250"
                       value="<?php echo $this->row->attribs->get('location', ''); ?>"
                       />
            </div>
        </div>
        <div class="col span6">
            <div class="input-wrap">
                ...
                <input type="text"
                       ...
                       id="attrib-timeof"
                       maxlength="250"
                       value="<?php echo $time ? Date::of($time)->toLocal('Y-m-d H:i:s') : ''; ?>"
    ...
    <div class="input-wrap" data-hint="<?php echo Lang::txt('COM_RESOURCES_FIELD_CANONICAL_HINT'); ?>">
        ...
        <input type="text"
               ...
               id="attrib-canonical"
               maxlength="250"
               value="<?php echo $this->row->attribs->get('canonical', ''); ?>"
               />
...
<?php } else { ?>
    ...
    <div class="input-wrap">
        ...
        <input type="text"
               ...
               id="attrib[duration]"
               maxlength="100"
               value="<?php echo $this->row->attribs->get('duration', ''); ?>"
               />
    </div>
        ...
        <div class="col span6">
            <div class="input-wrap">
                ...
                <input type="text"
                       ...
                       id="attrib[width]"
                       maxlength="250"
                       value="<?php echo $this->row->attribs->get('width', ''); ?>"
                       />
            </div>
        </div>
        <div class="col span6">
            <div class="input-wrap">
                ...
                <input type="text"
                       ...
                       id="attrib[height]"
                       maxlength="250"
                       value="<?php echo $this->row->attribs->get('height', ''); ?>"
                       />
            </div>
        </div>
    </div>
    ...
    <div class="input-wrap" data-hint="<?php echo Lang::txt('COM_RESOURCES_FIELD_ATTRIBUTES_HINT'); ?>">
        ...
        <input type="text"
               ...
               maxlength="100"
               value="<?php echo $this->row->attribs->get('attributes', ''); ?>"
               /><br
               />
...
<div class="input-wrap">
    ...
    echo $this->editor(
        'fields[introtext]',
        $this->escape(stripslashes($this->row->get('introtext'))),
        45,
        5,
        'field-introtext',
        array('buttons' => false)
...
<div class="input-wrap">
    ...
    echo $this->editor(
        'fields[fulltxt]',
        $this->escape($this->row->description),
        45,
        15,
        'field-fulltxt',
        array('buttons' => false)
