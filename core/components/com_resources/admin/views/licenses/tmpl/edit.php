            ...
            <fieldset class="adminform">
                ...
                <div class="input-wrap" data-hint="<?php echo Lang::txt('COM_RESOURCES_FIELD_ALIAS_HINT'); ?>">
                    ...
                    <input type="text"
                           ...
                           size="35"
                           maxlength="100"
                           value="<?php echo $this->escape(stripslashes($this->row->name)); ?>"
                           /><br
                           />
                ...
                <div class="input-wrap">
                    ...
                    <input type="text"
                           ...
                           size="35"
                           maxlength="100"
                           value="<?php echo $this->escape(stripslashes($this->row->url)); ?>"
                           /><br
                           />
                </div>

                <div class="input-wrap">
                    <label for="field-text"><?php
                           echo
                    ...
                    <textarea name="fields[text]"
                              ...
                              rows="15"><?php
                                echo
                                $this->escape(stripslashes($this->row->text));
                                ?></textarea>
                </div>
