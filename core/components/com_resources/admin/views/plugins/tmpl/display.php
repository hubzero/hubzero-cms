                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="priority-2 order">
                        <?php if ($canChange) : ?>
                            <?php if ($saveOrder) :?>
                                <?php
                                $prevFolder = @$folders[$i - 1] == $item->folder;
                                $nextFolder = @$folders[$i + 1] == $item->folder;
                                $pTotal = $this->items->pagination->total;
                                ?>
                                <?php if ($listDirn == 'asc') : ?>
                                    <?php
                                    $upIcon = $this->items->pagination->orderUpIcon(
                                        $i,
                                        $prevFolder,
                                        'orderup',
                                        'JLIB_HTML_MOVE_UP',
                                    ...
                                    $downIcon = $this->items->pagination->orderDownIcon(
                                        $i,
                                        $pTotal,
                                        $nextFolder,
                                        'orderdown',
