                ...
                if ($this->types) {
                    ...
                    foreach ($this->types as $type) {
                        ...
                        <div class="input-wrap">
                            ...
                            <label for="type-<?php echo $type->id; ?>"><?php
                                   echo
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden"
                                   ...
                                   value="<?php echo $this->escape($this->row->modified_by); ?>"
                                   />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden"
                                   ...
                                   id="field-modified"
                                   value="<?php echo $this->escape($this->row->modified); ?>"
                                   />
                        </td>
                    </tr>
                <?php } ?>
