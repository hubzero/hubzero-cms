    ...
    <div class="grid">
        <div class="col span9">
            <div class="col span6">
                ...
                <p> Become a contributor and share your work with the community! Contributing content is easy. Our
                step-by-step forms will guide you through the process.</p>
            </div>
            <div class="col span6 omega">
                <h3>What do I need?</h3>
                <p> The submission process will guide you through step-by-step, but for more detailed instructions on
                what can be submitted and how, please see the list of submission types below.</p>
            </div>
        </div>
        <div class="col span3 omega">
            <p id="getstarted">
                <?php $hrefUrl = Route::url('index.php?option=' . $this->option . '&task=draft'); ?>
                <a class="btn btn-primary" href="<?php echo $hrefUrl; ?>">Get Started &rsaquo;</a>
            </p>
        </div><!-- / .aside -->
    </div>
    ...
    <div class="grid">
        ...
        <?php if ($submissions) { ?>
            <table id="submissions">
                ...
                foreach ($submissions as $submission) {
                    ...
                    $step1Url = Route::url(
                        $baseUrl . '&task=draft&step=1&id='
                        . $submission->id
                    );
                    $step2Url = Route::url(
                        $baseUrl . '&task=draft&step=2&id='
                        . $submission->id
                    );
                    $step3Url = Route::url(
                        $baseUrl . '&task=draft&step=3&id='
                        . $submission->id
                    );
                    $step4Url = Route::url(
                        $baseUrl . '&task=draft&step=4&id='
                        . $submission->id
                    );
                    $step5Url = Route::url(
                        $baseUrl . '&task=draft&step=5&id='
                        . $submission->id
                    );
                    $retractUrl = Route::url(
                        $baseUrl . '&task=retract&id='
                        . $submission->id
                    );
                    $discardUrl = Route::url(
                        $baseUrl . '&task=discard&id='
                        . $submission->id
                    );
                    ...
                    <tr class="<?php echo $cls; ?>">
                        ...
                        <td>
                            <span class="<?php echo $state; ?> status">
                                <?php echo $state; ?>
                            </span>
                            <?php if ($isDraft) { ?>
                                <br /><a
                                    class="review"
                                    href="<?php echo $step5Url; ?>"
                                ><?php echo Lang::txt('Review &amp; Submit &rsaquo;'); ?></a>
                            <?php } elseif ($submission->published == 3) { ?>
                                <br /><a
                                    class="retract"
                                    href="<?php echo $retractUrl; ?>"
                                ><?php echo Lang::txt('&lsaquo; Retract'); ?></a>
                            <?php } ?>
                        </td>
                        <td>
                            <a class="icon-delete"
                               href="<?php echo $discardUrl; ?>"
                               title="<?php echo $deleteText; ?>"
                            ><?php echo $deleteText; ?></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
        ...
        <?php } else { ?>
            <p class="info">
                ...
                Once you've started a new contribution, you can proceed at your leisure. Stop half-way through and watch
                a presentation, go to lunch, even close the browser and come back a different day! Your contribution
                will be waiting just as you left it, ready to continue at any time.
            </p>
        <?php } ?>
        </div><!-- / .col span9 omega -->
    </div>
        ...
        <div class="col span9 omega">
            <div class="grid">
                <div class="col span6">
                    ...
                    <p> All materials contributed must have <strong>clearly defined rights and privileges</strong>.
                    Online presentations and instructional material are normally licensed under <a class="legal
                    creative-commons" href="/legal/cc" title="Learn more about Creative Commons">Creative Commons 4</a>.
                    Read <a class="legal licensing" href="/legal/licensing">more details</a> about our licensing
                    policies.</p>
                </div><!-- / .col span6 -->
                <div class="col span6 omega">
                    <h3>Questions or concerns?</h3>
                    <p> We hope that our self-service upload process is intuitive and easy to use. If you encounter any
                    problems during the upload process or need assistance of any kind, please <a class="new-ticket"
                    href="/support/ticket/new">file a trouble report</a>.</p>
                </div><!-- / .col span6 -->
            </div><!-- / .grid -->
        </div><!-- / .col span9 omega -->
    </div><!-- / .grid -->
        ...
        foreach ($categories as $category) {
            ...
            <div class="col span-third <?php echo $clm; ?>">
                <div class="<?php echo $cls; ?>">
                    ...
                    ?>
                    <h3><a href="<?php echo $catUrl; ?>"><?php
                        echo stripslashes($category->get('type'));
                    ?></a></h3>
