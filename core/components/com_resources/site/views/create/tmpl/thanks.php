...
<section class="main section">
    <div class="section-inner hz-layout-with-aside">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($this->resource->title) {
                                    $titleStr = stripslashes($this->resource->title);
            ...
            <div class="container">
                ...
                <?php if ($this->config->get('autoapprove', 0) != 1) { ?>
                    <div class="entry-content" id="submission">
                        ...
                        the contribution will be approved and immediately appear
                        in the <a href="<?php echo $browseUrl; ?>">resources
                        listing</a>.</p>
                    </div>
                    <div class="entry-content" id="status">
                        <h4>How will I know when my contribution is accepted?</h4>
                        <p> When a contribution passes the review stage and is published (made publicly available), an
                        email is sent to all authors listed on the contribution.</p>
                        <p>You may also continually monitor the status by:</p>
                        <ul>
                            <?php $accountUrl = Route::url('index.php?option=com_members&task=myaccount'); ?>
                            <li>checking your "contributions" tab under your
                            <a href="<?php echo $accountUrl; ?>">account</a></li>
                            <li>checking the "My Drafts" module on your
                            personalized dashboard (found
                            <a href="<?php echo $accountUrl; ?>">here</a>).
                            <strong>Note:</strong> The module must be present
                            on your dashboard. If it isn't, you can easily add
                            it from the "personalize dashboard" item.</li>
                            <?php $hrefUrl = Route::url('index.php?option=' . $this->option . '&task=new'); ?>
                            <li>visiting the <a href="<?php echo $hrefUrl; ?>">new contribution</a> page</li>
                        </ul>
                    </div>
                    <div class="entry-content" id="retract">
                        ...
                        <ul>
                            ...
                            <li> You should be presented with a list of your "drafts" and "pending" submissions. Find
                            the (pending) contribution you wish to retract.</li>
                            <li>Click "retract".</li>
                        </ul>
                    </div>
                <?php } else { ?>
                    <div class="entry-content" id="submission">
                        ...
                        ?>
                        <p>Your contribution is now published.
                        You may view it
                        <a href="<?php echo $viewUrl; ?>">here</a>.</p>
                    </div>
                    <div class="entry-content" id="retract">
                        <h4>Ooops! I missed something and/or submitted too early!</h4>
                        <?php
                        ...
                        <a href="<?php echo $supportUrl; ?>">contact the site
                        administrators</a> and ask the submission be retracted
                        (set back to "draft" status) or modify a submission by
                        following these steps:</p>
                        <ul>
                            <li>Visit the
                            <a href="<?php echo $resourceUrl; ?>">resource's
                            page</a> while <strong>logged in</strong>.</li>
                            <li>You should see an "edit" button or link next to the title of the resource.</li>
                            <li> Click "edit" and make the desired edits. Changes on approved resource take effect
                            immediately and do not require approval.</li>
                        </ul>
                    </div>
                <?php } ?>
                </div><!-- / .container-block -->
        ...
        <p>
            <?php $hrefUrl = Route::url('index.php?option=' . $this->option . '&task=new'); ?>
            <a class="icon-prev btn" href="<?php echo $hrefUrl; ?>">Return to start</a>
        </p>
    </aside><!-- /.aside -->
    </div>
