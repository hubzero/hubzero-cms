	...
	<section class="main section" id="browse-resources">
		...
		<div id="tagbrowser" data-loader="<?php echo Request::base(true); ?>/core/components/com_resources/site/assets/img/loading.gif" role="region" aria-label="<?php echo Lang::txt('COM_RESOURCES_BROWSETAGS_LABEL'); ?>">
			...
			<div id="level-1" role="region" aria-label="<?php echo Lang::txt('COM_RESOURCES_TAG'); ?>">
				...
				<ul id="ultags" tabindex="0" role="listbox" aria-label="<?php echo Lang::txt('COM_RESOURCES_TAG'); ?>">
					<li id="level-1-loading" role="option" aria-selected="false"></li>
				</ul>
			</div><!-- / #level-1 -->
			<div id="level-2" role="region" aria-label="<?php echo Lang::txt('COM_RESOURCES'); ?>" aria-live="polite">
				...
				<ul id="ulitems" tabindex="0" role="listbox" aria-label="<?php echo Lang::txt('COM_RESOURCES'); ?>">
					<li id="level-2-loading" role="option" aria-selected="false"></li>
				</ul>
			</div><!-- / #level-2 -->
