...
/**
 * Migration script for changing DATETIME fields default to NULL for com_resources tables
 **/
class Migration20190307114147ComResources extends Base
{
	/**
	...
	public static $tables = array(
		'#__resource_taxonomy_audience' => array(
			'added'
		)
	);
