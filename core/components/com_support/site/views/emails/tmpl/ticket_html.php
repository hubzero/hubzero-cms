                        ...
                        >
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('email')); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_IP_HOSTNAME'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('ip'))
                                            . ' (' . $this->escape($this->ticket->get('hostname')) . ')'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                    ...
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('os')); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                    ...
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('browser')); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_UAS'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('uas')); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_REFERRER'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->escape($this->ticket->get('referrer')); ?>
                                    </td>
                                </tr>
                                <?php /*<tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: left; padding: 0 0.5em;" align="left">
                                        <?php echo Lang::txt(
                                            'COM_SUPPORT_NOTIFY_TICKET_CREATED',
                                            $this->ticket->get('id'),
                                            $link
                                        ); ?>
                                    </td>
