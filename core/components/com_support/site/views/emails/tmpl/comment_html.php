...
$thStyleRNWV = 'text-align: right; padding: 0 0.5em; font-weight: bold;'
        ...
        <tr>
            <td height="30" style="border-collapse: collapse; color: #9bac9b;">
                ...
                <div style="text-align: center; font-size: 90%; display: block; padding: 1em;">
                    <?php echo Lang::txt('COM_SUPPORT_EMAIL_REPLY_ABOVE'); ?>
                </div>
            </td>
        </tr>
    </table>
...
<?php if (!$this->config->get('email_terse')) { ?>
        <thead>
            <tr>
                <th
                    style="font-weight: normal; border-bottom: 1px solid <?php echo $bdcolor; ?>;
                ...
                <td width="100%" style="padding: 8px;">
                    ...
                    <?php if (!$this->config->get('email_terse')) { ?>
                        ...
                        >
                            <tbody>
                                <tr>
                                    <th style="<?php echo $thStyleRNW; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_CREATED'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo Lang::txt(
                                            'COM_SUPPORT_TICKET_CREATED',
                                            $this->ticket->created('time'),
                                            $this->ticket->created('date')
                                        ); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNW; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_CREATED_BY'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->ticket->get('name', Lang::txt('COM_SUPPORT_UNKNOWN')); ?>
                                        <?php echo $this->ticket->get('login')
                                            ? '(' . $this->ticket->get('login') . ')' : ''; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNW; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_SEVERITY'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->ticket->get('severity'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNW; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_STATUS'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->ticket->status->get('title'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="<?php echo $thStyleRNWV; ?>" align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_TAGS'); ?>:
                                    </th>
                                    <td style="<?php echo $tdStyleL; ?>" align="left">
                                        <?php echo $this->ticket->tags('string'); ?>
                                    </td>
                                </tr>
                                <?php /*<tr class="mobilehide">
                                    <th style="..." align="right">
                                        <?php echo Lang::txt('COM_SUPPORT_TICKET_DETAILS_LINK'); ?>:
                                    </th>
                                    <td style="..." align="left">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: left; padding: 0 0.5em;" align="left">
                                        <?php echo Lang::txt(
                                            'COM_SUPPORT_NOTIFY_TICKET_UPDATED',
                                            $this->ticket->get('id'),
                                            $link
                                        ); ?>
                                    </td>
    ...
    <?php if ($this->comment->isPrivate()) { ?>
        ...
        <table class="tbl-private" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tbody>
                <tr>
                    <td height="30">
                        <div style="text-align: center; font-size: 85%; display: block; padding: 1em;
                            margin: 2em 0 0 0; text-transform: uppercase; letter-spacing: 0.1em;
                            font-weight: bold; background: #fdf7f6; color: #ecada2;">
            ...
            <tbody>
                <tr>
                    <th style="text-align: left;" align="left">
                        <?php
                        if ($this->comment->creator->get('id')) {
                            echo $this->comment->creator->get('name')
                                . ' (' . $this->comment->creator->get('username') . ')';
                        } else {
                            echo Lang::txt('JADMINISTRATOR');
                        }
                        ?>
                    </th>
                        ...
                        if ($this->comment->changelog() && count($this->comment->changelog()->lists()) > 0) {
                            ...
                            <table
                                ...
                                style="border-collapse: collapse; border-top: 1px solid #e1e1e1;
                                    margin: 1em 0 2em 0; color: #616161;"
                                cellpadding="0"
                                cellspacing="0"
                                border="0"
                            >
                                ...
                                foreach ($this->comment->changelog()->lists() as $type => $log) {
                                    if (is_array($log) && count($log) > 0) {
                                        foreach ($log as $items) {
                                            $clog .= '<tr class="' . $type . '">';
                                            $tdClogStyle = 'border-bottom: 1px solid #e1e1e1;'
                                                . ' text-align: left; padding: 0.4em 0.8em;';
                                            if ($type == 'changes') {
                                                $fieldSpan  = '<span style="color: #4e7ac7;">'
                                                    . $items->field . '</span>';
                                                $beforeSpan = '<b style="color: #333;">'
                                                    . $items->before . '</b>';
                                                $afterSpan  = '<b style="color: #333;">'
                                                    . $items->after . '</b>';
                                                $clog .= '<td width="100%"'
                                                    . ' style="' . $tdClogStyle . '"'
                                                    . ' align="left">'
                                                ...
                                                $clog .= '<td width="100%"'
                                                    . ' style="' . $tdClogStyle . '"'
                                                    . ' align="left"><span style="color: #4e7ac7;">'
                                                    . Lang::txt(
                        ...
                        <?php if ($this->comment->attachments->count()) { ?>
                            <div class="comment-attachments" style="margin: 2em 0 0 0; padding: 0; text-align: left;">
                                ...
                                foreach ($this->comment->attachments as $attachment) {
                                    ...
                                    $attClass    = $attachment->isImage() ? 'img' : 'file';
                                    $attFilename = $attachment->get('filename');
                                    $attHref     = $base . '/' . ltrim(Route::url($attachment->link()), '/');
                                    $attDesc     = $attachment->get('description');
                                    echo '<p class="attachment"'
                                        . ' style="margin: 0.5em 0; padding: 0; text-align: left;">'
                                        . '<a class="' . $attClass . '"'
                                        . ' data-filename="' . $attFilename . '"'
                                        . ' href="' . $attHref . '">'
                                        . $attDesc . '</a></p>';
                                }
                                ?>
