        ...
        <div class="col span7">
            <fieldset class="adminform">
                ...
                <div class="grid">
                    <div class="col span6">
                        <div class="input-wrap">
                            <label for="field-open">
                                <?php echo Lang::txt('COM_SUPPORT_FIELD_FOR'); ?>:
                                <span class="required"><?php echo Lang::txt('JOPTION_REQUIRED'); ?></span>
                            </label>
                            <select name="fields[open]" id="field-open">
                                <option value="1"<?php if ($this->row->get('open') == 1) {
                                    echo ' selected="selected"';
                                                 } ?>><?php echo Lang::txt('COM_SUPPORT_FIELD_FOR_OPEN'); ?></option>
                                <option value="0"<?php if ($this->row->get('open') == 0) {
                                    echo ' selected="selected"';
                                                 } ?>><?php echo Lang::txt('COM_SUPPORT_FIELD_FOR_CLOSED'); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col span6">
                        <div class="input-wrap">
                            ...
                            <input
                                ...
                                name="fields[color]"
                                id="field-color"
                                value="<?php echo $this->escape($this->row->get('color')); ?>"
                            />
                        </div>
                    </div>
                </div>
