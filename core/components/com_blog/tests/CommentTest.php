...
class CommentTest extends Database
{
    ...
    public function testGetParent()
    {
        ...
        $this->assertInstanceOf(
            '\Components\Blog\Models\Comment',
            $parent,
            'Parent is not an instance of \Components\Blog\Models\Comment'
        );
    ...
    public function testIsReported()
    {
        ...
        $this->assertNotEquals(
            ...
            $comment->get('state'),
            'Comment->state should not have returned a value of ' . Comment::STATE_FLAGGED
        );
        ...
        $this->assertEquals(
            Comment::STATE_FLAGGED,
            $comment->get('state'),
            'Comment->state should have returned a value of ' . Comment::STATE_FLAGGED
        );
