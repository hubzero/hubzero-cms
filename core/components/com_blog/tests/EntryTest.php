...
class EntryTest extends Database
{
    ...
    public function testCommentsRelationship()
    {
        $this->assertCount(
            2,
            Entry::oneOrFail(1)->comments,
            'Model should have returned a count of 2 comments for entry 1'
        );
    }
    ...
    public function testAutomaticAlias()
    {
        ...
        $title = 'Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ' .
