...
@php
  ...
  $feedUrl   = Route::url($feedPath, false);
            ...
            <li class="list-row" id="e{{ $row->get('id') }}">
              <div class="list-col-grow">
                <h3 class="text-base font-semibold">
                  <a class="link link-hover text-primary" href="{{ Route::url($row->link(), false) }}">
                    {{ $row->get('title') }}
                  </a>
                </h3>
                <div class="flex items-baseline gap-x-3 text-sm text-base-content/60">
                    ...
                    <span>
                      ...
                      @if(in_array($authorAccess, $viewLevels))
                        <a class="link link-hover"
                           href="{{ Route::url($row->creator->link(), false) }}">
                  ...
                  @if($row->get('allow_comments') == 1)
                    <a class="link link-hover"
                       href="{{ Route::url($row->link('comments'), false) }}">
