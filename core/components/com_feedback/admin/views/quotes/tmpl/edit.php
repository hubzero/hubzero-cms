        ...
        <div class="col span7">
            <fieldset class="adminform">
                ...
                <div class="input-wrap">
                    <input type="checkbox" name="fields[notable_quote]" id="field-notable_quote" value="1" <?php if ($this->row->get('notable_quote') == 1) {
                ...
                <div class="input-wrap" data-hint="<?php echo Lang::txt('COM_FEEDBACK_USER_ID_EXPLANATION'); ?>">
                    ...
                    <input type="text" name="fields[user_id]" id="field-user_id" value="<?php echo $this->escape(stripslashes($this->row->get('user_id'))); ?>" <?php if ($this->row->get('id') && $this->row->get('user_id')) {
                ...
                <fieldset>
                    ...
                    <div class="input-wrap">
                        <input type="checkbox" name="fields[publish_ok]" id="publish_ok" value="1" <?php if ($this->row->get('publish_ok') == 1) {
                            echo ' checked="checked"';
                                                                                                   } if ($this->row->get('id')) {
                        ...
                        <input type="checkbox" name="fields[contact_ok]" id="contact_ok" value="1" <?php if ($this->row->get('contact_ok') == 1) {
                            echo ' checked="checked"';
                                                                                                   } if ($this->row->get('id')) {
                                                                                                       echo ' disabled="disabled"';
                                                                                                   } ?> />
