...
namespace Components\Modules\Migrations;

use Hubzero\Content\Migration\Base;

/**
 * Migration script for adding component entry for com_modules
 **/
class Migration20170831000000ComModules extends Base
{
    /**
     * Up
     **/
    ...
    {
        $this->deleteComponentEntry('modules');
    }
}
