...
<section class="main section">
    <div class="section-inner hz-layout-with-aside">
        <div class="subject">
        <p id="toggle-prior">
            <strong><a id="toggle-prior-anchor" href="#" onClick="return false;">Show Past Events</a></strong>
        </p>
        ...
        <?php } else { ?>
            <?php $noEventTxt = Lang::txt('EVENTS_CAL_LANG_NO_EVENTFOR'); ?>
            <p class="warning"><?php echo $noEventTxt . ' <strong>' . $this->year . '</strong>'; ?></p>
        <?php } ?>
        </div><!-- / .subject -->
        <div class="aside">
        <form action="<?php echo $yearUrl; ?>" method="get" id="event-categories">
            <fieldset>
