        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input class="option" id="start_pm0" name="start_pm" type="radio"  value="0" <?php if (!$this->times['start_pm']) {
                        echo 'checked="checked"';
                                                                                                 } ?> /><small>AM</small>
                    <input class="option" id="start_pm1" name="start_pm" type="radio"  value="1" <?php if ($this->times['start_pm']) {
                        echo 'checked="checked"';
                                                                                                 } ?> /><small>PM</small>
                    <?php } ?>
                </p>
                ...
                <p>
                    ...
                    <?php if ($this->config->getCfg('calUseStdTime') == 'YES') { ?>
                    <input class="option" id="end_pm0" name="end_pm" type="radio"  value="0" <?php if (!$this->times['end_pm']) {
                        echo 'checked="checked"';
                                                                                             } ?> /><small>AM</small>
                    <input class="option" id="end_pm1" name="end_pm" type="radio"  value="1" <?php if ($this->times['end_pm']) {
                        echo 'checked="checked"';
                                                                                             } ?> /><small>PM</small>
                    <?php } ?>
                </p>
