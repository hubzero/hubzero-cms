...
class Following extends Model
{
    ...
    {
        if (!$this->followerObj) {
            $this->followerObj = $this->adapter('follower');
        }
    ...
    public function following()
    {
        if (!$this->followingObj) {
            $this->followingObj = $this->adapter('following');
        }
     ...
     * @return  object
     */
    private function adapter($key = 'following')
    {
