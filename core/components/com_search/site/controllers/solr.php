...
class Solr extends SiteController
{
    ...
    public function displayTask($response = null)
    {
        ...
        if ($section == 'map') {
            ...
            if ($minLon && $maxLon && $minLat && $maxLat) {
                $locationFilter = 'coverage:"INTERSECTS(ENVELOPE('
        ...
        foreach ($searchComponents as $searchComponent) {
            ...
            $queryOptions = array('exclude' => 'filter_type', 'include' => 'child_type');
            $multifacet->createQuery($searchComponent->getQueryName(), $componentQuery, $queryOptions);
        }
    ...
    private function formatResults($results, $terms)
    {
        ...
        foreach ($results as &$result) {
            ...
            $eventArgs = array($result['hubtype'], &$result, $terms, $highlightOptions);
            $override = Event::trigger('search.onFormatResult', $eventArgs);
