...
<form action="<?php echo $formAction; ?>" method="post" name="adminForm" id="item-form">
    <fieldset class="adminform">
        ...
        <div class="input-wrap">
            ...
            <?php $typeTxt = Lang::txt('COM_NEWSLETTER_STORY_' . ucfirst($this->type)); ?>
            <span class="pseudo-input"><?php echo $typeTxt; ?></span>
            <input
                type="hidden"
                name="type"
                id="field-type"
                value="<?php echo $this->escape(strtolower($this->type)); ?>"
            />
        </div>
        <div class="input-wrap">
            ...
            <input
                ...
                name="story[title]"
                id="field-title"
                value="<?php echo $this->escape($this->story->title); ?>"
            />
        </div>
        <?php if ($this->story->id) : ?>
            <?php $orderHint = Lang::txt('COM_NEWSLETTER_NEWSLETTER_STORY_ORDER_HINT'); ?>
            <div class="input-wrap" data-hint="<?php echo $orderHint; ?>">
                ...
                <input
                    ...
                    id="field-order"
                    readonly
                    value="<?php echo $this->story->order; ?>"
                />
                <span class="hint"><?php echo $orderHint; ?></span>
            </div>
        <?php endif; ?>
        <div class="input-wrap" data-hint="<?php echo Lang::txt('COM_NEWSLETTER_NEWSLETTER_STORY_STORY_HINT1'); ?>">
            ...
            <?php
            $storyContent = $this->escape($this->story->story);
            echo $this->editor(
                "story[story]",
                $storyContent,
                50,
        ...
        <?php
        $titlePlaceholder = Lang::txt(
            'COM_NEWSLETTER_NEWSLETTER_STORY_READMORE_LINK_TITLE_PLACEHOLDER'
        );
        $linkPlaceholder = Lang::txt(
            'COM_NEWSLETTER_NEWSLETTER_STORY_READMORE_LINK_PLACEHOLDER'
        );
        ?>
        <fieldset>
                ...
                <div class="grid">
                    <div class="col span4">
                        <input
                            ...
                            value="<?php echo $this->escape($this->story->readmore_title); ?>"
                            placeholder="<?php echo $titlePlaceholder; ?>"
                        />
                    </div>
                    <div class="col span8">
                        <input
                            ...
                            value="<?php echo $this->escape($this->story->readmore_link); ?>"
                            placeholder="<?php echo $linkPlaceholder; ?>"
                        />
                    </div>
                </div>
            </div>
