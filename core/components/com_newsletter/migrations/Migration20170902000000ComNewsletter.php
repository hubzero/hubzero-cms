        ...
        if ($this->db->tableExists('#__newsletter_templates')) {
            ...
            if (!$id) {
                ...
                $query = "INSERT INTO `#__newsletter_templates` "
                    . "(`editable`, `name`, `template`, `primary_title_color`, "
                    . "`primary_text_color`, `secondary_title_color`, `secondary_text_color`, `deleted`) "
                    . "VALUES (0, 'Default HTML Email Template', '$htmlTemplate', '', '', '', '', 0), "
                    . "(0, 'Default Plain Text Email Template', '$plainTemplate', NULL, NULL, NULL, NULL, 0);";
