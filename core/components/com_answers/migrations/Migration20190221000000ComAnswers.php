...
/**
 * Migration script for changing DATETIME fields default to NULL for com_answers
 **/
class Migration20190221000000ComAnswers extends Base
{
    /**
    ...
    public static $tables = array(
        '#__answers_questions' => array(
            'created'
        ),
        '#__answers_responses' => array(
            'created'
        )
    );
        ...
        foreach (self::$tables as $table => $fields) {
            foreach ($fields as $field) {
                if (
                    ...
                    $query = "ALTER TABLE `$table` CHANGE `$field` `$field` DATETIME "
