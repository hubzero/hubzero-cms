        ...
        >
            <div class="explaination">
                ...
                <?php if ($this->config->get('banking')) { ?>
                    <p class="help">
                        <strong>
                            <?php echo Lang::txt('COM_ANSWERS_WHAT_IS_REWARD'); ?>
                        </strong><br />
                        <?php echo Lang::txt('COM_ANSWERS_EXPLAINED_MARKET_VALUE'); ?>
                        <a href="<?php echo $this->config->get('infolink'); ?>">
                            <?php echo Lang::txt('COM_ANSWERS_LEARN_MORE'); ?>
                        </a>
                        <?php echo Lang::txt('COM_ANSWERS_ABOUT_POINTS'); ?>
                    </p>
                <?php } ?>
            </div><!-- / .explaination -->
            <fieldset>
                ...
                <input
                    type="hidden"
                    name="fields[id]"
                    value="<?php echo $this->escape($this->question->get('id', 0)); ?>"
                />
                ...
                <div class="form-group">
                    <label for="actags">
                        <?php echo Lang::txt('COM_ANSWERS_TAGS'); ?>:
                        <span class="required">
                            <?php echo Lang::txt('COM_ANSWERS_REQUIRED'); ?>
                        </span><br />
                ...
                <div class="form-group">
                    <label for="field-subject">
                        <?php echo Lang::txt('COM_ANSWERS_ASK_ONE_LINER'); ?>:
                        <span class="required">
                            <?php echo Lang::txt('COM_ANSWERS_REQUIRED'); ?>
                        </span><br />
                        <input
                            ...
                            name="fields[subject]"
                            id="field-subject"
                            value="<?php echo $this->escape($this->question->get('subject', '')); ?>"
                        />
                    </label>
                </div>
                ...
                <?php if ($this->config->get('banking')) { ?>
                    <div class="form-group">
                        <label for="field-reward">
                            ...
                            />
                            <?php echo Lang::txt('COM_ANSWERS_YOU_HAVE'); ?>
                            <strong><?php echo $this->escape($this->funds); ?></strong>
                            <?php echo Lang::txt('COM_ANSWERS_POINTS_TO_SPEND'); ?>
                        </label>
                    </div>
                <?php } else { ?>
            ...
            <p class="submit">
                ...
                <?php
                $cancelUrl = $this->question->get('id')
                    ? Route::url($this->question->link())
