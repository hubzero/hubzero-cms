...
<header id="content-header">
    ...
    <div id="content-header-extra">
        <ul id="useroptions">
            ...
            ?>
            <li><a class="icon-status btn" href="<?php echo $statusUrl; ?>">
                <?php echo Lang::txt('COM_TOOLS_TOOL_STATUS'); ?></a></li>
            <li><a class="icon-add btn" href="<?php echo $newUrl; ?>">
...
<section class="main section">
    ...
    <div class="grid">
        <div class="col span-half">
            ...
            $licText = $this->escape(stripslashes($this->license_choice['text']));
            $enterLicTxt = Lang::txt('COM_TOOLS_ENTER_LICENSE_TEXT');
            ?>
            <form action="<?php echo $licenseFormAction; ?>" method="post"
                ...
                <fieldset class="versionfield">
                    ...
                    <div id="closed-source">
                        ...
                        <div class="why-open">
                            <?php echo Lang::txt('COM_TOOLS_LICENSE_WHY_OPEN_SOURCE'); ?></div>
                        <label>
                            <?php echo Lang::txt('COM_TOOLS_LICENSE_CLOSED_REASON'); ?>
                    ...
                    <div id="open-source">
                        ...
                        <div class="licinput">
                            <label>
                                <?php echo Lang::txt('COM_TOOLS_LICENSE_TEXT'); ?>
                                <span class="required"><?php echo Lang::txt('JOPTION_REQUIRED'); ?></span>
                                <textarea name="license" cols="50" rows="15" id="license"
                                    placeholder="<?php echo $enterLicTxt; ?>">
                                    <?php echo $licText; ?></textarea>
                            </label>
                            <?php
                            if ($this->licenses) {
                                foreach ($this->licenses as $l) {
                                    echo '<div class="hidden" id="' . $l->name . '" >'
                                        . $this->escape(stripslashes($l->text))
                                        . '</div>' . "\n";
                                }
                            }
                            ?>
                        ...
                        <label for="field-authorize">
                            ...
                            <span class="required"><?php echo Lang::txt('JOPTION_REQUIRED'); ?></span>
                            <?php echo Lang::txt('COM_TOOLS_LICENSE_CERTIFY')
        ...
        <div class="col span-half omega">
            ...
            <p class="opensource">
                <?php
                $openTxt = strtolower(Lang::txt('COM_TOOLS_OPEN_SOURCE'));
                $openHead = '<strong>' . ucfirst(Lang::txt('COM_TOOLS_OPEN_SOURCE')) . '</strong><br />';
                $openBody = Lang::txt('COM_TOOLS_CONTRIBTOOL_LICENSE_IF_YOU_CHOOSE')
                ...
                echo $openHead . $openBody;
                ?>
            </p>
            <p class="closedsource">
                <strong><?php echo ucfirst(Lang::txt('COM_TOOLS_CLOSED_SOURCE')); ?></strong><br />
                <?php echo Lang::txt('COM_TOOLS_CONTRIBTOOL_LICENSE_CLOSED_TXT'); ?>
            </p>

            <h4>Need help selecting a license?</h4>
            <p>Find more information at:
                <a href="https://choosealicense.com">https://choosealicense.com</a></p>
        </div><!-- / .col span-half -->
    </div><!-- / .grid -->
