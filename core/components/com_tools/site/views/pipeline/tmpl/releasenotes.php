...
<header id="content-header">
	...
	<div id="content-header-extra">
		<ul id="useroptions">
			...
			<li class="last"><a href="<?php echo Route::url('index.php?option='.$this->option.'&controller='.$this->controller.'&task=create'); ?>" class="icon-add btn add"><?php echo Lang::txt('CONTRIBTOOL_NEW_TOOL'); ?></a></li>
		</ul>
