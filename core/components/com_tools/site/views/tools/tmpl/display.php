...
<section id="introduction" class="section">
    <div class="grid">
        <div class="col span9">
            ...
            <p>
                <?php echo Lang::txt(
                    'COM_TOOLS_TOOL_DEVELOPMENT_INTRO',
                    $this->escape($this->forgeName),
                    $this->escape(Config::get('sitename'))
                ); ?>
            </p>
        </div>
        <div class="col span3 omega">
            ...
            <ul>
                <?php $registerUrl = Route::url('index.php?option=com_members&controller=register'); ?>
                <li><a href="<?php echo $registerUrl; ?>"><?php echo Lang::txt('COM_TOOLS_SIGN_UP_FREE'); ?></a></li>
            </ul>
            <?php } ?>
        </div>
    </div>
        ...
        <div class="col span9 omega">
            <table>
                ...
                if (count($this->apps) > 0) {
                    ...
                    echo $cls; ?>">
                        <td><a href="<?php echo $wikiUrl; ?>"><?php echo $truncTitle; ?></a></td>
                        <td><a href="<?php echo $wikiUrl; ?>"><?php
                            echo $this->escape($project->toolname); ?></a></td>
                        <td><span class="<?php echo $status; ?>-code"><?php
                            echo $status; ?></span></td>
                    </tr>
                            <?php
                        }
