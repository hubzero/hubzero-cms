...
<form action="<?php echo $formAction; ?>" method="post" name="adminForm" id="adminForm">
    <table class="adminlist">
        <thead>
            <tr>
                <th colspan="6"><?php echo Lang::txt('COM_TOOLS_COL_ZONE') . ': '
                    . $this->escape($this->zone->get('zone')); ?></th>
            </tr>
            <tr>
                <th scope="col">
                ...
                <th scope="col"><?php echo $sortIpFrom; ?></th>
                <th scope="col"><?php echo $sortIpTo; ?></th>
                <th scope="col"><?php echo $sortContinent; ?></th>
                <th scope="col"><?php echo $sortCountry; ?></th>
            </tr>
        </thead>
        <tfoot>
            <tr>
