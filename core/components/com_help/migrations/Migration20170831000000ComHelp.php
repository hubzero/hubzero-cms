...
namespace Components\Help\Migrations;

use Hubzero\Content\Migration\Base;

/**
 * Migration script for adding component entry for com_help
 **/
class Migration20170831000000ComHelp extends Base
{
    /**
     * Up
     **/
    public function up()
    {
        ...
        // com_help is purposely separate from the 'components' list.
        //
        ...
        $this->addComponentEntry('help', null, 1, '', false);
    }
