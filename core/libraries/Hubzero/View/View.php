...
class View extends Obj
{
    ...
    public function getName()
    {
        if (empty($this->_name)) {
            ...
            if (!$this->_name) {
                ...
                if (strpos($r[3], 'view')) {
                    throw new Exception('Classname contains the substring "view" which causes problems when extracting 
                        the classname.', 500);
                }
     ...
     * @param   mixed   $path  The new search path, or an array of search paths.  If null or false,
