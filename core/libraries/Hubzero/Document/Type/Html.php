...
class Html extends Base
{
    ...
    protected function _fetchTemplate($params = array())
    {
        ...
        $file     = isset($params['file'])     ? preg_replace(
            '/[^A-Z0-9_\.-]/i',
            '',
            $params['file']
        )     : 'index.php';
