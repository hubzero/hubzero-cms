...
class Atom extends Renderer
{
    ...
    public function render($name = '', $params = null, $content = null)
    {
        ...
        $feed .= '	<link rel="self" type="application/atom+xml" href="' .
            str_replace(' ', '%20', $url .
            $syndicationURL) .
            "\"/>\n";
        ...
        for ($i = 0, $count = count($data->items); $i < $count; $i++) {
            ...
            $feed .= "		<published>" .
                ...
                "</published>\n";
            $feed .= "		<updated>" . htmlspecialchars($itemDate->toISO8601(true), ENT_COMPAT, 'UTF-8') . "
            ...
            if ($data->items[$i]->author != "") {
                $feed .= "		<author>\n";
                $feed .= "			<name>" . htmlspecialchars($data->items[$i]->author, ENT_COMPAT, 'UTF-8') . "
