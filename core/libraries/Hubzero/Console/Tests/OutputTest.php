...
class OutputTest extends Basic
{
    ...
    public function testOutputParagraph()
    {
        ...
        $actual = $this->getBuffered(function () use ($output) {
            $paragraph  = 'PBR cred distillery, 
                meggings farm-to-table craft beer pop-up before they sold out health goth.';
            $paragraph .= ' Crucifix drinking vinegar polaroid tote bag before they sold out, 
                flexitarian plaid taxidermy.';
            $paragraph .= ' 90\'s cold-pressed pour-over pug asymmetrical small batch. Roof party freegan ennui 
                single-ori';
            $paragraph .= 'gin coffee, 
                Thundercats trust fund PBR&B flexitarian seitan kitsch bespoke taxidermy Pitchfork ';
            $paragraph .= 'fixie kogi. Church-key typewriter readymade, 
                Portland 8-bit whatever sriracha tofu blog DIY Aus';
            $paragraph .= 'tin. Street art twee salvia, 
                cray McSweeney\'s put a bird on it trust fund ethical bicycle righ';
    ...
    public function testOutputTable()
    {
        ...
        $expected .= '\033[0m| \033[0m\033[0mJohn\033[0m\033[0m    \033[0m\033[0m| \033[0m\033[0mFootball\033[0m\033[0m 
            \033[0m\033[0m|\033[0m\n';
        $expected .= '\033[0m| \033[0m\033[0mStephen\033[0m\033[0m \033[0m\033[0m| \033[0m\033[0mSoccer\033[0m\033[0m   
            \033[0m\033[0m|\033[0m\n';
        $expected .= '\033[0m| \033[0m\033[0mBen\033[0m\033[0m     \033[0m\033[0m| \033[0m\033[0mBaseball\033[0m\033[0m 
            \033[0m\033[0m|\033[0m\n';
        $expected .= '\033[0m\--------------------/\033[0m\n';
