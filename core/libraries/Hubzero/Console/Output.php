...
class Output
{
     ...
     * Set the output mode
     *
     * Assume normal, but minimal and verbose are also options. This isn't setting the format, but it's allowing us to
     * distinguishwhat
     * amount/sorts of data the command should return.  The individual format handler would then format the output
     * appropriately.
     *
     * @public string
     **/
     ...
     *
     * @param   bool  $newLine  Whether or not to include new line with each response (really only
     *                          applies to interactive output)
     * @return  void
     **/
     ...
     * @param   mixed   $styles   Array of custom styles or string containing predefined term (see
     *                            formatLine() for posibilities)
     ...
     * @param   mixed   $styles     Array of custom styles or string containing predefined term
     *                              (see formatLine() for posibilities)
     * @return  $this
     **/
