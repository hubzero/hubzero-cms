...
class DetectorTest extends Basic
{
    ...
    {
        $browser = new Detector('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, 
            like Gecko) Chrome/34.0.1847.132 Safari/537.36 OPR/21.0.1432.67');
        $this->assertTrue($browser->isBrowser('Opera'));
        $this->assertFalse($browser->isBrowser('Chrome'));
        $browser = new Detector('Mozilla/5.0 (iPhone; CPU iPhone OS 8_1_2 like Mac OS X) AppleWebKit/600.1.4 (KHTML, 
            like Gecko) CriOS/43.0.2357.51 Mobile/12B440 Safari/600.1.4');
    ...
    public function testIsMobile()
    {
        ...
        foreach ($uas as $userAgentString) {
            $browser = new Detector($userAgentString->string);
            if (
                $userAgentString->device == 'iPhone' ||
                $userAgentString->device == 'iPad' ||
                $userAgentString->device == 'phone'
            ) {
    ...
    public function testIsRobot()
    {
        $uas = array(
            ...
            'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10 _1) AppleWebKit/600.2.5 (KHTML, 
                like Gecko) Version/8.0.2 Safari/600.2.5 (Applebot/0.1; +http://www.apple.com/go/applebot)' => true,
            'Mozilla/2.0 (compatible; Ask Jeeves/Teoma)' => true,
            'Mozilla/5.0 AppleWebKit/537.36 (KHTML, 
                like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Safari/537.36' => true,
            'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, 
                like Gecko) Chrome/40.0.2214.89 Vivaldi/1.0.83.38 Safari/537.36' => false,
            ...
            'Mozilla/5.0 (X11; CrOS x86_64 4731.101.0) AppleWebKit/537.36 (KHTML, 
                like Gecko) Chrome/31.0.1650.67 Safari/537.36' => false
        );
    ...
    private static function map()
    {
        ...
        $xml = new SimpleXmlElement(file_get_contents(__DIR__ .
            DIRECTORY_SEPARATOR .
            'Fixtures' .
            DIRECTORY_SEPARATOR .
