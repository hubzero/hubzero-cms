...
class Arr
{
     ...
     * @return  array   An array of arrays pivoted either on the value of the keys, or an
     * individual key of an object or array.
     */
     ...
     * @param   mixed  $direction      Direction (integer) or an array of direction to sort in [1 =
