...
class StrTest extends Basic
{
    ...
    public function testStartsWith()
    {
        ...
        $this->assertTrue(
            ...
            'String does not start with given value.'
        );
    ...
    public function testInsert()
    {
        ...
        $result = Str::insert('*name is *age years old.', array('name' => 'Bob',
            'age' => '65'), array('before' => '*'));
        $this->assertEquals($result, 'Bob is 65 years old.');
        $result = Str::insert('*name* is *age* years *old.', array('name' => 'Bob',
            'age' => '65'), array('before' => '*', 'after' => '*'));
        $this->assertEquals($result, 'Bob is 65 years *old.');
    }
    ...
    public function testAmpReplace()
    {
        ...
        $this->assertEquals(
            $result,
            'Cras mattis &#f0c2; consectetur &amp; purus &amp; sit &&amp; amet &amp; fermentum.'
        );
    }
