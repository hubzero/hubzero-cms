            ...
            if ((string) $this->element['action']) {
                ...
                if (!$this->form->getValue($name)) {
                    foreach ($options as $i => $option) {
                        ...
                        // Unset the option if the user isn't authorised for it. In this field assets are always
                ...
                // If you have an existing category id things are more complex.
                    ...
                    foreach ($options as $i => $option) {
                        ...
                        if ($user->authorise('core.edit.state', $extension . '.category.' . $categoryOld) != true) {
                            ...
                            // However, if you can edit.state you can also move this to another category for which
                            // you have create permission and you should also still be able to save in the current
                            // category.
