...
abstract class Driver implements LoggerAwareInterface
{
    ...
    public function reset(array $options = []): void
    {
        ...
        // The savepoint depth belongs to the transaction that was just rolled back
        if (property_exists($this, 'transactionDepth')) {
    ...
    public function execute()
    {
        ...
        // The affected-row count stays available through getAffectedRows();
        // a write that changes nothing must not read as a failed query.
        return $this;
    }
