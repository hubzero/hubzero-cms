...
class NestedTest extends Database
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf(
            ...
            $model,
            'Model is not an instance of \Hubzero\Database\Nested'
        );
    ...
    public function testCanAddNewChildNodeFromParentModel()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            DS .
            'Fixtures' .
            DS .
            'updatedDiscussionsWithNewChildNode.xml')
    ...
    public function testCanAddNewChildNodeFromParentId()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            ...
            'Fixtures' .
            DS .
            'updatedDiscussionsWithNewChildNodeByParentId.xml')
                              ->getTable('discussions');
    ...
    public function testCanAddNewFirstChildNode()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            ...
            'Fixtures' .
            DS .
            'updatedDiscussionsWithNewFirstChild.xml')
                              ->getTable('discussions');
    ...
    public function testCanAddNewRootNode()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            ...
            'Fixtures' .
            DS .
            'updatedDiscussionsWithNewRootNode.xml')
                              ->getTable('discussions');
    ...
    public function testCanDeleteLeafNode()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            ...
            'Fixtures' .
            DS .
            'updatedDiscussionsAfterDelete.xml')
                              ->getTable('discussions');
    ...
    public function testCanDeleteParentNode()
    {
        ...
        $expectedTable = $this->createFlatXmlDataSet(dirname(__FILE__) .
            ...
            'Fixtures' .
            DS .
            'updatedDiscussionsAfterDeleteParent.xml')
                              ->getTable('discussions');
