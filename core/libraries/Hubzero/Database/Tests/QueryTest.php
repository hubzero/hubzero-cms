...
class QueryTest extends Database
{
    ...
    public function testBuildQueryWithAliasedFrom()
    {
        ...
        $this->assertEquals(
            ...
            'Query did not build the expected result'
        );
    }
    ...
    public function testBuildQueryWithJoinClause()
    {
        ...
        $this->assertEquals(
            ...
            'join Query did not build the expected result'
        );
        ...
        $this->assertEquals(
            ...
            'innerJoin Query did not build the expected result'
        );
        ...
        $this->assertEquals(
            ...
            'leftJoin Query did not build the expected result'
        );
        ...
        if ($dbo->getConnection()->getAttribute(\PDO::ATTR_DRIVER_NAME) == 'sqlite') {
            ...
            $this->assertEquals(
                ...
                'rightJoin Query did not build the expected result'
            );
        }
        ...
        if ($dbo->getConnection()->getAttribute(\PDO::ATTR_DRIVER_NAME) == 'sqlite') {
            ...
            $this->assertEquals(
                ...
                'fullJoin Query did not build the expected result'
            );
        }
    }
