...
class DriverTest extends AbstractDriverTestCase
{
    ...
    public function testSetQueryAndExecute(string $dbName, Driver $driver): void
    {
        ...
        // execute() returns the driver so calls chain and a no-op write is not
        // mistaken for a failure; the row count is read separately
        $this->assertSame($driver, $result, 'Execute should return the driver instance');
        $this->assertGreaterThan(0, $driver->getAffectedRows(), 'Should have affected at least 1 row');
    }
