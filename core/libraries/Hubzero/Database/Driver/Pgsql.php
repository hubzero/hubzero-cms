    ...
    public function getTableColumns($table, $typeOnly = true)
    {
        ...
        $this->setQuery('
			...
			SELECT a.attname AS "column_name",
				...
				CASE WHEN a.attnotnull IS TRUETHEN \'NO\'
            ...
            $this->setQuery('
                SELECT indexname as "idxName",
                    ...
                    then (
                        ...
                        FROM pg_constraint as const
                        WHERE const.conname= pgClassFirst.relname
                    )
