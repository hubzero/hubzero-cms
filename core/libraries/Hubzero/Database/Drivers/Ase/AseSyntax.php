 ...
 */
class AseSyntax extends \Hubzero\Database\Drivers\Base\BaseSqlSyntax
{
    /**
    ...
    protected function buildFullJoinEmulationSelect()
    {
        ...
        if (!empty($this->limit) && $this->connection instanceof \Hubzero\Database\Drivers\Ase\AseDriver) {
