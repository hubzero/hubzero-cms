...
class View extends AbstractView
{
     ...
     * @param   string|array  $path  The new set of search paths. If null or false, resets to the
    ...
    public function __call($method, $parameters)
    {
        if (!static::hasHelper($method)) {
            ...
            // Namespaced
            $invokable1 = '\\Plugins\\' .
                ucfirst($this->_folder) .
                '\\' .
                ucfirst($this->_element) .
                '\\Helpers\\' .
                ucfirst($method);
            ...
            } elseif (class_exists($invokable2)) {
