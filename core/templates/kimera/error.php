...
<html dir="<?php echo $this->direction; ?>" lang="<?php echo $this->language; ?>"
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all"
            href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/error.css?v=<?php
                echo filemtime(__DIR__ . '/css/error.css'); ?>" />
    ...
    <body id="error-page">
        ...
        <div id="errorbox">
            <header id="masthead">
                <h1>
                    <a href="<?php echo empty($this->baseurl) ? '/' : $this->baseurl; ?>"
