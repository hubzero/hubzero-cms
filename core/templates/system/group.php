...
?>
<!DOCTYPE html>
<!--[if lt IE 7 ]> <html dir="<?php echo $this->direction; ?>"
    lang="<?php echo $this->language; ?>" class="ie6"> <![endif]-->
<!--[if IE 7 ]>    <html dir="<?php echo $this->direction; ?>"
    lang="<?php echo $this->language; ?>" class="ie7"> <![endif]-->
<!--[if IE 8 ]>    <html dir="<?php echo $this->direction; ?>"
    lang="<?php echo $this->language; ?>" class="ie8"> <![endif]-->
<!--[if IE 9 ]>    <html dir="<?php echo $this->direction; ?>"
    lang="<?php echo $this->language; ?>" class="ie9"> <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!-->
    <html dir="<?php echo $this->direction; ?>" lang="<?php echo $this->language; ?>"
        class="<?php echo $b . ' ' . $b . $v; ?>">
<!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css"
            href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/group.css" />
                ...
                <div class="col span8 omega">
                    <p id="tab">
                        <a href="<?php echo Route::url('index.php?option=com_support'); ?>"
                            title="<?php echo Lang::txt('TPL_SYSTEM_HELP_HINT'); ?>">
                    ...
                    <div id="group" role="navigation">
                        ...
                        <?php elseif ($group->get('join_policy') == 1 && $membership_control == 1) : ?>
                            <a href="<?php
                                echo Route::url('index.php?option=com_groups&cn=' . $group->get('cn') . '&task=join');
                            ?>" class="restricted">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li id="account-logout">
                                            <?php
                                            $logoutUrl = Route::url(
                                                'index.php?option=com_users&view=logout&return='
                        ...
                        <?php else : ?>
                            <ul class="menu loggedout">
                                <?php if (Component::params('com_members')->get('allowUserRegistration') != '0') : ?>
                                    <li id="account-register">
                                        ...
                                        $registerUrl = Route::url(
                                            'index.php?option=com_members&controller=register&return='
                                            . base64_encode($return)
                                        );
                                        ?>
                                        <a href="<?php echo $registerUrl; ?>"
                                            title="<?php echo Lang::txt('TPL_SYSTEM_REGISTER'); ?>">
                                ...
                                <li id="account-login">
                                    <?php
                                    $loginUrl = Route::url(
                                        'index.php?option=com_groups&cn=' . Request::getCmd('cn', '')
                                        . '&task=login&return=' . base64_encode($return)
                                    );
                                    ?>
                                    <a href="<?php echo $loginUrl; ?>"
                                        title="<?php echo Lang::txt('TPL_SYSTEM_LOGIN'); ?>">
        ...
        <div id="group-info">
            ...
            <ul class="links cf">
                ...
                <?php if ($isInvitee && $membership_control == 1) : ?>
                    <?php
                    $acceptUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&task=accept'
                    );
                    ?>
                    <li>
                        <a class="accept" href="<?php echo $acceptUrl; ?>">
                ...
                <?php if ($isPending && $membership_control == 1) : ?>
                    <?php
                    $cancelRequestUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&task=cancel'
                    );
                    ?>
                    <li>
                        <a class="cancel-request" href="<?php echo $cancelRequestUrl; ?>">
                ...
                ?>
                <?php if ($canInvite && $membership_control == 1) : ?>
                    <?php
                    $membersUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&active=members'
                    );
                    ?>
                    <li>
                        <a class="membership" href="<?php echo $membersUrl; ?>">
                ...
                <?php if ($canEdit) : ?>
                    <?php
                    $editUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&task=edit'
                    );
                    ?>
                    <li>
                        <a class="settings" href="<?php echo $editUrl; ?>">
                ...
                <?php if ($canPages) : ?>
                    <?php
                    $pagesUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&task=pages'
                    );
                    ?>
                    <li>
                        <a class="pages" href="<?php echo $pagesUrl; ?>">
                ...
                <?php
                $canCancel = ($isMember || ($isManager && count($group->get('managers')) > 1))
                    && $membership_control == 1;
                ?>
                <?php if ($canCancel) : ?>
                    <?php
                    $cancelUrl = Route::url(
                    ...
                    ?>
                    <li>
                        <a class="cancel" href="<?php echo $cancelUrl; ?>">
                ...
                <?php if ($isManager && $membership_control == 1) : ?>
                    <?php
                    $deleteUrl = Route::url(
                        'index.php?option=com_groups&cn=' . $group->get('cn') . '&task=delete'
                    );
                    ?>
                    <li>
                        <a class="delete danger" href="<?php echo $deleteUrl; ?>">
