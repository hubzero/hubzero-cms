...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>"
    class="no-js <?php echo $this->direction; ?>">
    <head>
...
?></title>
        <link rel="stylesheet" type="text/css"
            href="<?php echo $this->asset('css/error.css'); ?>" />
    </head>
    <body id="error-body">
        <div class="container">
            <header>
            ...
            <main class="content">
                <section>
                    ...
                    <ol>
                        ...
                        <li><?php
                            echo Lang::txt('JERROR_LAYOUT_ERROR_HAS_OCCURRED_WHILE_PROCESSING_YOUR_REQUEST');
                        ?></li>
                    </ol>
                </section>
                <section>
                    ...
                    <ul>
                        <li>
                            <?php
                            // The site's root, not the template's. baseurl
                            // addresses wherever the template was found -
                            // /core when this page is the system template's
                            // fallback - and /core/index.php is a 404, so the
                            // one link on the last-resort error page led
                            // nowhere.
                            ?>
                            <a href="<?php echo rtrim(Request::root(true), '/'); ?>/"
                                title="<?php echo Lang::txt('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><?php
                                    echo Lang::txt('JERROR_LAYOUT_HOME_PAGE');
                                ?></a>
                        </li>
                    </ul>
                </section>
