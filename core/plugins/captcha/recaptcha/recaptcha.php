...
class Recaptcha extends Plugin
{
     ...
     * @var  string
     */
    private static $jsUrl = 'https://www.google.com/recaptcha/api.js';
     ...
     * @var  string
     */
    private static $jsFallbackUrl = 'https://www.google.com/recaptcha/api/fallback?k=';
...
// @phpcs:disable PSR2.Classes.PropertyDeclaration.Underscore
    ...
    public function onDisplay($name = null, $id = 'dynamic_recaptcha_1', $class = '')
    {
        ...
        $html .= '<div class="g-recaptcha" id="' . $id . '" data-type="' . $this->params->get('type', 'image')
            . '" data-theme="' . $this->params->get('theme', 'light') . '" data-sitekey="'
            . $this->params->get('public') . '"></div>
                    <noscript>
                      <div class="g-recaptcha-ns">
                        <div class="g-recaptcha-inner">
                          <div class="g-recaptcha-challenge">
                            <iframe sandbox="allow-scripts allow-same-origin allow-popups" src="'
            . static::$jsFallbackUrl . $this->params->get('public')
            . '" frameborder="0" scrolling="no" title="' . Lang::txt('PLG_CAPTCHA_RECAPTCHA_TITLE') . '">
                    ...
                    <script type="text/javascript" src="' . static::$jsUrl . '?hl='
            . $this->params->get('language', 'en') . '" async defer></script>';
        $html .= '</div>';
        $html .= '</div>';
    ...
    public function onCheckAnswer($code = null)
    {
        ...
        $verificationResponse = $this->submitHttpGet(static::$verifyUrl, array(
     ...
     */
    private function submitHttpGet($url, $data)
    {
        return file_get_contents($url . $this->encodeQS($data));
    }
