...
class plgAuthenticationOrcid extends \Hubzero\Plugin\OauthClient
{
        ...
        if ($oauth->isAuthenticated()) {
            ...
            if (\Hubzero\Auth\Link::getInstance($hzad->id, $username)) {
                ...
                if ($hzal) {
                    ...
                    Log::error(sprintf(
                        'Hubzero\Auth\Link::find_or_create("authentication", "orcid", null, %s) returned false',
                        $username
                    ));
                }
            }
    ...
    public static function onRenderOption($return = null)
    {
        ...
        $html = '<a class="orcid account" href="'
            . Route::url('index.php?option=com_users&view=login&authenticator=orcid' . $return) . '">';
