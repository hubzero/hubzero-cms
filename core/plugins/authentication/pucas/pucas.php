...
// phpcs:ignore PSR2.Classes.PropertyDeclaration.Underscore
        ...
        if (phpCAS::isAuthenticated()) {
            ...
            if (\Hubzero\Auth\Link::getInstance($hzad->id, $username)) {
                ...
                if ($hzal) {
                    ...
                    Log::error(sprintf(
                        'Hubzero\Auth\Link::find_or_create("authentication", "pucas", null, %s) returned false',
                        $username
                    ));
                }
            }
            ...
            if (Config::get('debug')) {
                ...
                if ($debug_location) {
                    if ($this->logger == null) {
                        ...
                        $this->stream_handler = new \Monolog\Handler\StreamHandler(
                            $debug_location,
    ...
    public static function onRenderOption($return = null)
    {
        ...
        $html = '<a class="pucas account" href="'
            . Route::url('index.php?option=com_users&view=login&authenticator=pucas' . $return) . '">';
