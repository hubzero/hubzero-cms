/**
 * @package     hubzero-cms
 * @file        plugins/hubzero/wikieditortoolbar/assets/js/wikieditortoolbar.js
...
(function(jQuery) {
	...
	jQuery.fn.wikitoolbar = function(options) {
		...
		return this.each(function() {
			...
			var toolbar = jQuery(document.createElement('ul'))
							.attr('id', 'wiki-toolbar-' + id)
							.addClass('wiki-toolbar')
							.addClass('hide');
