...
class ConstantContact
{
    ...
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/opens';
    ...
    public function getContactClicks(Contact $Contact, $page = null)
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/clicks';
    ...
    public function getContactForwards(Contact $Contact, $page = null)
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/forwards';
    ...
    public function getContactBounces(Contact $Contact, $page = null)
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/bounces';
    ...
    public function getContactOptOuts(Contact $Contact, $page = null)
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/optouts';
    ...
    public function getContactSends(Contact $Contact, $page = null)
    {
        $ContactsCollection = new ContactsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Contact->link . '/events/sends';
    ...
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        return $CampaignsCollection->getCampaignDetails(
            $this->CTCTRequest->baseUri . "/ws/customers/" . $this->CTCTRequest->username . "/campaigns/" . $ID
        );
    }
    ...
    public function getCampaignOpens(Campaign $Campaign, $page = null)
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Campaign->link . '/events/opens';
    ...
    public function getCampaignForwards(Campaign $Campaign, $page = null)
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Campaign->link . '/events/forwards';
    ...
    public function getCampaignBounces(Campaign $Campaign, $page = null)
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Campaign->link . '/events/bounces';
    ...
    public function getCampaignOptOuts(Campaign $Campaign, $page = null)
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Campaign->link . '/events/optouts';
    ...
    public function getCampaignSends(Campaign $Campaign, $page = null)
    {
        $CampaignsCollection = new CampaignsCollection($this->CTCTRequest);
        $url = ($page) ? $this->CTCTRequest->baseUri . $page
            : $this->CTCTRequest->baseUri . $Campaign->link . '/events/sends';
    ...
    public function getRegistrants(CCEvent $Event, $page = null)
    {
        ...
        return $EventsCollection->getRegistrants(
            $this->CTCTRequest->baseUri . $Event->link . '/registrants?pageNumber=1'
        );
    }
