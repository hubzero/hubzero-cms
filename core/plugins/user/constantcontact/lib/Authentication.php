...
class CTCTOauth2
{
    ...
    public function __construct($apikey, $consumersecret, $redirect, $thecode)
    {
        $this->api_key = $apikey;
...
class CTCTOAuth
{
    ...
    public function __construct($consumer_key, $consumer_secret, $oauth_callback = null)
    {
        if ($oauth_callback) {
    ...
    public function getRequestToken()
    {
        ...
        $this->request_token = new OAuthConsumer(
            $response_params['oauth_token'],
    ...
    public function getAccessToken($oauth_verifier)
    {
        ...
        // Set username
        $this->access_token = new OAuthConsumer(
            $response_params['oauth_token'],
            $response_params['oauth_token_secret'],
            1
        );
    ...
    public function httpRequest($url, $auth_header, $method, $body = null)
    {
        if (!$method) {
            $method = "GET";
        };
...
class CTCTDataStore
{
    ...
    public function lookup_token($username)
    {
    }
...
//changed this so that hubzero code catches exception
        //try{
