...
class Registrant extends CCObject
{
    ...
    public function __construct($params = array())
    {
        ...
        $this->personalInformation = (isset($params['personalInformation']))
            ? $params['personalInformation'] : new PersonalInformation();
        $this->businessInformation = (isset($params['businessInformation']))
            ? $params['businessInformation'] : new BusinessInformation();
    ...
    public static function createStruct($parsedResponse)
    {
        ...
        $reg['personalInformation'] = new PersonalInformation(
            PersonalInformation::createStruct($content->Registrant->PersonalInformation)
        );
        $reg['businessInformation'] = new BusinessInformation(
            BusinessInformation::createStruct($content->Registrant->BusinessInformation)
        );
