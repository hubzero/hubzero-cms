...
class Campaign extends CCObject
{
    ...
    public function __construct($params = array())
    {
        ...
        $this->permissionReminderText = (isset($params['permissionReminderText']))
            ? $params['permissionReminderText'] : '';
        ...
        $this->orgInternationalState = (isset($params['orgInternationalState']))
            ? $params['orgInternationalState'] : '';
