...
use Plugins\Usage\Overview\Overview as plgUsageOverview;
            ...
            $(document).ready(function() {
                ...
                var chart_sim_users = $.plot(csimusers, dataset_sim_users, {
                    ...
                    xaxis: {
                        ...
                        //tickLength: 0,
                        tickDecimals: 0,
                        <?php if (count($simusers) <= 12) {
                            echo 'ticks: ' . count($simusers) . ',';
                        } ?>
                        tickFormatter: function (val, axis) {
                            var d = new Date(val);
                ...
                var chart_sim_jobs = $.plot(csimjobs, dataset_sim_jobs, {
                    ...
                    xaxis: {
                        ...
                        //tickLength: 0,
                        tickDecimals: 0,
                        <?php if (count($simjobs) <= 12) {
                            echo 'ticks: ' . count($simjobs) . ',';
                        } ?>
                        tickFormatter: function (val, axis) {
                            var d = new Date(val);
                            //return month_short[d.getUTCMonth()];//d.getUTCDate() + "/" + (d.getUTCMonth() + 1);
