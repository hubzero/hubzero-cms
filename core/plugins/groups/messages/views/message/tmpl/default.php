...
<div class="subject">
    ...
    $messagesUrl = Route::url(
        ...
        . '&cn=' . $cn . '&active=messages'
    );
    $newMessageUrl = Route::url(
        'index.php?option=' . $this->option
        . '&cn=' . $cn . '&active=messages&action=new'
    );
    ?>
    <?php if (!$this->no_html) : ?>
    <ul class="entries-menu">
        <li>
            <a class="active" href="<?php echo $messagesUrl; ?>">
                <span><?php echo Lang::txt('PLG_GROUPS_MESSAGES_SENT'); ?></span>
            </a>
        </li>
        <?php if ($this->authorized == 'admin' || $this->authorized == 'manager') { ?>
            <li>
                <a href="<?php echo $newMessageUrl; ?>">
    ...
    <form action="<?php echo $messagesUrl; ?>" method="post">
                        ...
                        <span>
                            <small>(
                                <a href="<?php echo $messagesUrl; ?>">
                                    <?php echo Lang::txt('&lsaquo; Back to Sent Messages'); ?>
                                </a>
                            )</small>
                        </span>
                    <?php endif; ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            echo Date::of($this->xmessage->created)
                                ->toLocal($dateFormat);
                            ?>
                        </td>
                    </tr>
