    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 order-first lg:order-last">
            <div class="alert alert-info">
                <span>{{ Lang::txt('PLG_GROUPS_MEMBERS_REMOVE_EXPLANATION') }}</span>
            </div>
        </div>
            ...
            <fieldset class="card bg-base-100 shadow">
                <div class="card-body">
                    <legend class="card-title text-lg">
                        {{ Lang::txt('PLG_GROUPS_MEMBERS_REMOVE_MEMBERSHIP') }}
                    </legend>
                    ...
                    <div class="form-control mb-4">
                        <label class="label">
                            <span class="label-text">
                                {{ Lang::txt('PLG_GROUPS_MEMBERS_REMOVE_USERS') }}
                            </span>
                        </label>
                    ...
                    <div class="form-control">
                        <label class="label" for="reason">
                            <span class="label-text">
                                {{ Lang::txt('PLG_GROUPS_MEMBERS_REMOVE_REASON') }}
                            </span>
                        </label>
