...
?>
        ...
        <div class="comment-content">
            <p class="comment-title">
                ...
                <a class="permalink"
                    ...
                    title="<?php echo Lang::txt('PLG_GROUPS_BLOG_PERMALINK'); ?>">
                    <?php
                    ...
                    <?php if ($this->comment->wasModified()) { ?>
                        ...
                        ?>
                        &mdash;
                        <?php echo Lang::txt('PLG_GROUPS_BLOG_EDITED'); ?>
                        <span class="comment-date-at">
                            <?php echo Lang::txt('PLG_GROUPS_BLOG_AT'); ?>
                        </span>
                        <span class="time">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="comment_<?php echo $this->comment->get('id'); ?>_content">
                            ...
                            $this->comment->get('id') . '_content', array('class' => 'form-control minimal no-footer'));
                            ?>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label comment-anonymous-label"
    ...
    <?php } else { ?>
            ...
            <?php if ($this->config->get('access-delete-comment')) { ?>
                <?php
                $confirmDelete = Lang::txt('PLG_GROUPS_BLOG_CONFIRM_DELETE');
                $deleteUrl = Route::url(
                    $this->base . '&action=deletecomment&comment='
                    . $this->comment->get('id')
                );
                ?>
            ...
            <?php if (!$this->comment->isReported()) { ?>
                ...
                <?php if ($canEditComment) { ?>
                    <?php
                    $editUrl = Route::url(
                        $this->base . '&action=editcomment&comment='
                        . $this->comment->get('id')
                    );
                    ?>
                ...
                <?php if ($this->depth < $this->config->get('comments_depth', 3)) { ?>
                    ...
                    <a class="icon-reply reply active"
                        ...
                        data-txt-inactive="<?php echo Lang::txt('PLG_GROUPS_BLOG_REPLY'); ?>"
                ...
                $abuseUrl = Route::url(
                    ...
                    . '&category=blog&id=' . $this->comment->get('id')
                    . '&parent=' . $this->comment->get('entry_id')
                );
                $commentFormId = 'comment-form' . $this->comment->get('id');
                ?>
                <a class="icon-abuse abuse"
                    href="<?php echo $abuseUrl; ?>"
                    rel="<?php echo $commentFormId; ?>"><!--
                ...
                <form id="cform<?php echo $this->comment->get('id'); ?>"
                    ...
                    <fieldset id="commentform<?php echo $this->comment->get('id'); ?>">
                        ...
                        $replyToName = !$this->comment->get('anonymous')
                            ? $name
                            : Lang::txt('JANONYMOUS');
                        $replyToText = Lang::txt(
                            'PLG_GROUPS_BLOG_REPLYING_TO',
                            $replyToName
                        );
                        ?>
                        <legend>
                            <span><?php echo $replyToText; ?></span>
                        </legend>
                        ...
                        <div class="form-group">
                            <label for="comment_<?php echo $this->comment->get('id'); ?>_content">
                                <?php
                                $commentsLabel = Lang::txt('PLG_GROUPS_BLOG_FIELD_COMMENTS');
                                ?>
