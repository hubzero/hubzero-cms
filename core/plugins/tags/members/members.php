...
// phpcs:ignore PSR2.Classes.PropertyDeclaration.Underscore
    ...
    public function onTagView($tags, $limit = 0, $limitstart = 0, $sort = '', $areas = null)
    {
        ...
        $f_fields = "SELECT a.id,
             a.name AS title, a.username as alias, NULL AS itext, b.profile_value AS ftext, a.activation AS state,
                    a.registerDate AS created,
                    a.id AS created_by, NULL AS modified, a.registerDate AS publish_up, NULL AS publish_down,
                    CONCAT('index.php?option=com_members&id=',
                         a.id) AS href, 'members' AS section, COUNT(DISTINCT t.tagid) AS uniques, a.params,
                    NULL AS rcount,
    ...
    public static function out($row)
    {
        ...
        $html .= "\t\t" . '<p class="photo"><img width="50" height="50" src="' . $member->picture()
            . '" alt="" /></p>' . "\n";
