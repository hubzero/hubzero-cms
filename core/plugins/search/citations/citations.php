...
class Citations extends Plugin
{
    ...
    public static function onSearch($request, &$results, $authz)
    {
        ...
        $weight = 'match(c.title, c.isbn, c.doi, c.abstract, c.author, c.publisher) AGAINST (\''
            . join(' ', $terms['stemmed']) . '\')';
        ...
        $sql_result_one = "SELECT c.id as id FROM #__citations c "
            . "WHERE c.published=1 AND $weight > 0 ORDER BY $weight DESC";
