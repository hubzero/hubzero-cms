...
class Helper extends \Hubzero\Base\Obj
{
    ...
    // publication and the option it is working on, and the views read the
    // reviewer's own review back off it. The same is true of the resources
    // reviews helper, which is the same class under a different name.
    public $_option;
    public $loggedin;
    public $myreview;
    public $publication;
    ...
    private function savereply()
    {
        ...
        $message = $row->id ?
                Lang::txt('PLG_PUBLICATIONS_REVIEWS_EDITS_SAVED') :
                Lang::txt('PLG_PUBLICATIONS_REVIEWS_COMMENT_POSTED');
    ...
    public function savereview()
    {
        ...
        $message = $row->id ?
                Lang::txt('PLG_PUBLICATIONS_REVIEWS_EDITS_SAVED') :
                Lang::txt('PLG_PUBLICATIONS_REVIEWS_REVIEW_POSTED');
