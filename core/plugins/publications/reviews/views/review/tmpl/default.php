...
<div class="below section" id="reviewform">
    ...
    <form action="<?php echo Route::url($this->publication->link('reviews')); ?>" method="post" id="commentform">
            ...
            <fieldset>
                ...
                <input type="hidden"
                    name="publication_version_id"
                    value="<?php echo $review->get('publication_version_id'); ?>"/>
                ...
                <fieldset>
                    ...
                    <label>
                        <input class="option"
                            ...
                            name="rating"
                            type="radio"
                            value="1"<?php if ($review->get('rating') == 1) {
                    ...
                    <label>
                        <input class="option"
                            ...
                            name="rating"
                            type="radio"
                            value="2"<?php if ($review->get('rating') == 2) {
                                echo ' checked="checked"';
                                     } ?> />
                        &#x272D;&#x272D;&#x2729;&#x2729;&#x2729;
                    ...
                    <label>
                        <input class="option"
                            ...
                            name="rating"
                            type="radio"
                            value="3"<?php if ($review->get('rating') == 3) {
                                echo ' checked="checked"';
                                     } ?> />
                        &#x272D;&#x272D;&#x272D;&#x2729;&#x2729;
                    ...
                    <label>
                        <input class="option"
                            ...
                            name="rating"
                            type="radio"
                            value="4"<?php if ($review->get('rating') == 4) {
                                echo ' checked="checked"';
                                     } ?> />
                        &#x272D;&#x272D;&#x272D;&#x272D;&#x2729;
                    ...
                    <label>
                        <input class="option"
                            ...
                            name="rating"
                            type="radio"
                            value="5"<?php if ($review->get('rating') == 5) {
                                echo ' checked="checked"';
                                     } ?> />
                        &#x272D;&#x272D;&#x272D;&#x272D;&#x272D;
                ...
                <label for="review_comments">
                    ...
                    if ($this->banking) {
                        echo ' ( <span class="required">'
                            . Lang::txt('PLG_PUBLICATIONS_REVIEWS_REQUIRED')
                            . '</span> '
                            . Lang::txt('PLG_PUBLICATIONS_REVIEWS_FOR_ELIGIBILITY')
                            . ' <a href="'
                            . $this->infolink
                            . '">'
                            . Lang::txt('PLG_PUBLICATIONS_REVIEWS_EARN_POINTS')
                            . '</a> )';
                    }
                    ?>
                    <?php
                    echo $this->editor(
                        'comment',
                        $this->escape($review->content('raw')),
                        35,
                        10,
                        'review_comments',
                ...
                <label id="review-anonymous-label">
                    <input class="option"
                        ...
                        name="anonymous"
                        id="review-anonymous"
                        value="1"<?php if ($review->get('anonymous') != 0) {
                            echo ' checked="checked"';
                                 } ?> />
