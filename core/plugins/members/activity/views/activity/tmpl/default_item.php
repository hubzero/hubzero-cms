...
if ($this->row->log->get('created_by') == User::get('id')) {
    ...
    $online = true;
} elseif (!$this->row->log->get('anonymous')) {
    // Someone else
    // Is it not anonymous?
    // Get their full name
...
?>
<li data-time="<?php echo $this->row->get('created'); ?>" data-id="<?php echo $this->row->get('id'); ?>"
    data-log_id="<?php echo $this->row->get('log_id'); ?>" data-context="<?php echo $this->row->log->get('scope'); ?>"
    data-action="<?php echo $this->row->log->get('action'); ?>" id="activity<?php echo $this->row->get('id'); ?>"
    class="activity <?php echo $status . ($this->row->get('starred') ? ' starred' : ''); ?>">

    <div class="activity-actor-picture<?php if ($online) {
        echo ' tooltips" title="' . Lang::txt('PLG_MEMBERS_ACTIVITY_ONLINE');
                                      } ?>">
        ...
        <div class="activity-body">
            <div class="activity-details">
                ...
                <span class="activity-time"><time
                        datetime="<?php echo Date::of($this->row->get('created'))->format('Y-m-d\TH:i:s\Z'); ?>"><?php
