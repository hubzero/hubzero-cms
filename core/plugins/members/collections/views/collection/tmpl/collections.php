				...
				<div class="meta">
					...
					<div class="actions">
						<?php if (!User::isGuest()) { ?>
							...
							<?php } ?>
						<?php } else { ?>
							<a class="btn repost tooltips" href="<?php echo Route::url('index.php?option=com_login&return=' . base64_encode(Route::url($base . '&task=' . $row->get('alias'), false, true)), false); ?>" title="<?php echo Lang::txt('PLG_MEMBERS_COLLECTIONS_WARNING_LOGIN_TO_COLLECT'); ?>">
								<span><?php echo Lang::txt('PLG_MEMBERS_COLLECTIONS_COLLECT'); ?></span>
							</a>
							<a class="btn follow tooltips" href="<?php echo Route::url('index.php?option=com_login&return=' . base64_encode(Route::url($base . '&task=' . $row->get('alias'), false, true)), false); ?>" title="<?php echo Lang::txt('PLG_MEMBERS_COLLECTIONS_WARNING_LOGIN_TO_FOLLOW'); ?>">
								<span><?php echo Lang::txt('PLG_MEMBERS_COLLECTIONS_FOLLOW'); ?></span>
							</a>
						<?php } ?>
					</div><!-- / .actions -->
