    ...
    <fieldset class="settings">
        ...
        <label for="field-param-feeds_enabled">
            ...
            <select name="params[feeds_enabled]" id="field-param-feeds_enabled">
                <option value="0"<?php if (!$this->config->get('feeds_enabled', 1)) {
                    echo ' selected="selected"';
                                 }?>><?php echo Lang::txt('PLG_MEMBERS_BLOG_SETTINGS_DISABLED'); ?></option>
                <option value="1"<?php if ($this->config->get('feeds_enabled', 1) == 1) {
                    echo ' selected="selected"';
                                 }?>><?php echo Lang::txt('PLG_MEMBERS_BLOG_SETTINGS_ENABLED'); ?></option>
            </select>
        </label>
        ...
        <label for="field-params-feed_entries">
            ...
            <select name="params[feed_entries]" id="field-params-feed_entries">
                <option value="full"<?php if ($this->config->get('feed_entries', 'partial') == 'full') {
                    echo ' selected="selected"';
                                    }?>><?php echo Lang::txt('PLG_MEMBERS_BLOG_SETTINGS_FULL'); ?></option>
                <option value="partial"<?php if ($this->config->get('feed_entries', 'partial') == 'partial') {
                    echo ' selected="selected"';
                                       }?>><?php echo Lang::txt('PLG_MEMBERS_BLOG_SETTINGS_PARTIAL'); ?></option>
            </select>
        </label>
