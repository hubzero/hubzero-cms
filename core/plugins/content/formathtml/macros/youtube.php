...
class Youtube extends Macro
{
    ...
    public function description()
    {
        ...
        $txt['html'] = '<p>Embeds a Youtube Video into the Page. Accepts either full Youtube ' .
            'video URL or just Youtube Video ID (highlighted below).</p>
            ...
            'src="https://youtube.com/embed/FgfGOEpZEOw" width="640px" height="390px" ' .
            'border="0" title="YouTube video"></iframe>';
    ...
    public function render()
    {
        ...
        return '<iframe sandbox="allow-scripts allow-same-origin" src="' . $youtube_url . '" ' .
            'width="' . $width . '" height="' . $height . '" title="YouTube video"></iframe>';
    }
}
