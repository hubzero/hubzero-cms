...
// @phpcs:ignore PSR1.Methods.CamelCapsMethodName
    public function newconnection()
    {
        ...
        // Redirect
        App::redirect(Route::url($this->model->link('files') . '&action=editconnection&connection='
            . $connection->id, false));*/
...
// @phpcs:ignore PSR1.Methods.CamelCapsMethodName
    ...
    public function browse()
    {
        ...
        $dir = \Hubzero\Filesystem\Entity::fromPath($this->subdir, $this->connection->adapter());
...
// @phpcs:ignore PSR1.Methods.CamelCapsMethodName
    public function setup_base_dir()
    {
        ...
        $dir = \Hubzero\Filesystem\Entity::fromPath($subdir, $this->connection->adapter());
...
// @phpcs:ignore PSR1.Methods.CamelCapsMethodName
    ...
    public function download()
    {
        ...
        if (count($items) > 1) {
            if ($archive = $items->compress()) {
                $result = $archive->serve(
                    'project_files_' . \Components\Projects\Helpers\Html::generateCode(6, 6, 0, 1, 1) . '.zip'
                );
    ...
    private function preview()
    {
        ...
        $view->set('option', $this->_option);
        $view->set('model', $this->model);
        $view->set('file', \Hubzero\Filesystem\Entity::fromPath($path, $this->connection->adapter()));
    ...
    public function save()
    {
        ...
        if (isset($_FILES['qqfile'])) {
            ...
            $file = \Hubzero\Filesystem\Entity::fromPath($path, $this->connection->adapter());
...
// @phpcs:ignore PSR1.Methods.CamelCapsMethodName
    ...
    public function move()
    {
        ...
        $root = \Hubzero\Filesystem\Entity::fromPath('', $this->connection->adapter());
    ...
    public function renameit()
    {
        ...
        // Rename
        $entity = \Hubzero\Filesystem\Entity::fromPath(Request::getString('oldname', ''), $this->connection->adapter());
    ...
    public function savedir()
    {
        ...
        // Create
        $entity = \Hubzero\Filesystem\Entity::fromPath(
            trim($this->subdir, '/') . '/' . trim(Request::getString('newdir', '')),
    ...
    public function annotate()
    {
        ...
        if ($editors && isset($editors[0]) > 0 && $editors[0] instanceof View) {
            $view = $editors[0];
        }
    ...
    public function annotateit()
    {
        ...
        $entity = \Hubzero\Filesystem\Entity::fromPath($file, $this->connection->adapter());
    ...
    private function getCollection()
    {
        ...
        $collection = new \Hubzero\Filesystem\Collection();
        ...
        if (!empty($entities) && is_array($entities)) {
            foreach ($entities as $entity) {
                ...
                $collection->add(\Hubzero\Filesystem\Entity::fromPath($path, $this->connection->adapter()));
            }
        }
