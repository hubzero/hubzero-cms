...
$headingText = $this->row->id
    ? Lang::txt('PLG_PROJECTS_LINKS_SELECTOR_EDIT_CITATION')
    : Lang::txt('PLG_PROJECTS_LINKS_SELECTOR_ADD_CITATION');
...
<div id="abox-content" class="citation-edit">
    ...
    <h3>
        ...
        <span class="abox-controls">
            <a class="btn btn-success active"
                id="b-add"><?php echo Lang::txt('PLG_PROJECTS_LINKS_SELECTOR_SAVE_CITATION'); ?></a>
            <?php if ($this->ajax) { ?>
    ...
    <form id="add-cite"
        ...
        <div class="cite-wrap">
            <?php
            $typeLabel = Lang::txt('PLG_PROJECTS_LINKS_SELECTOR_CITE_TYPE');
            $requiredText = Lang::txt('PLG_PROJECTS_LINKS_REQUIRED');
            $selectTypeText = Lang::txt(
                'PLG_PROJECTS_LINKS_SELECTOR_CITE_SELECT_TYPE'
            );
            ?>
            <label for="type">
                <?php echo $typeLabel; ?>: <span class="required"><?php echo $requiredText; ?></span>
                <select name="cite[type]" id="type" class="inputrequired">
                    <option value="">- <?php echo $selectTypeText; ?> -</option>
                    <?php
            ...
            <?php
            $titleLabel = Lang::txt(
                'PLG_PROJECTS_LINKS_SELECTOR_CITE_TITLE'
            );
            ?>
            <label for="title">
                <?php echo $titleLabel; ?>: <span class="required"><?php echo $requiredText; ?></span>
                <input type="text"
                    name="cite[title]"
                    id="title"
                    size="30"
            ...
            <label for="author">
                ...
                ?>
                <span class="hint"><?php echo $authorHint; ?></span>
            </label>
            ...
            <label for="eprint">
                ...
                <?php
                $eprintHint = Lang::txt(
                    'PLG_PROJECTS_LINKS_SELECTOR_CITE_EPRINT_EXPLANATION'
                );
                ?>
                <span class="hint"><?php echo $eprintHint; ?></span>
            </label>
            ...
            <div class="grid">
                ...
                <div class="col span6 omega">
                    <?php
                    $doiLabel = Lang::txt(
                        'PLG_PROJECTS_LINKS_SELECTOR_CITE_DOI'
                    );
                    ?>
                    <label for="doi">
                        <abbr title="<?php echo $doiLabel; ?>"><?php echo $doiLabel; ?></abbr>:
                        <input type="text"
                            name="cite[doi]"
                            id="doi"
                            size="30"
            ...
            <label for="abstract">
                ...
                <textarea name="cite[abstract]"
                    id="abstract"
                    rows="4"
                    cols="10"><?php echo stripslashes($this->row->abstract ? $this->row->abstract : ""); ?></textarea>
            </label>
            ...
            <label for="edition">
                ...
                <?php
                $editionHint = Lang::txt(
                    'PLG_PROJECTS_LINKS_SELECTOR_CITE_EDITION_EXPLANATION'
                );
                ?>
                <span class="hint"><?php echo $editionHint; ?></span>
            </label>
        ...
        <div class="formatted-cite">
            ...
            <label for="formatted">
                <textarea name="cite[formatted]"
                    id="formatted"
                    rows="4"
                    cols="10"><?php echo stripslashes($this->row->formatted()); ?></textarea>
                <?php
                $fmtHint = Lang::txt(
                    'PLG_PROJECTS_LINKS_SELECTOR_CITE_FORMATTED_EXPLANATION'
                )
                    . ' ' . Lang::txt(
                        'PLG_PROJECTS_LINKS_SELECTOR_CITE_FORMATTED_FORMAT'
                    )
                    . ' ' . strtoupper($citationFormat);
                ?>
                <span class="hint"><?php echo $fmtHint; ?></span>
            </label>
        </div>
    </form>
</div>
