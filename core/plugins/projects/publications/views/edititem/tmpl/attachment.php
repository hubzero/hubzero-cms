                ...
                <?php if ($this->row->type == 'file') { ?>
                    <?php if ($gone || !$allowRename) { ?>
                        ...
                        <p class="c-wrapper">
                            ...
                            <textarea name="description" class="long" rows="10" cols="60" maxlength="5000" value="<?php echo $this->row->attribs; ?>" placeholder="Enter up to 5000 characters..."><?php echo $this->row->attribs;
                            ; ?></textarea>
                        </p>
                    <?php } else { ?>
                        <p class="c-wrapper">
