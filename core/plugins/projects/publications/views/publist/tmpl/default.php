		...
		<?php foreach ($this->items as $pub) { ?>
			<li>
				...
				<span class="pub-details">
					<a href="<?php echo Route::url($pub->link('version')); ?>" title="<?php echo $this->escape($pub->get('title')); ?>"><?php echo $this->escape(stripslashes($pub->get('title'))) . ' v.' . $this->escape($pub->get('version_label')); ?></a>
