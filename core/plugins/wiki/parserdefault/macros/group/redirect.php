...
class Redirect extends GroupMacro
{
    ...
    public function description()
    {
        return '<p>Redirects to a URL with an optional delay (in seconds).</p>'
            ...
            . '<li><code>[[Group.Redirect(https://google.com, 5)]]</code> '
            . '- Wait 5 seconds before redirecting.</li>'
            . '</ul>';
    }
    ...
    public function render()
    {
        ...
        // Delayed redirect
        return '<script type="text/javascript">setTimeout(function () { window
            . location
            . href = "'
            . str_replace(array("'", '"'), array('%27', '%22'), $url)
            . '"; }, '
            . ($delay * 1000)
            . ');</script>
                <p class="warning">' . \Hubzero\Facades\Lang::txt('This page will redirect in %s seconds', $delay) . '</p>';
    }
}
