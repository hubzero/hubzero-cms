...
class Video extends WikiMacro
{
    ...
    public function description()
    {
        ...
        $txt['html'] = '<p>Embeds a video into the Page. Accepts either full video URL '
            ...
            . 'When a name attribute is not given (e.g., 600, 338), '
            . 'the first value will be set as width and the second value as height.</p>'
            . '<p>Examples:</p>'
            . '<ul>'
            . '<li><code>[[Video(MyVideo.m4v, width="600", height="338")]]</code></li>'
            . '<li><code>[[Video(https://www.youtube.com/watch?v=FgfGOEpZEOw, width=600px, '
            . 'height=338px)]]</code></li>'
        ...
        if (stristr($video_url, 'youtube')) {
            ...
            if (!stristr($video_url, 'iframeembed') && stristr($video_url, 'kmc')) {
                ...
                $video_url = 'https://www
                    ...
                    . '/partner_id/'
                    . $partner_id
                    . '?iframeembed=true&playerId=movie'
                    . rand(0, 1000)
                    . '&entry_id='
                    . $entry_id
     ...
     *
     * @param      $file    Filename
     * @param      $alt  Switches between relative and absolute path?
     * @return     string
     */
