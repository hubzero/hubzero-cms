...
// phpcs:ignore PSR2.Classes.PropertyDeclaration.Underscore
    ...
    protected function getEndpoints()
    {
        ...
        foreach (array(1, 2, 3) as $point) {
            ...
            $endpoints[] = array(
                ...
                'channel_created' => ($this->params->get('channel_created' . $sfx)
                    ? $this->params->get('channel_created' . $sfx)
                    : $this->params->get('channel' . $sfx)),
                // Ticket updated
                ...
                'channel_updated' => ($this->params->get('channel_updated' . $sfx)
                    ? $this->params->get('channel_updated' . $sfx)
                    : $this->params->get('channel' . $sfx))
            );
        }
    ...
    public function onTicketSubmission($ticket)
    {
        ...
        foreach ($endpoints as $endpoint) {
            ...
            $data = array(
                ...
                'color' => $color, // Change the color of the attachment, default is 'good'.
    ...
    public function onTicketUpdate($ticket, $comment)
    {
        ...
        foreach ($endpoints as $endpoint) {
            ...
            $pretext = Lang::txt(
                'PLG_SUPPORT_SLACK_TICKET_UPDATED',
                Config::get('sitename')
