    ...
    public function up()
    {
        ...
        if (!$schema->tableExists('#__publication_categories')) {
            ...
            $categories = [
                ...
                ['2', 'Workshops', 'Event', 'workshop', 'workshops', $desc2, '0', '0', $customFields, $params],
                [
                    '3',
                    'Publications',
                    'Dataset',
                ...
                ['5', 'Animations', 'MovingImage', 'animation', 'animations', $desc5, '0', '0', $customFields, $params],
                ['6', 'Courses', 'Collection', 'course', 'courses', $desc6, '0', '0', $customFields, $params],
                ['7', 'Tools', 'Software', 'tool', 'tools', $desc7, '0', '1', $customFieldsTool, $params],
                ['9', 'Downloads', 'PhysicalObject', 'download', 'downloads', $desc9, '0', '0', $customFields, $params],
                ['10', 'Notes', 'Text', 'note', 'notes', $desc10, '0', '0', $customFields, $params],
                ['11', 'Series', 'Collection', 'series', 'series', $desc11, '0', '0', $customFields, $params],
                [
                    '12',
                    'Teaching Materials',
                    'Text',
