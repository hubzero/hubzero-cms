...
/**
 * Migration script for changing DATETIME fields default to NULL for comments tables
 **/
class Migration20190305000000ItemComments extends Base
{
	/**
