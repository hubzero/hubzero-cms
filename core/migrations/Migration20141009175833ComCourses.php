...
class Migration20141009175833ComCourses extends Base
{
    ...
    public function up()
    {
        if (
            ...
            && strtolower($this->db->getEngine('#__courses_form_answers')) != 'myisam'
        ) {
        ...
        if (
            ...
            && strtolower($this->db->getEngine('#__courses_form_deployments')) != 'myisam'
        ) {
        ...
        if (
            $this->db->tableExists('#__courses_form_questions')
            && strtolower($this->db->getEngine('#__courses_form_questions')) != 'myisam'
        ) {
        ...
        if (
            $this->db->tableExists('#__courses_form_respondent_progress')
            && strtolower($this->db->getEngine('#__courses_form_respondent_progress')) != 'myisam'
        ) {
        ...
        if (
            ...
            && strtolower($this->db->getEngine('#__courses_form_respondents')) != 'myisam'
        ) {
        ...
        if (
            ...
            && strtolower($this->db->getEngine('#__courses_form_responses')) != 'myisam'
        ) {
        ...
        if (
            $this->db->tableExists('#__courses_forms')
            && strtolower($this->db->getEngine('#__courses_forms')) != 'myisam'
        ) {
        ...
        if (
            $this->db->tableExists('#__courses_offering_section_badge_criteria')
            && strtolower($this->db->getCharacterSet('#__courses_offering_section_badge_criteria')) != 'utf8'
        ) {
        ...
        if (
            ...
            $query = "ALTER TABLE `#__courses_offering_section_badge_criteria` "
                . "CHANGE `text` `text` TEXT CHARACTER SET utf8 NOT NULL;";
            $this->db->setQuery($query);
            $this->db->query();
        }
    }
