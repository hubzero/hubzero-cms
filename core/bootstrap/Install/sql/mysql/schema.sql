...
CREATE TABLE `#__menu` (
  ...
  `note` varchar(255) NOT NULL DEFAULT '',
  `path` varchar(1024) NOT NULL COMMENT 'The address this item answers at. Follows the menu unless route says otherwise.',
  `route` varchar(1024) DEFAULT NULL COMMENT 'An address of its own, so a page can sit anywhere in the menu and still answer where it always did.',
