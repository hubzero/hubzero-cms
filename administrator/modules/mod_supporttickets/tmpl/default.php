	...
	<div class="breakdown">
		<table class="support-stats-overview open-tickets">
			<tbody>
				<tr>
					<td class="major">
						<a href="index.php?option=com_support&amp;controller=tickets" title="<?php echo JText::_('MOD_SUPPORTTICKETS_OPEN_TITLE'); ?>">
							<?php echo $this->escape($this->topened[0]->count); ?>
							<span><?php echo JText::_('MOD_SUPPORTTICKETS_OPEN'); ?></span>
						</a>
					</td>
					<td class="critical">
						<a href="index.php?option=com_support&amp;controller=tickets" title="<?php echo JText::_('MOD_SUPPORTTICKETS_UNASSIGNED_TITLE'); ?>">
							<?php echo $this->escape($this->topened[2]->count); ?>
							<span><?php echo JText::_('MOD_SUPPORTTICKETS_UNASSIGNED'); ?></span>
						</a>
					</td>
					<td class="newt">
						<a href="index.php?option=com_support&amp;controller=tickets" title="<?php echo JText::_('MOD_SUPPORTTICKETS_NEW_TITLE'); ?>">
