...
JToolBarHelper::title(JText::_('COM_STOREFRONT') . ': ' . JText::_('COM_STOREFRONT_PRODUCT_META') . ': ' . $text, 'kb.png');
...
<form action="index.php" method="post" name="adminForm" id="item-form">
		...
		<fieldset class="adminform">
			...
			<div class="input-wrap">
				...
				<select name="fields[eulaRequired]" id="eulaRequired">
					<option value="0"<?php if ($this->meta->eulaRequired == 0) { echo ' selected="selected"'; } ?>><?php echo JText::_('COM_STOREFRONT_NO'); ?></option>
					<option value="1"<?php if ($this->meta->eulaRequired == 1) { echo ' selected="selected"'; } ?>><?php echo JText::_('COM_STOREFRONT_YES'); ?></option>
				</select>
			</div>
	...
	<div class="col width-40 fltrt">
		...
		<table class="meta">
			<tbody>
			<tr>
				<th class="key"><?php echo JText::_('COM_STOREFRONT_PRODUCT') . ' ' . JText::_('COM_STOREFRONT_ID'); ?>:</th>
				<td>
