...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    define('_XMAP_CFG_CLICK_HERE', 'Kattintson ide');
    ...
    // -- Tips ---------------------------------------------------------------------
    define('_XMAP_EXCLUDE_MENU_TIP',		'Adja meg a helytérképbõl kihagyandó menüazonosítókat.<br /><strong>MEGJEGYZÉS</strong><br />Válassza el vesszõvel az azoosítókat!');

    // -- Menus --------------------------------------------------------------------
    define('_XMAP_CFG_SET_ORDER', 'Állítsa be a menük megjelenítésének sorrendjét');
    ...
    define('_XMAP_CFG_DISABLE', 'Kattintson rá a letiltáshoz');
    define('_XMAP_CFG_ENABLE', 'Kattintson rá az engedélyezéshez');
    ...
    define('_XMAP_HTML_LINK_TIP',	'Ez az oldaltérkép URL-je. Menüpontok létrehozásához is felhasználhatja.');
	...
	define('_XMAP_USE_COMPRESSION','Compress the XML sitemap to save bandwidth');
        ...
        define('_XMAP_NEWS_LINK_TIP',   'This is the news sitemap\'s URL. You can use it to create items on your menus.');
