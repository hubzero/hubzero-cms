...
<?php
	if ($this->pid != '-1') {
		...
		echo '<h3><a href="index.php?option='.$this->option.'&amp;task=edit&amp;id[]='.$this->pid.'">'. stripslashes($this->parent->title) .'</a></h3>'."\n";
	}
?>
...
?>
			<tr class="<?php echo "row$k"; ?>">
				...
				<td><a class="<?php echo $class;?>" href="index.php?option=<?php echo $this->option ?>&amp;task=<?php echo $task; ?>&amp;id[]=<?php echo $row->id; echo $filterstring; ?>" title="Set this to <?php echo $task;?>"><span><?php echo $alt; ?></span></a></td>
				<td><a href="index.php?option=<?php echo $this->option ?>&amp;task=<?php echo $task_access; ?>&amp;id=<?php echo $row->id; echo $filterstring; ?>" <?php echo $color_access; ?> title="Change Access"><?php echo $row->groupname;?></a></td>
...
<?php if ($this->parent->type == 4) { ?>
				<td><?php echo ResourcesHtml::selectSection('grouping'.$row->id, $this->sections, $row->grouping, '', $i); ?></td>
<?php } ?>
<?php } ?>
	  		</tr>
<?php
