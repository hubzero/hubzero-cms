 ...
 * @since		1.6
 */
class ResourcesModelRole extends JModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_resources.role', 'role', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	/**
		 ...
		 * @since	1.7
		 */
	public function getTable($type = 'Role', $prefix = 'Resources', $config = array())
	{
