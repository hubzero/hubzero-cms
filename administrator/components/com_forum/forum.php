...
require_once(JPATH_COMPONENT_SITE . DS . 'models' . DS . 'manager.php');
...
\JSubMenuHelper::addEntry(
	...
	\JRoute::_('index.php?option=com_forum&controller=sections'),
	($controllerName == 'sections')
);
\JSubMenuHelper::addEntry(
	\JText::_('COM_FORUM_CATEGORIES'),
	\JRoute::_('index.php?option=com_forum&controller=categories&section_id=-1'),
	($controllerName == 'categories')
);
\JSubMenuHelper::addEntry(
	\JText::_('COM_FORUM_THREADS'),
	\JRoute::_('index.php?option=com_forum&controller=threads&category_id=-1'),
