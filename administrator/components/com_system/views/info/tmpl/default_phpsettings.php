...
<fieldset class="adminform">
	<legend><?php echo JText::_('COM_SYSTEM_INFO_RELEVANT_PHP_SETTINGS'); ?></legend>
	<table class="adminlist">
		<thead>
			<tr>
				<th scope="col">
					<?php echo JText::_('COM_SYSTEM_INFO_SETTING'); ?>
				</th>
				<th scope="col">
					<?php echo JText::_('COM_SYSTEM_INFO_VALUE'); ?>
				</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_SAFE_MODE'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_OPEN_BASEDIR'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_DISPLAY_ERRORS'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_SHORT_OPEN_TAGS'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_FILE_UPLOADS'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_MAGIC_QUOTES'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_REGISTER_GLOBALS'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_OUTPUT_BUFFERING'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_SESSION_SAVE_PATH'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_SESSION_AUTO_START'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_XML_ENABLED'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_ZLIB_ENABLED'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_ZIP_ENABLED'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_DISABLED_FUNCTIONS'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_MBSTRING_ENABLED'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<?php echo JText::_('COM_SYSTEM_INFO_ICONV_AVAILABLE'); ?>
				</th>
				<td>
