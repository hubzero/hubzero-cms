...
class CoursesTableReason extends JTable
{
	...
	{
		parent::__construct('#__courses_reasons', 'id', $db);
	}

	/**
	 * Load a record based on course ID and user ID and bind to $this
	 * 
	 * @param      integer $uid User ID
	 * @param      integer $gid Course ID
	...
	/**
	 * Delete an entry based on course ID and user ID
	 * 
	 * @param      integer $uid User ID
	 * @param      integer $gid Course ID
	 * @return     boolean True on success
	...
	public function check()
	{
		...
		{
			$this->setError(JText::_('COURSES_REASON_MUST_HAVE_COURSEID'));
			return false;
		}

		if (trim($this->uidNumber) == '') 
		{
			$this->setError(JText::_('COURSES_REASON_MUST_HAVE_USERNAME'));
			return false;
		}
