...
<form action="<?php echo JRoute::_('index.php?option=com_templates&view=styles'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" placeholder="<?php echo JText::_('COM_TEMPLATES_STYLES_FILTER_SEARCH_DESC'); ?>" />
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<?php if ($item->assigned > 0) : ?>
							<span class="state yes" title="<?php echo JText::plural('COM_TEMPLATES_ASSIGNED', $item->assigned); ?>">
								<span class="text"><?php echo JText::plural('COM_TEMPLATES_ASSIGNED', $item->assigned); ?></span>
							</span>
					<?php else : ?>
							&#160;
					<?php endif; ?>
