...
// Menu
JToolBarHelper::title(JText::_('COM_TOOLS_SESSION_CLASSES'), 'user.png');
JToolBarHelper::addNew();
JToolBarHelper::editList();
JToolBarHelper::deleteList('COM_TOOLS_SESSION_CLASSES_CONFIRM_DELETE', 'delete');
JToolBarHelper::spacer();
JToolBarHelper::help('sessionclasses');
?>
	...
	<table class="adminlist">
		<thead>
		 	<tr>
				...
				<th><?php echo JText::_('COM_TOOLS_SESSION_CLASS_ALIAS'); ?></th>
				<th><?php echo JText::_('COM_TOOLS_SESSION_CLASS_JOBS'); ?></th>
			</tr>
		</thead>
		<tfoot>
			<tr>
