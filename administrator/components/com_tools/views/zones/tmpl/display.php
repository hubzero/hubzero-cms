...
JToolBarHelper::makeDefault('default', 'COM_TOOLS_MAKE_DEFAULT');
...
?>
			<tr>
				...
				<td>
					<a href="index.php?option=<?php echo $this->option; ?>&amp;controller=locations&amp;zone=<?php echo $row->get('id'); ?>&amp;tmpl=index">
