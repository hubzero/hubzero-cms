 ...
 */
class ToolsTableSessionClassGroup extends \JTable
{
	/**
	 * Constructor
	 *
	...
	public function check()
	{
		if (!$this->class_id)
		{
			$this->setError(JText::_('COM_TOOLS_SESSION_CLASS_MUST_HAVE_CLASS_ID'));
		}

		if (!$this->class_id)
		{
			$this->setError(JText::_('COM_TOOLS_SESSION_CLASS_MUST_HAVE_GROUP_ID'));
		}
