...
JToolBarHelper::title(JText::_('GEOdb Configuration'), 'addedit.png');
JToolBarHelper::preferences('com_geodb', '550');

?>
Import old HubConfig GEOdb configuration...
<form action="index.php" method="post" name="adminForm">
	<input type="hidden" name="option" value="com_geodb" />
