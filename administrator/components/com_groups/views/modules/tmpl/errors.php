...
JToolBarHelper::title($this->group->get('description').': '.$this->module->get('title').' - ' . JText::_('COM_GROUPS_MODULES_ERRORS'), 'groups.png');
JToolBarHelper::custom('errorscheckagain', 'check', 'check', 'COM_GROUPS_MODULES_CHECK_AGAIN', false);
...
<form action="index.php?option=<?php echo $this->option ?>&amp;controller=<?php echo $this->controller; ?>&amp;gid=<?php echo $this->group->cn; ?>" method="post" name="adminForm" id="item-form">
	...
	<p class="error">
		<?php echo JText::sprintf('COM_GROUPS_MODULES_ERROR_LIST' , $this->module->get('title'), $this->error); ?>
	</p>
