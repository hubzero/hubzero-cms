...
<form action="<?php echo JRoute::_('index.php?option=' . $this->option . '&controller=' . $this->controller . '&gid=' . $this->group->cn); ?>" name="adminForm" id="item-form" method="post">
	<div class="col width-50 fltlft">
		<fieldset class="adminform">
			<legend><span><?php echo JText::_('COM_GROUPS_MODULES_DETAILS'); ?></span></legend>

			<div class="input-wrap">
				<label for="field-title"><?php echo JText::_('COM_GROUPS_MODULES_TITLE'); ?>:</label>
				<input type="text" name="module[title]" id="field-title" value="<?php echo $this->escape($this->module->get('title')); ?>" size="50" />
			</div>
			<div class="input-wrap">
				<label for="field-position"><?php echo JText::_('COM_GROUPS_MODULES_POSITION'); ?>:</label>
				<input type="text" name="module[position]" id="field-position" value="<?php echo $this->escape($this->module->get('position')); ?>" size="50" />
			</div>
			<div class="input-wrap">
				<label for="field-type"><?php echo JText::_('COM_GROUPS_MODULES_STATUS'); ?>:</label>
			...
			<div class="input-wrap">
				<label for="field-ordering"><?php echo JText::_('COM_GROUPS_MODULES_ORDERING'); ?>:</label>
		...
		<fieldset class="adminform">
			...
			<div class="input-wrap">
				<label for="field-assignment"><?php echo JText::_('COM_GROUPS_MODULES_MODULE_ASSIGNMENT'); ?>:</label>
	...
	<div class="col width-50 fltrt">
		...
		<fieldset class="adminform">
			...
			<div class="input-wrap">
				<label for="field-content"><?php echo JText::_('COM_GROUPS_MODULES_CONTENT'); ?>:</label>
