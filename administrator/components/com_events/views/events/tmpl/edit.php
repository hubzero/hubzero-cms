			...
			<table class="admintable">
				<tbody>
					<tr>
						...
						<td>
							<input type="radio" name="announcement" value="0" <?php if ($this->row->announcement == 0) { echo 'checked="checked"'; } ?> /> <?php echo JText::_('EVENT'); ?></label><br />
							<input type="radio" name="announcement" value="1" <?php if ($this->row->announcement == 1) { echo 'checked="checked"'; } ?> /> <?php echo JText::_('ANNOUNCEMENT'); ?></label>
						</td>
					</tr>
					<tr>
