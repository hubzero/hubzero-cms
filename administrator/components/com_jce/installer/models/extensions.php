<?php
/**
 * @version		$Id: extensions.php 47 2009-05-26 18:06:30Z happynoodleboy $
 * @package		Joomla
...
class InstallerModel extends JModel
{
	...
	function __construct()
	{
		...
		$this->setState('pagination.offset',$mainframe->getUserStateFromRequest('$option.$type.$task.$client.limitstart.'.$this->_type, 'limitstart', 0, 'int'));
	...
	function remove($eid=array())
	{
		...
		$installer = & JCEInstaller::getInstance();
