<tr class="<?php echo "row".$this->item->index % 2; ?>" <?php echo $this->item->style; ?>>
    ...
    <td><input type="checkbox" id="cb<?php echo $this->item->index;?>" name="eid[<?php echo $this->item->id; ?>]" value="" onclick="isChecked(this.checked);" <?php echo $this->item->cbd; ?> /></td>
	<td><span class="bold"><?php echo $this->item->name; ?></span></td>
    <td><span class="bold"><?php echo $this->item->plugin; ?></span></td>
