...
/**
 * This class adds structure of 'SENSOR_MANIFEST' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class SensorManifestMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.SensorManifestMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('SENSOR_MANIFEST');
		$tMap->setPhpName('SensorManifest');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('SENSOR_MANIFEST_SEQ');
