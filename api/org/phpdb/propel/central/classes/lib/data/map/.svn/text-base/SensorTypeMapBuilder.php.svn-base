...
/**
 * This class adds structure of 'SENSOR_TYPE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class SensorTypeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.SensorTypeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('SENSOR_TYPE');
		$tMap->setPhpName('SensorType');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('SENSOR_TYPE_SEQ');
