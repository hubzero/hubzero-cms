...
/**
 * This class adds structure of 'EQUIPMENT_GROUPED_ATTRIBUTE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class EquipmentGroupedAttributeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.EquipmentGroupedAttributeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('EQUIPMENT_GROUPED_ATTRIBUTE');
		$tMap->setPhpName('EquipmentGroupedAttribute');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('QPMNT_GRPD_TTRBT_SEQ');
...
} // EquipmentGroupedAttributeMapBuilder
