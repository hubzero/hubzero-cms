...
require_once 'lib/data/tsunami/om/BaseTsunamiEngineeringDataPeer.php';
...
/**
 * Skeleton subclass for performing query and update operations on the 'TsunamiEngineeringData' table.
 *
 *
 *
 ...
 */
class TsunamiEngineeringDataPeer extends BaseTsunamiEngineeringDataPeer {

  /**
   * Find a TsunamiEngineeringData object based on its ID
   *
   * @param int $id
  ...
  /**
   * Find all TsunamiEngineeringDatas
   *
   * @return array <TsunamiEngineeringData>
   */
  ...
  /**
   * Find all TsunamiEngineeringData given by a condition
  ...
  function listTsunamiEngineeringDataBySite($siteId, $filterArr = null, $expanded = false) {
    ...
    $c->addAscendingOrderByColumn(self::TSUNAMI_ENGINEERING_DATA_ID);
