...
include_once 'lib/data/SensorPoolPeer.php';

/**
 * Base class that represents a row from the 'SENSOR_POOL' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseSensorPool extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SensorPoolPeer::ID;
		}
	...
	public function setExperimentId($v)
	{
		...
		if ($this->exp_id !== $v) {
			$this->exp_id = $v;
			$this->modifiedColumns[] = SensorPoolPeer::EXP_ID;
		}
	...
	public function setSensorManifestId($v)
	{
		...
		if ($this->manifest_id !== $v) {
			$this->manifest_id = $v;
			$this->modifiedColumns[] = SensorPoolPeer::MANIFEST_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 3; // 3 = SensorPoolPeer::NUM_COLUMNS - SensorPoolPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SensorPool object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			SensorPoolPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SensorPoolPeer::doInsert($this, $con);
					...
					$affectedRows += SensorPoolPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SensorPoolPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SensorPoolPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SensorPoolPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SensorPoolPeer::ID)) $criteria->add(SensorPoolPeer::ID, $this->id);
		if ($this->isColumnModified(SensorPoolPeer::EXP_ID)) $criteria->add(SensorPoolPeer::EXP_ID, $this->exp_id);
		if ($this->isColumnModified(SensorPoolPeer::MANIFEST_ID)) $criteria->add(SensorPoolPeer::MANIFEST_ID, $this->manifest_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SensorPoolPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SensorPool (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SensorPool Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SensorPoolPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SensorPoolPeer();
		}
		return self::$peer;
	}
