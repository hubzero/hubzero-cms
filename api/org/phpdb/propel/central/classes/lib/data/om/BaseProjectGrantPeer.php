...
// actual class may be a subclass -- as returned by ProjectGrantPeer::getOMClass()
include_once 'lib/data/ProjectGrant.php';

/**
 * Base static class for performing query and update operations on the 'PROJECT_GRANT' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseProjectGrantPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'NEEScentral';

	/** the table name for this class */
	const TABLE_NAME = 'PROJECT_GRANT';
	...
	const PROJID = 'PROJECT_GRANT.PROJID';

	/** the column name for the FUND_ORG field */
	const FUND_ORG = 'PROJECT_GRANT.FUND_ORG';

	/** the column name for the AWARD_NUM field */
	const AWARD_NUM = 'PROJECT_GRANT.AWARD_NUM';
	...
	{
		include_once 'lib/data/map/ProjectGrantMapBuilder.php';
		return BasePeer::getMapBuilder('lib.data.map.ProjectGrantMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = ProjectGrantPeer::getTableMap();
	 ...
	 * @param      string $column The column name for current table. (i.e. ProjectGrantPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ProjectGrantPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProjectGrantPeer::PROJID);

		$criteria->addSelectColumn(ProjectGrantPeer::FUND_ORG);
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ProjectGrantPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ProjectGrantPeer::populateObjects(ProjectGrantPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function populateObjects(ResultSet $rs)
	{
		...
		$cls = ProjectGrantPeer::getOMClass();
	...
	/**
	 * Selects a collection of ProjectGrant objects pre-filled with all related objects.
	 *
	 * @return     array Array of ProjectGrant objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	{
		return ProjectGrantPeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a ProjectGrant or Criteria object.
	 *
	 * @param      mixed $values Criteria or ProjectGrant object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ProjectGrant object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ProjectGrant or Criteria object.
	 *
	 * @param      mixed $values Criteria or ProjectGrant object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		} else { // $values is ProjectGrant object
	...
	/**
	 * Method to DELETE all rows from the PROJECT_GRANT table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(ProjectGrantPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	...
	/**
	 * Method perform a DELETE on the database, given a ProjectGrant or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ProjectGrant object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof ProjectGrant) {
	...
	/**
	 * Validates all modified columns of given ProjectGrant object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ProjectGrant $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(ProjectGrant $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ProjectGrantPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ProjectGrantPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ProjectGrantPeer::DATABASE_NAME, ProjectGrantPeer::TABLE_NAME, $columns);
	}

} // BaseProjectGrantPeer
...
if (Propel::isInit()) {
	...
	try {
		BaseProjectGrantPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'lib/data/map/ProjectGrantMapBuilder.php';
	Propel::registerMapBuilder('lib.data.map.ProjectGrantMapBuilder');
}
