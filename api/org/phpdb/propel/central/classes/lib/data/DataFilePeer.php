...
class DataFilePeer extends BaseDataFilePeer {
  ...
  */
  ...
  public static function findDataFileByEntityType($p_strEntityTypeNTableName, $p_iProjectId, $p_iExperimentId=0, $p_iTrialId=0, $p_iRepetitionId=0){
    ...
    $c->add(self::DELETED, 0);
    $c->add(self::DIRECTORY, 0);
  	$c->add(EntityTypePeer::N_TABLE_NAME, $p_strEntityTypeNTableName);
  	return self::doSelect($c);
  }
  ...
  public static function findProjectPhotoDataFiles($p_iProjectId, $p_iLowerLimit=0, $p_iUpperLimit = 24){
    ...
    while($oResultSet->next()){
      ...
      $strDisplayName = "display_" . $strFileArray['ID'] . "_" . $strFileArray['NAME'];
        ...
        $strFileArray['THUMBNAIL'] = "<div style='color:green'><a style='border-bottom:0px;' rel='lightbox' title='".$strCaption."' target='_blank' href='" . self::getUrl($thumbpath, $strDisplayName) . "'><img src='" . self::getUrl($thumbpath, $thumbname) . "'  alt=''/></a><br>".StringHelper::neat_trim($strCaption, 15, $strDelimiter='...')."</div>";
  	  }else{
...
//    $thumbpath = $strPathArray[0]."/".$strPathArray[1]."/".$strPathArray[2]."/".$strPathArray[3]."/Public/Photos";
  	  ...
  	  $thumbpath = $strFileArray['PATH']."/Generated_Pics";
