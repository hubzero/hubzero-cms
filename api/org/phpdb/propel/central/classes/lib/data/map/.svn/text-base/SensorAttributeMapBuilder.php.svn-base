...
/**
 * This class adds structure of 'SENSOR_ATTRIBUTE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class SensorAttributeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.SensorAttributeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('SENSOR_ATTRIBUTE');
		$tMap->setPhpName('SensorAttribute');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('SENSOR_ATTRIBUTE_SEQ');
