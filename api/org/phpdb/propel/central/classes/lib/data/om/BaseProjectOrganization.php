...
include_once 'lib/data/ProjectOrganizationPeer.php';

/**
 * Base class that represents a row from the 'PROJECT_ORGANIZATION' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseProjectOrganization extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProjectOrganizationPeer::ID;
		}
	...
	public function setOrganizationId($v)
	{
		...
		if ($this->orgid !== $v) {
			$this->orgid = $v;
			$this->modifiedColumns[] = ProjectOrganizationPeer::ORGID;
		}
	...
	public function setProjectId($v)
	{
		...
		if ($this->projid !== $v) {
			$this->projid = $v;
			$this->modifiedColumns[] = ProjectOrganizationPeer::PROJID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->orgid = $rs->getFloat($startcol + 1);

			$this->projid = $rs->getFloat($startcol + 2);
			...
			return $startcol + 3; // 3 = ProjectOrganizationPeer::NUM_COLUMNS - ProjectOrganizationPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ProjectOrganization object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ProjectOrganizationPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ProjectOrganizationPeer::doInsert($this, $con);
					...
					$affectedRows += ProjectOrganizationPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProjectOrganizationPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProjectOrganizationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ProjectOrganizationPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProjectOrganizationPeer::ID)) $criteria->add(ProjectOrganizationPeer::ID, $this->id);
		if ($this->isColumnModified(ProjectOrganizationPeer::ORGID)) $criteria->add(ProjectOrganizationPeer::ORGID, $this->orgid);
		if ($this->isColumnModified(ProjectOrganizationPeer::PROJID)) $criteria->add(ProjectOrganizationPeer::PROJID, $this->projid);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ProjectOrganizationPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProjectOrganization (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProjectOrganization Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProjectOrganizationPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProjectOrganizationPeer();
		}
		return self::$peer;
	}
