...
include_once 'lib/data/CoordinateSpaceDataFilePeer.php';

/**
 * Base class that represents a row from the 'COORDINATE_SPACE_DATA_FILE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseCoordinateSpaceDataFile extends BaseObject  implements Persistent {
	 ...
	 * @var        CoordinateSpaceDataFilePeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CoordinateSpaceDataFilePeer::ID;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comments !== $v) {
			$this->comments = $v;
			$this->modifiedColumns[] = CoordinateSpaceDataFilePeer::COMMENTS;
		}
	...
	public function setCoordinateSpaceId($v)
	{
		...
		if ($this->coordinate_space_id !== $v) {
			...
			$this->modifiedColumns[] = CoordinateSpaceDataFilePeer::COORDINATE_SPACE_ID;
		}
	...
	public function setDataFileId($v)
	{
		...
		if ($this->data_file_id !== $v) {
			$this->data_file_id = $v;
			$this->modifiedColumns[] = CoordinateSpaceDataFilePeer::DATA_FILE_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 4; // 4 = CoordinateSpaceDataFilePeer::NUM_COLUMNS - CoordinateSpaceDataFilePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CoordinateSpaceDataFile object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CoordinateSpaceDataFilePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CoordinateSpaceDataFilePeer::doInsert($this, $con);
					...
					$affectedRows += CoordinateSpaceDataFilePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CoordinateSpaceDataFilePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CoordinateSpaceDataFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CoordinateSpaceDataFilePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CoordinateSpaceDataFilePeer::ID)) $criteria->add(CoordinateSpaceDataFilePeer::ID, $this->id);
		if ($this->isColumnModified(CoordinateSpaceDataFilePeer::COMMENTS)) $criteria->add(CoordinateSpaceDataFilePeer::COMMENTS, $this->comments);
		if ($this->isColumnModified(CoordinateSpaceDataFilePeer::COORDINATE_SPACE_ID)) $criteria->add(CoordinateSpaceDataFilePeer::COORDINATE_SPACE_ID, $this->coordinate_space_id);
		if ($this->isColumnModified(CoordinateSpaceDataFilePeer::DATA_FILE_ID)) $criteria->add(CoordinateSpaceDataFilePeer::DATA_FILE_ID, $this->data_file_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CoordinateSpaceDataFilePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CoordinateSpaceDataFile (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CoordinateSpaceDataFile Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CoordinateSpaceDataFilePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CoordinateSpaceDataFilePeer();
		}
		return self::$peer;
	}
