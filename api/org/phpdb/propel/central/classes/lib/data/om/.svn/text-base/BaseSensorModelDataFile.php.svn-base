...
include_once 'lib/data/SensorModelDataFilePeer.php';

/**
 * Base class that represents a row from the 'SENSOR_MODEL_DATA_FILE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseSensorModelDataFile extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SensorModelDataFilePeer::ID;
		}
	...
	public function setDataFileId($v)
	{
		...
		if ($this->data_file_id !== $v) {
			$this->data_file_id = $v;
			$this->modifiedColumns[] = SensorModelDataFilePeer::DATA_FILE_ID;
		}
	...
	public function setSensorModelId($v)
	{
		...
		if ($this->sensor_model_id !== $v) {
			...
			$this->modifiedColumns[] = SensorModelDataFilePeer::SENSOR_MODEL_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->sensor_model_id = $rs->getFloat($startcol + 2);
			...
			return $startcol + 3; // 3 = SensorModelDataFilePeer::NUM_COLUMNS - SensorModelDataFilePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SensorModelDataFile object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			SensorModelDataFilePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SensorModelDataFilePeer::doInsert($this, $con);
					...
					$affectedRows += SensorModelDataFilePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SensorModelDataFilePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SensorModelDataFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SensorModelDataFilePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDataFileId(),
			$keys[2] => $this->getSensorModelId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setSensorModelId($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SensorModelDataFilePeer::ID)) $criteria->add(SensorModelDataFilePeer::ID, $this->id);
		if ($this->isColumnModified(SensorModelDataFilePeer::DATA_FILE_ID)) $criteria->add(SensorModelDataFilePeer::DATA_FILE_ID, $this->data_file_id);
		if ($this->isColumnModified(SensorModelDataFilePeer::SENSOR_MODEL_ID)) $criteria->add(SensorModelDataFilePeer::SENSOR_MODEL_ID, $this->sensor_model_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SensorModelDataFilePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SensorModelDataFile (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SensorModelDataFile Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SensorModelDataFilePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SensorModelDataFilePeer();
		}
		return self::$peer;
	}
