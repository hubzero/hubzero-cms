...
include_once 'lib/data/EquipmentGroupedAttributePeer.php';

/**
 * Base class that represents a row from the 'EQUIPMENT_GROUPED_ATTRIBUTE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseEquipmentGroupedAttribute extends BaseObject  implements Persistent {
	 ...
	 * @var        EquipmentGroupedAttributePeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::ID;
		}
	...
	public function setAttributeId($v)
	{
		...
		if ($this->attribute_id !== $v) {
			$this->attribute_id = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::ATTRIBUTE_ID;
		}
	...
	public function setDateValue($v)
	{
		...
		if ($this->date_value !== $ts) {
			$this->date_value = $ts;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::DATE_VALUE;
		}
	...
	public function setGroupAttributeId($v)
	{
		...
		if ($this->g_attribute_id !== $v) {
			...
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::G_ATTRIBUTE_ID;
		}
	...
	public function setIntValue($v)
	{
		...
		if ($this->int_value !== $v) {
			$this->int_value = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::INT_VALUE;
		}
	...
	public function setNote($v)
	{
		...
		if ($changed) {
			...
			$this->note = $obj;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::NOTE;
		}
	...
	public function setNumValue($v)
	{
		...
		if ($this->num_value !== $v) {
			$this->num_value = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::NUM_VALUE;
		}
	...
	public function setPageCount($v)
	{
		...
		if ($this->page_count !== $v) {
			$this->page_count = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::PAGE_COUNT;
		}
	...
	public function setStringValue($v)
	{
		...
		if ($changed) {
			...
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::STRING_VALUE;
		}
	...
	public function setUnitId($v)
	{
		...
		if ($this->unit_id !== $v) {
			$this->unit_id = $v;
			$this->modifiedColumns[] = EquipmentGroupedAttributePeer::UNIT_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 10; // 10 = EquipmentGroupedAttributePeer::NUM_COLUMNS - EquipmentGroupedAttributePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EquipmentGroupedAttribute object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			EquipmentGroupedAttributePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EquipmentGroupedAttributePeer::doInsert($this, $con);
					...
					$affectedRows += EquipmentGroupedAttributePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EquipmentGroupedAttributePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EquipmentGroupedAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EquipmentGroupedAttributePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::ID)) $criteria->add(EquipmentGroupedAttributePeer::ID, $this->id);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::ATTRIBUTE_ID)) $criteria->add(EquipmentGroupedAttributePeer::ATTRIBUTE_ID, $this->attribute_id);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::DATE_VALUE)) $criteria->add(EquipmentGroupedAttributePeer::DATE_VALUE, $this->date_value);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::G_ATTRIBUTE_ID)) $criteria->add(EquipmentGroupedAttributePeer::G_ATTRIBUTE_ID, $this->g_attribute_id);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::INT_VALUE)) $criteria->add(EquipmentGroupedAttributePeer::INT_VALUE, $this->int_value);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::NOTE)) $criteria->add(EquipmentGroupedAttributePeer::NOTE, $this->note);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::NUM_VALUE)) $criteria->add(EquipmentGroupedAttributePeer::NUM_VALUE, $this->num_value);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::PAGE_COUNT)) $criteria->add(EquipmentGroupedAttributePeer::PAGE_COUNT, $this->page_count);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::STRING_VALUE)) $criteria->add(EquipmentGroupedAttributePeer::STRING_VALUE, $this->string_value);
		if ($this->isColumnModified(EquipmentGroupedAttributePeer::UNIT_ID)) $criteria->add(EquipmentGroupedAttributePeer::UNIT_ID, $this->unit_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EquipmentGroupedAttributePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EquipmentGroupedAttribute (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EquipmentGroupedAttribute Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EquipmentGroupedAttributePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EquipmentGroupedAttributePeer();
		}
		return self::$peer;
	}
