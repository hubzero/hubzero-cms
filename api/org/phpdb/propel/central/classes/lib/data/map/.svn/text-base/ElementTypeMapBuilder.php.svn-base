...
/**
 * This class adds structure of 'ELEMENT_TYPE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class ElementTypeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.ElementTypeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ELEMENT_TYPE');
		$tMap->setPhpName('ElementType');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('ELEMENT_TYPE_SEQ');
