...
/**
 * This class adds structure of 'CONTROLLER_CHANNEL_EQUIPMENT' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class ControllerChannelEquipmentMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.ControllerChannelEquipmentMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('CONTROLLER_CHANNEL_EQUIPMENT');
		$tMap->setPhpName('ControllerChannelEquipment');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('CNTRLLR_CHNNL_QPMNT_SEQ');

		$tMap->addPrimaryKey('ID', 'Id', 'double', CreoleTypes::NUMERIC, true, 22);

		$tMap->addForeignKey('CONTROLLER_CHANNEL_ID', 'ControllerChannelId', 'double', CreoleTypes::NUMERIC, 'CONTROLLER_CHANNEL', 'ID', false, 22);
		...
		$tMap->addValidator('CONTROLLER_CHANNEL_ID', 'maxValue', 'propel.validator.MaxValueValidator', '', 'CONTROLLER_CHANNEL_ID');

		$tMap->addValidator('CONTROLLER_CHANNEL_ID', 'notMatch', 'propel.validator.NotMatchValidator', '', 'CONTROLLER_CHANNEL_ID');

		$tMap->addValidator('CONTROLLER_CHANNEL_ID', 'required', 'propel.validator.RequiredValidator', '', 'CONTROLLER_CHANNEL_ID');
...
} // ControllerChannelEquipmentMapBuilder
