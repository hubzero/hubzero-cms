...
include_once 'lib/data/SpecimenComponentMaterialFilePeer.php';

/**
 * Base class that represents a row from the 'SPECCOMP_MATERIAL_DATAFILE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseSpecimenComponentMaterialFile extends BaseObject  implements Persistent {
	 ...
	 * @var        SpecimenComponentMaterialFilePeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SpecimenComponentMaterialFilePeer::ID;
		}
	...
	public function setDataFileId($v)
	{
		...
		if ($this->data_file_id !== $v) {
			$this->data_file_id = $v;
			$this->modifiedColumns[] = SpecimenComponentMaterialFilePeer::DATA_FILE_ID;
		}
	...
	public function setSpecimenComponentMaterialId($v)
	{
		...
		if ($this->specimen_component_material_id !== $v) {
			...
			$this->modifiedColumns[] = SpecimenComponentMaterialFilePeer::SPECIMEN_COMPONENT_MATERIAL_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->specimen_component_material_id = $rs->getFloat($startcol + 2);
			...
			return $startcol + 3; // 3 = SpecimenComponentMaterialFilePeer::NUM_COLUMNS - SpecimenComponentMaterialFilePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SpecimenComponentMaterialFile object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			SpecimenComponentMaterialFilePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SpecimenComponentMaterialFilePeer::doInsert($this, $con);
					...
					$affectedRows += SpecimenComponentMaterialFilePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SpecimenComponentMaterialFilePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SpecimenComponentMaterialFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SpecimenComponentMaterialFilePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDataFileId(),
			$keys[2] => $this->getSpecimenComponentMaterialId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setSpecimenComponentMaterialId($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SpecimenComponentMaterialFilePeer::ID)) $criteria->add(SpecimenComponentMaterialFilePeer::ID, $this->id);
		if ($this->isColumnModified(SpecimenComponentMaterialFilePeer::DATA_FILE_ID)) $criteria->add(SpecimenComponentMaterialFilePeer::DATA_FILE_ID, $this->data_file_id);
		if ($this->isColumnModified(SpecimenComponentMaterialFilePeer::SPECIMEN_COMPONENT_MATERIAL_ID)) $criteria->add(SpecimenComponentMaterialFilePeer::SPECIMEN_COMPONENT_MATERIAL_ID, $this->specimen_component_material_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SpecimenComponentMaterialFilePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SpecimenComponentMaterialFile (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SpecimenComponentMaterialFile Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SpecimenComponentMaterialFilePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SpecimenComponentMaterialFilePeer();
		}
		return self::$peer;
	}
...
} // BaseSpecimenComponentMaterialFile
