...
/**
 * This class adds structure of 'LOOKUP_TYPES' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class NCLookupTypesMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.curation.map.NCLookupTypesMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('LOOKUP_TYPES');
		$tMap->setPhpName('NCLookupTypes');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('LOOKUP_TYPES_SEQ');
