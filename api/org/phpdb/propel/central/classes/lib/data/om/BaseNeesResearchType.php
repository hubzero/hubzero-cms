...
include_once 'lib/data/NeesResearchTypePeer.php';

/**
 * Base class that represents a row from the 'NEES_RESEARCH_TYPE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseNeesResearchType extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = NeesResearchTypePeer::ID;
		}
	...
	public function setSystemName($v)
	{
		...
		if ($this->system_name !== $v) {
			$this->system_name = $v;
			$this->modifiedColumns[] = NeesResearchTypePeer::SYSTEM_NAME;
		}
	...
	public function setDisplayName($v)
	{
		...
		if ($this->display_name !== $v) {
			$this->display_name = $v;
			$this->modifiedColumns[] = NeesResearchTypePeer::DISPLAY_NAME;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 3; // 3 = NeesResearchTypePeer::NUM_COLUMNS - NeesResearchTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating NeesResearchType object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NeesResearchTypePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = NeesResearchTypePeer::doInsert($this, $con);
					...
					$affectedRows += NeesResearchTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NeesResearchTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NeesResearchTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NeesResearchTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NeesResearchTypePeer::ID)) $criteria->add(NeesResearchTypePeer::ID, $this->id);
		if ($this->isColumnModified(NeesResearchTypePeer::SYSTEM_NAME)) $criteria->add(NeesResearchTypePeer::SYSTEM_NAME, $this->system_name);
		if ($this->isColumnModified(NeesResearchTypePeer::DISPLAY_NAME)) $criteria->add(NeesResearchTypePeer::DISPLAY_NAME, $this->display_name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NeesResearchTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NeesResearchType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NeesResearchType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     NeesResearchTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new NeesResearchTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this NeesResearchType has previously
	 * been saved, it will retrieve related Projects from storage.
	 * If this NeesResearchType is new, it will return
		...
		if ($this->collProjects === null) {
			if ($this->isNew()) {
			   $this->collProjects = array();
				...
				$criteria->add(ProjectPeer::NEES_RESEARCH_TYPE_ID, $this->getId());
	 ...
	 * If this collection has already been initialized with
	 * an identical criteria, it returns the collection.
	 * Otherwise if this NeesResearchType is new, it will return
	 * an empty collection; or if this NeesResearchType has previously
	 * been saved, it will retrieve related Projects from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in NeesResearchType.
	 */
	 ...
	 * actually need in NeesResearchType.
	 */
	public function getProjectsJoinProjectResearchType($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'lib/data/om/BaseProjectPeer.php';
		if ($criteria === null) {
		...
		if ($this->collProjects === null) {
			if ($this->isNew()) {
				...
				$this->collProjects = ProjectPeer::doSelectJoinProjectResearchType($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
