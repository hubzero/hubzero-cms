 ...
 */
class SiteReportQFRMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.SiteReportQFRMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('FACILITY_ID', 'EntityID', 'double', CreoleTypes::NUMERIC, false, 22);

		$tMap->addColumn('NEES_GROUPSPACE_PATH', 'NEESGroupspacePath', 'string', CreoleTypes::VARCHAR, false, 500);

	} // doBuild()

} // SiteReportQFRMapBuilder
