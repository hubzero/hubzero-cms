...
include_once 'lib/data/SensorAttributePeer.php';

/**
 * Base class that represents a row from the 'SENSOR_ATTRIBUTE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseSensorAttribute extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SensorAttributePeer::ID;
		}
	...
	public function setAttributeId($v)
	{
		...
		if ($this->attribute_id !== $v) {
			$this->attribute_id = $v;
			$this->modifiedColumns[] = SensorAttributePeer::ATTRIBUTE_ID;
		}
	...
	public function setDateValue($v)
	{
		...
		if ($this->date_value !== $ts) {
			$this->date_value = $ts;
			$this->modifiedColumns[] = SensorAttributePeer::DATE_VALUE;
		}
	...
	public function setGroupValue($v)
	{
		...
		if ($this->group_value !== $v) {
			$this->group_value = $v;
			$this->modifiedColumns[] = SensorAttributePeer::GROUP_VALUE;
		}
	...
	public function setIntValue($v)
	{
		...
		if ($this->int_value !== $v) {
			$this->int_value = $v;
			$this->modifiedColumns[] = SensorAttributePeer::INT_VALUE;
		}
	...
	public function setNote($v)
	{
		...
		if ($changed) {
			...
			$this->note = $obj;
			$this->modifiedColumns[] = SensorAttributePeer::NOTE;
		}
	...
	public function setNumValue($v)
	{
		...
		if ($this->num_value !== $v) {
			$this->num_value = $v;
			$this->modifiedColumns[] = SensorAttributePeer::NUM_VALUE;
		}
	...
	public function setPageCount($v)
	{
		...
		if ($this->page_count !== $v) {
			$this->page_count = $v;
			$this->modifiedColumns[] = SensorAttributePeer::PAGE_COUNT;
		}
	...
	public function setSensorId($v)
	{
		...
		if ($this->sensor_id !== $v) {
			$this->sensor_id = $v;
			$this->modifiedColumns[] = SensorAttributePeer::SENSOR_ID;
		}
	...
	public function setStringValue($v)
	{
		...
		if ($changed) {
			...
			$this->modifiedColumns[] = SensorAttributePeer::STRING_VALUE;
		}
	...
	public function setUnitId($v)
	{
		...
		if ($this->unit_id !== $v) {
			$this->unit_id = $v;
			$this->modifiedColumns[] = SensorAttributePeer::UNIT_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->group_value = $rs->getFloat($startcol + 3);
			...
			$this->sensor_id = $rs->getFloat($startcol + 8);

			$this->string_value = $rs->getClob($startcol + 9);

			$this->unit_id = $rs->getFloat($startcol + 10);
			...
			return $startcol + 11; // 11 = SensorAttributePeer::NUM_COLUMNS - SensorAttributePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SensorAttribute object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			SensorAttributePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SensorAttributePeer::doInsert($this, $con);
					...
					$affectedRows += SensorAttributePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SensorAttributePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SensorAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SensorAttributePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getAttributeId(),
			$keys[2] => $this->getDateValue(),
			$keys[3] => $this->getGroupValue(),
			$keys[4] => $this->getIntValue(),
			$keys[5] => $this->getNote(),
			$keys[6] => $this->getNumValue(),
			$keys[7] => $this->getPageCount(),
			$keys[8] => $this->getSensorId(),
			$keys[9] => $this->getStringValue(),
			$keys[10] => $this->getUnitId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setGroupValue($arr[$keys[3]]);
		...
		if (array_key_exists($keys[8], $arr)) $this->setSensorId($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setStringValue($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setUnitId($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SensorAttributePeer::ID)) $criteria->add(SensorAttributePeer::ID, $this->id);
		if ($this->isColumnModified(SensorAttributePeer::ATTRIBUTE_ID)) $criteria->add(SensorAttributePeer::ATTRIBUTE_ID, $this->attribute_id);
		if ($this->isColumnModified(SensorAttributePeer::DATE_VALUE)) $criteria->add(SensorAttributePeer::DATE_VALUE, $this->date_value);
		if ($this->isColumnModified(SensorAttributePeer::GROUP_VALUE)) $criteria->add(SensorAttributePeer::GROUP_VALUE, $this->group_value);
		if ($this->isColumnModified(SensorAttributePeer::INT_VALUE)) $criteria->add(SensorAttributePeer::INT_VALUE, $this->int_value);
		if ($this->isColumnModified(SensorAttributePeer::NOTE)) $criteria->add(SensorAttributePeer::NOTE, $this->note);
		if ($this->isColumnModified(SensorAttributePeer::NUM_VALUE)) $criteria->add(SensorAttributePeer::NUM_VALUE, $this->num_value);
		if ($this->isColumnModified(SensorAttributePeer::PAGE_COUNT)) $criteria->add(SensorAttributePeer::PAGE_COUNT, $this->page_count);
		if ($this->isColumnModified(SensorAttributePeer::SENSOR_ID)) $criteria->add(SensorAttributePeer::SENSOR_ID, $this->sensor_id);
		if ($this->isColumnModified(SensorAttributePeer::STRING_VALUE)) $criteria->add(SensorAttributePeer::STRING_VALUE, $this->string_value);
		if ($this->isColumnModified(SensorAttributePeer::UNIT_ID)) $criteria->add(SensorAttributePeer::UNIT_ID, $this->unit_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SensorAttributePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SensorAttribute (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SensorAttribute Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SensorAttributePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SensorAttributePeer();
		}
		return self::$peer;
	}
