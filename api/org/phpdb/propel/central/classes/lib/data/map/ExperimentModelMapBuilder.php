...
/**
 * This class adds structure of 'EXPERIMENT_MODEL' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class ExperimentModelMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.ExperimentModelMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('EXPERIMENT_MODEL');
		$tMap->setPhpName('ExperimentModel');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('EXPERIMENT_MODEL_SEQ');
		...
		$tMap->addForeignKey('TYPEID', 'TypeId', 'double', CreoleTypes::NUMERIC, 'EXPERIMENT_MODEL_TYPE', 'ID', false, 22);
		...
		$tMap->addValidator('TYPEID', 'maxValue', 'propel.validator.MaxValueValidator', '', 'TYPEID');

		$tMap->addValidator('TYPEID', 'notMatch', 'propel.validator.NotMatchValidator', '', 'TYPEID');

		$tMap->addValidator('TYPEID', 'required', 'propel.validator.RequiredValidator', '', 'TYPEID');

	} // doBuild()

} // ExperimentModelMapBuilder
