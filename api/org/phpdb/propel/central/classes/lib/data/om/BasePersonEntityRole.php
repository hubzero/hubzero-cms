...
include_once 'lib/data/PersonEntityRolePeer.php';

/**
 * Base class that represents a row from the 'PERSON_ENTITY_ROLE' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BasePersonEntityRole extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PersonEntityRolePeer::ID;
		}
	...
	public function setEntityId($v)
	{
		...
		if ($this->entity_id !== $v) {
			$this->entity_id = $v;
			$this->modifiedColumns[] = PersonEntityRolePeer::ENTITY_ID;
		}
	...
	public function setEntityTypeId($v)
	{
		...
		if ($this->entity_type_id !== $v) {
			...
			$this->modifiedColumns[] = PersonEntityRolePeer::ENTITY_TYPE_ID;
		}
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = PersonEntityRolePeer::PERSON_ID;
		}
	...
	public function setRoleId($v)
	{
		...
		if ($this->role_id !== $v) {
			$this->role_id = $v;
			$this->modifiedColumns[] = PersonEntityRolePeer::ROLE_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->person_id = $rs->getFloat($startcol + 3);

			$this->role_id = $rs->getFloat($startcol + 4);
			...
			return $startcol + 5; // 5 = PersonEntityRolePeer::NUM_COLUMNS - PersonEntityRolePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PersonEntityRole object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PersonEntityRolePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PersonEntityRolePeer::doInsert($this, $con);
					...
					$affectedRows += PersonEntityRolePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PersonEntityRolePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PersonEntityRolePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PersonEntityRolePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersonEntityRolePeer::ID)) $criteria->add(PersonEntityRolePeer::ID, $this->id);
		if ($this->isColumnModified(PersonEntityRolePeer::ENTITY_ID)) $criteria->add(PersonEntityRolePeer::ENTITY_ID, $this->entity_id);
		if ($this->isColumnModified(PersonEntityRolePeer::ENTITY_TYPE_ID)) $criteria->add(PersonEntityRolePeer::ENTITY_TYPE_ID, $this->entity_type_id);
		if ($this->isColumnModified(PersonEntityRolePeer::PERSON_ID)) $criteria->add(PersonEntityRolePeer::PERSON_ID, $this->person_id);
		if ($this->isColumnModified(PersonEntityRolePeer::ROLE_ID)) $criteria->add(PersonEntityRolePeer::ROLE_ID, $this->role_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PersonEntityRolePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PersonEntityRole (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PersonEntityRole Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PersonEntityRolePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PersonEntityRolePeer();
		}
		return self::$peer;
	}
