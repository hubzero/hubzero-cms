...
/**
 * This class adds structure of 'EXPERIMENT_MODEL_TYPE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class ExperimentModelTypeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.ExperimentModelTypeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('EXPERIMENT_MODEL_TYPE');
		$tMap->setPhpName('ExperimentModelType');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('XPRMNT_MDL_TYP_SEQ');
