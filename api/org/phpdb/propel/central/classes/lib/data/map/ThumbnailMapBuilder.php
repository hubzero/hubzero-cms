...
/**
 * This class adds structure of 'THUMBNAIL' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
...
class ThumbnailMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'lib.data.map.ThumbnailMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('THUMBNAIL_SEQ');

		$tMap->addPrimaryKey('ID', 'Id', 'double', CreoleTypes::NUMERIC, true, 22);

		$tMap->addForeignKey('DATAFILE_ID', 'DataFileId', 'double', CreoleTypes::NUMERIC, 'DATA_FILE', 'ID', false, 22);
		...
		$tMap->addValidator('DATAFILE_ID', 'maxValue', 'propel.validator.MaxValueValidator', '', 'DATAFILE_ID');

		$tMap->addValidator('DATAFILE_ID', 'notMatch', 'propel.validator.NotMatchValidator', '', 'DATAFILE_ID');

		$tMap->addValidator('DATAFILE_ID', 'required', 'propel.validator.RequiredValidator', '', 'DATAFILE_ID');
