...
/**
 * This class adds structure of 'MEASUREMENT_UNIT_CATEGORY' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class MeasurementUnitCategoryMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.MeasurementUnitCategoryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('MEASUREMENT_UNIT_CATEGORY');
		$tMap->setPhpName('MeasurementUnitCategory');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('MSRMNT_NT_CTGRY_SEQ');
...
} // MeasurementUnitCategoryMapBuilder
