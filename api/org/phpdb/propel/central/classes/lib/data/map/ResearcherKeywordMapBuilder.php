...
/**
 * This class adds structure of 'RESEARCHER_KEYWORD' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class ResearcherKeywordMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.ResearcherKeywordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('RESEARCHER_KEYWORD');
		$tMap->setPhpName('ResearcherKeyword');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('RESEARCHER_KEYWORD_SEQ');
		...
		$tMap->addColumn('KEYWORD_TERM', 'KeywordTerm', 'string', CreoleTypes::VARCHAR, true, 128);

		$tMap->addColumn('CREATED_DT', 'CreatedDate', 'int', CreoleTypes::DATE, true, 22);

		$tMap->addColumn('CREATED_BY', 'CreatedBy', 'string', CreoleTypes::VARCHAR, true, 20);
