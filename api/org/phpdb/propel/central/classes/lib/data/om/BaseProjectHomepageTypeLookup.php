...
/**
 * Base class that represents a row from the 'PROJECT_HOMEPAGE_TYPE_LOOKUP' table.
 *
 * 
 *
 * @package    lib.data.om
 */
abstract class BaseProjectHomepageTypeLookup extends BaseObject  implements Persistent {
	 ...
	 * @var        ProjectHomepageTypeLookupPeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProjectHomepageTypeLookupPeer::ID;
		}
	...
	public function setSystemName($v)
	{
		...
		if ($this->system_name !== $v) {
			$this->system_name = $v;
			$this->modifiedColumns[] = ProjectHomepageTypeLookupPeer::SYSTEM_NAME;
		}
	...
	public function setDisplayName($v)
	{
		...
		if ($this->display_name !== $v) {
			$this->display_name = $v;
			$this->modifiedColumns[] = ProjectHomepageTypeLookupPeer::DISPLAY_NAME;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 3; // 3 = ProjectHomepageTypeLookupPeer::NUM_COLUMNS - ProjectHomepageTypeLookupPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ProjectHomepageTypeLookup object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(ProjectHomepageTypeLookupPeer::DATABASE_NAME);
		}

		try {
			$con->begin();
			ProjectHomepageTypeLookupPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ProjectHomepageTypeLookupPeer::doInsert($this, $con);
					...
					$affectedRows += ProjectHomepageTypeLookupPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProjectHomepageTypeLookupPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProjectHomepageTypeLookupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ProjectHomepageTypeLookupPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new Criteria(ProjectHomepageTypeLookupPeer::DATABASE_NAME);

		if ($this->isColumnModified(ProjectHomepageTypeLookupPeer::ID)) $criteria->add(ProjectHomepageTypeLookupPeer::ID, $this->id);
		if ($this->isColumnModified(ProjectHomepageTypeLookupPeer::SYSTEM_NAME)) $criteria->add(ProjectHomepageTypeLookupPeer::SYSTEM_NAME, $this->system_name);
		if ($this->isColumnModified(ProjectHomepageTypeLookupPeer::DISPLAY_NAME)) $criteria->add(ProjectHomepageTypeLookupPeer::DISPLAY_NAME, $this->display_name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ProjectHomepageTypeLookupPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProjectHomepageTypeLookup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProjectHomepageTypeLookup Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProjectHomepageTypeLookupPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProjectHomepageTypeLookupPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ProjectHomepageTypeLookup has previously
	 * been saved, it will retrieve related ProjectHomepages from storage.
	 * If this ProjectHomepageTypeLookup is new, it will return
		...
		if ($this->collProjectHomepages === null) {
			if ($this->isNew()) {
			   $this->collProjectHomepages = array();
				...
				$criteria->add(ProjectHomepagePeer::PROJECT_HOMEPAGE_TYPE_ID, $this->getId());
	...
	public function addProjectHomepage(ProjectHomepage $l)
	{
		...
		$l->setProjectHomepageTypeLookup($this);
	}
	 ...
	 * If this collection has already been initialized with
	 * an identical criteria, it returns the collection.
	 * Otherwise if this ProjectHomepageTypeLookup is new, it will return
	 * an empty collection; or if this ProjectHomepageTypeLookup has previously
	 * been saved, it will retrieve related ProjectHomepages from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ProjectHomepageTypeLookup.
	 */
