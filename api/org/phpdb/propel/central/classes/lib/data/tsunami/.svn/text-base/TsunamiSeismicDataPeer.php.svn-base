...
require_once 'lib/data/tsunami/om/BaseTsunamiSeismicDataPeer.php';
...
/**
 * Skeleton subclass for performing query and update operations on the 'TsunamiSeismicData' table.
 *
 *
 *
 ...
 */
class TsunamiSeismicDataPeer extends BaseTsunamiSeismicDataPeer {

  /**
   * Find a TsunamiSeismicData object based on its ID
   *
   * @param int $id
  ...
  /**
   * Find all TsunamiSeismicDatas
   *
   * @return array <TsunamiSeismicData>
   */
  ...
  /**
   * Find all TsunamiSeismicData given by a condition
  ...
  function listTsunamiSeismicDataBySite($siteId, $filterArr = null, $expanded = false) {
    ...
    $c->addAscendingOrderByColumn(self::TSUNAMI_SEISMIC_DATA_ID);
