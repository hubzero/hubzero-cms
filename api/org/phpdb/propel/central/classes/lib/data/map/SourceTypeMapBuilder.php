...
/**
 * This class adds structure of 'SOURCE_TYPE' table to 'NEEScentral' DatabaseMap object.
 *
 *
 *
 ...
 */
class SourceTypeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.data.map.SourceTypeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('SOURCE_TYPE');
		$tMap->setPhpName('SourceType');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('SOURCE_TYPE_SEQ');
