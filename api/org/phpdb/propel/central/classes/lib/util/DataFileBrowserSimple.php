  ...
  function getViewSimpleFileBrowser($datafiles, $rootname){
    ...
    foreach($this->datafiles as $df) {
      ...
      $listing = <<<ENDHTML
        ...
        <tr bgcolor="#f7fcfd" id="rowId_simple_$rowId">
          ...
          <td nowrap="nowrap"><a href="$file_url" target="_blank">$df_created</a></td>
          <td nowrap="nowrap"><a href="$file_url" target="_blank">$cleansize</a></td>
...
<div id="MainFileBrowserDiv_$uniqueId">
  <div class="miniportlet">
    <div class="miniportlet_h3">
      <div class="miniportlet_title floatleft">$rootname</div>
    </div>
...
//-->
    ...
    <div class="filebrowser">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" id="tableId_$uniqueId" >
