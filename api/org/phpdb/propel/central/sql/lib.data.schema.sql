...
ALTER TABLE "EXPERIMENT" ADD CONSTRAINT "EXPERIMENT_FK_3" FOREIGN KEY ("CREATOR_ID") REFERENCES "PERSON" ("ID") ON DELETE SET NULL;
...
ALTER TABLE "LOCATION_PLAN" ADD CONSTRAINT "LOCATION_PLAN_FK_3" FOREIGN KEY ("DATA_FILE_ID") REFERENCES "DATA_FILE" ("ID") ON DELETE CASCADE;
...
(
	...
	ALTER TABLE "SPONSOR"
		ADD CONSTRAINT "SPONSOR_PK"
	PRIMARY KEY ("ID");
CREATE SEQUENCE "SPONSOR_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;


/* -----------------------------------------------------------------------
   DATA_FILE_ARCHIVE_LIST
   ----------------------------------------------------------------------- */

DROP TABLE "DATA_FILE_ARCHIVE_LIST" CASCADE CONSTRAINTS;

DROP SEQUENCE "DATA_FILE_ARCHIVE_LIST_SEQ";


CREATE TABLE "DATA_FILE_ARCHIVE_LIST"
(
	"ID" NUMBER(22)  NOT NULL,
	"PROCESSED" NUMBER(22)  NOT NULL,
	"PROCESSED_DATE" DATE
);
CREATE SEQUENCE "DATA_FILE_ARCHIVE_LIST_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;
...
DROP TABLE "ENTITY_HISTORY" CASCADE CONSTRAINTS;

DROP SEQUENCE "ENTITY_HISTORY_SEQ";
...
(
	...
	"ACTION_BY" VARCHAR2(20),
	"IS_CURRENT" NUMBER(22)  NOT NULL,
	"ACTION_COMMENT" VARCHAR2(200)
);

	ALTER TABLE "ENTITY_HISTORY"
		ADD CONSTRAINT "ENTITY_HISTORY_PK"
	PRIMARY KEY ("ID");
CREATE SEQUENCE "ENTITY_HISTORY_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;

ALTER TABLE "ENTITY_HISTORY" ADD CONSTRAINT "ENTITY_HISTORY_FK_1" FOREIGN KEY ("ENTITY_TYPE_ID") REFERENCES "ENTITY_TYPE" ("ID") ON DELETE CASCADE;


/* -----------------------------------------------------------------------
   SITEREPORTS_SITE_SETUP
   ----------------------------------------------------------------------- */

DROP TABLE "SITEREPORTS_SITE_SETUP" CASCADE CONSTRAINTS;

DROP SEQUENCE "SITEREPORTS_SITE_SETUP_SEQ";


CREATE TABLE "SITEREPORTS_SITE_SETUP"
(
	"ID" NUMBER(22)  NOT NULL,
	"FACILITY_ID" NUMBER(22),
	"NEES_GROUPSPACE_PATH" VARCHAR2(500)
);

	ALTER TABLE "SITEREPORTS_SITE_SETUP"
		ADD CONSTRAINT "SITEREPORTS_SITE_SETUP_PK"
	PRIMARY KEY ("ID");
CREATE SEQUENCE "SITEREPORTS_SITE_SETUP_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;

ALTER TABLE "SITEREPORTS_SITE_SETUP" ADD CONSTRAINT "SITEREPORTS_SITE_SETUP_FK_1" FOREIGN KEY ("FACILITY_ID") REFERENCES "ORGANIZATION" ("ORGID");
