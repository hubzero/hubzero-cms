 ...
 **/
class Migration20130426062338ComCourses extends Hubzero_Migration
{
	/**
	 * Up
	 **/
	protected static function up($db)
	{
		...
		$query .= "INSERT INTO `jos_courses_grade_policies` (`alias`, `description`, `type`, `grade_criteria`, `score_criteria`, `badge_criteria`)
