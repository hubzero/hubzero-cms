		...
		<div class="project-inner-wrap grid">
			...
			<?php if ($this->model->allowMembershipRequest()): ?>
				...
				<?php elseif ($member->get('status') == 3): ?>
					<div class="btn-container tooltips span4" title="<?php echo Lang::txt('COM_PROJECTS_REQUEST_PENDING') ;?>">
						<a href="<?php echo $link; ?>" class="tooltips btn btn-success" disabled><?php echo Lang::txt('COM_PROJECTS_REQUEST_PENDING') ;?></a>
					</div>
				<?php elseif ($member->get('status') == 4): ?>
					...
					<div class="btn-container tooltips span4 denied" title="<?php echo $denyMessage;?>">
						<a href="<?php echo $link; ?>" class="btn btn-success" disabled><?php echo Lang::txt('COM_PROJECTS_REQUEST_DENIED') ;?></a>
					</div>
				<?php endif; ?>
			<?php endif; ?>
