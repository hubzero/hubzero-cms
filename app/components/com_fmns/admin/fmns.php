...
if (!\User::authorise('core.manage', 'com_fmns'))
{
...
\Submenu::addEntry(
	\Lang::txt('COM_FMNS'),
	\Route::url('index.php?option=com_fmns&controller=fmns'),
	($controllerName == 'fmns')
);
...
//            /fmns.php
//
// ... we get the final class name of "Components\Fmns\Site\Controllers\Fmns".
//
