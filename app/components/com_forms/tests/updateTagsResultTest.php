...
use Components\Forms\Helpers\UpdateTagsResult as Result;
use Components\Forms\Tests\Traits\canMock;
use stdClass;

class UpdateTagsResultTest extends Basic
{
	use canMock;
	...
	public function testSucceededIsFalseIfTagsNotUpdated()
	{
		$result = new Result();
	...
	public function testSucceededIsTrueIfTagsUpdatedWithoutFailures()
	{
		$result = new Result();
