...
Documentation for Hubzero 2.4, the open source platform for scientific
collaboration websites. It is organized as books, each for a different kind
of reader. Everything here is Markdown in the
...
- [Getting started](getting-started/README.md) — what a hub is and the
