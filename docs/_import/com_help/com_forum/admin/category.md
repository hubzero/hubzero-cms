<!--
status: imported
source: core/components/com_forum/admin/help/en-GB/category.phtml
imported: 2026-09-09
-->
# Forum Manager: Edit Category
...
- **Section**  
  The section this entry can be found under.
- **Title**  
...
- **Description**  
  A short one or two lines to describe the category and give users a better idea as to the subject of threads and posts within.
...
- **Lock Category**  
  The locked status of the entry. Locked categories will **disallow** any new threads and posts. This can be thought of as an archival feature where one mght want the content within still available for reading but not alteration.
- **State**  
