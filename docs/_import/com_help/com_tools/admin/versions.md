<!--
status: imported
source: core/components/com_tools/admin/help/en-GB/versions.phtml
imported: 2026-09-09
-->
# Tools Manager: Tool Versions
...
Here you will a list of versions associated with a specific tool.
...
- **Name**  
  A unique short name or identifier. The text is made lowercase, all punctuation and spaces are stripped.
- **Version**  
  The version number.
- **Revision**  
  The revision number associated with this version. Revision and version number differ in that an item may undergo several revisions before a new **version** is officially released.
- **State**  
...
At the top left, above the filters, you will see sub-menu options. These are links to managing various aspects of the tool environment. The links are:
...
- **Host Types**  
  List host types.
- **Zones**  
  List available tool zones.
- **Sessions**  
  A list of currently active tool sessions.
