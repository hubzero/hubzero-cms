<!--
status: imported
source: core/components/com_activity/admin/help/en-GB/comments.phtml
imported: 2026-09-09
-->
# Blog Entry: Comments
...
Here you will a list of comments associated with a specific blog post.
...
- **Comment**  
  The first sentence or so of the comment made. Longer comments will be truncated. To edit the entry, click the comment text.
- **Author**  
  The author of the entry.
- **Anonymous**  
  If the post was made anonymously or not.
- **Date**  
