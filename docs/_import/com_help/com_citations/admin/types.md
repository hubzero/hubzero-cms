<!--
status: imported
source: core/components/com_citations/admin/help/en-GB/types.phtml
imported: 2026-09-09
-->
# Citations Manager: Types
...
Here you will a list of citation types.
...
- **Alias**  
  The alias of the item. Typically, this is a lower-cased version of the title with spaces and punctuation removed.
- **Title**  
  The title of the item. This entry is required. You can open the item for editing by clicking on the Title.
...
- **Citations**  
  A list of citations.
- **Stats**  
  Basic statistics about the entries.
- **Types**  
  The types of materials that can be cited.
- **Sponsors**  
  Sponsors that can be associated with citations.
- **Format**  
  Specify the format citations should appear in (e.g., APA, IEEE).
