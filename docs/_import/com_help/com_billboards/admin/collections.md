<!--
status: imported
source: core/components/com_billboards/admin/help/en-GB/collections.phtml
imported: 2026-09-09
-->
# Billboards Manager: Collections
...
Here you will a list of collections. A collection is a way of grouping billboards for display.
...
- **Name**  
  The name of the item. This entry is required. You can open the item for editing by clicking on the Name.
...
- **Billboards**  
  Manage billboard entries.
- **Collections**  
  Manage collections that billboards can be added to.
