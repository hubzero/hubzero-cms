<!--
status: imported
source: core/components/com_members/admin/help/en-GB/notes.phtml
imported: 2026-09-09
-->
# User Notes
...
User notes are pieces of information which can be assigned to registered users on your site. These notes can contain for example comments about 'offending' or 'difficult' users, etc.

## Column Headers

In the table containing the user notes assigned to users registered on your site, you will see different columns. Here you can read what they mean and what is displayed in that column.
