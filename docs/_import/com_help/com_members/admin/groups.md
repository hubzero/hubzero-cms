<!--
status: imported
source: core/components/com_members/admin/help/en-GB/groups.phtml
imported: 2026-09-09
-->
...
- Click the **User Manager** button in the Control Panel and select the User Groups tab, or
- Select **Users → Groups** from the drop-down menus.
...
- **Edit**. Opens the editing screen for the selected user group. If more than one user group is selected (where applicable), only the first user group will be opened. The editing screen can also be opened by clicking on the Title or Name of the user group.
...
- **Search User Groups**. In the upper left is a Search field and two buttons, as shown below.

Enter part of the group's name and press the Search to find matching names. Press Clear to clear the search field and restore the list of groups.
