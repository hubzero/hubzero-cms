<!--
status: imported
source: core/components/com_jobs/admin/help/en-GB/types.phtml
imported: 2026-09-09
-->
# Jobs Manager: Types
...
Here you will a list of job types.
...
- **Title**  
  The name of the item. This entry is required. You can view the posts in a thread by clicking on the Title.
...
- **Categories**  
  Show categories jobs can be assigned to.
- **Types**  
  Show all types of jobs (Full time, Part time, etc.).
