<!--
status: imported
source: https://help.hubzero.org/documentation/platform_2_4/users/tools
source-id: 3789
modified: 2011-11-04
imported: 2026-09-09
-->
...
Can your tool take advantage of cluster resources or parallel execution? We have additional computing resources within the hub that you can tap into via the [submit](../developers/05-grid/01-submitcmd.md) command. Write a wrapper program in your favorite language, and have it gather the input values, prepare input files, and [submit](../developers/05-grid/01-submitcmd.md) your runs to our remote computing resources.
