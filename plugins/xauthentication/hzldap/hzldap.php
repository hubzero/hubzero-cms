...
/**
 * Authentication plugin for HUBzero LDAP
 */
class plgXAuthenticationHzldap extends JPlugin
{
	 ...
	 * @return     void
	 */
	public function logintobreeze($login, $passwd)
	{
		$buffer = '';
	...
	/**
	 * Removes Breeze cookie, effectively logging out of Breeze
	 * 
	 * @return     void
	 */
	public function logoutofbreeze()
	{
