		...
		<div class="comment-content">
			...
			<?php if (!$this->comment->get('reports')) { ?>
				<?php if ($this->depth < $this->config->get('comments_depth', 3)) { ?>
					...
					<a class="reply active" data-txt-active="<?php echo JText::_('PLG_MEMBERS_BLOG_CANCEL'); ?>" data-txt-inactive="<?php echo JText::_('PLG_MEMBERS_BLOG_REPLY'); ?>" href="<?php echo JRoute::_($this->base); ?>" rel="comment-form<?php echo $this->comment->get('id'); ?>"><!-- 
					--><?php echo JText::_('PLG_MEMBERS_BLOG_CANCEL'); ?><!-- 
				--></a>
					<?php } else { ?>
					<a class="reply" data-txt-active="<?php echo JText::_('PLG_MEMBERS_BLOG_CANCEL'); ?>" data-txt-inactive="<?php echo JText::_('PLG_MEMBERS_BLOG_REPLY'); ?>" href="<?php echo JRoute::_($this->base . '&reply=' . $this->comment->get('id')); ?>" rel="comment-form<?php echo $this->comment->get('id'); ?>"><!-- 
