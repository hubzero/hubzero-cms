...
?>
				<p class="file-drop">
					<a class="delete" href="<?php echo JRoute::_('index.php?option=' . $this->option . '&id=' . $this->member->get('uidNumber') . '&active=' . $this->name . '&task=posts/' . $this->entry->id . '/edit&remove=' . $asset->id); ?>">delete</a>
