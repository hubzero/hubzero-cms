...
class plgUsageChart extends JPlugin
{
	public function plgUsageChart(&$subject, $config)
	{
		...
		$this->_plugin = JPluginHelper::getPlugin( 'usage', 'chart' );
	...
	{
		include_once( JPATH_ROOT.DS.'components'.DS.$option.DS.'ofc'.DS.'php-ofc-library'.DS.'open-flash-chart.php' );
		...
		window.addEvent("domready", function(){
			swfobject.embedSWF("/components/com_usage/ofc/open-flash-chart.swf", "chart1", "600", "350", "9.0.0", "expressInstall.swf", {"get-data":"get_data_1"});
			swfobject.embedSWF("/components/com_usage/ofc/open-flash-chart.swf", "chart2", "300", "300", "9.0.0", "expressInstall.swf", {"get-data":"get_data_2"});
			swfobject.embedSWF("/components/com_usage/ofc/open-flash-chart.swf", "chart3", "300", "300", "9.0.0", "expressInstall.swf", {"get-data":"get_data_3"});
		});
	...
	public function onUsageDisplay( $option, $task, $db, $months, $monthsReverse, $enddate ) 
	{
		...
		$document =& JFactory::getDocument();
		if (is_file('components'.DS.$option.DS.'ofc'.DS.'js'.DS.'swfobject.js')) {
			$document->addScript('components'.DS.$option.DS.'ofc'.DS.'js'.DS.'json'.DS.'json2.js');
			$document->addScript('components'.DS.$option.DS.'ofc'.DS.'js'.DS.'swfobject.js');
