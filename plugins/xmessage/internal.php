...
JPlugin::loadLanguage( 'plg_xmessage_internal' );

/**
 * Short description for 'plgXMessageInternal'
 * 
...
class plgXMessageInternal extends JPlugin
{
	 ...
	 * @return     void
	 */
	public function plgXMessageInternal(&$subject, $config)
	{
		parent::__construct($subject, $config);

		// load plugin parameters
		$this->_plugin = JPluginHelper::getPlugin( 'xmessage', 'internal' );
