...
class WikiParser 
{
	...
	public function __construct( $title, $option='', $scope='', $pagename='', $pageid=0, $filepath='', $domain=null ) 
	{
	...
	public function parse( $text, $linestart=0, $camelcase=1 ) 
	{
		$text = "\n".$text;
	...
	{
		return "\n".'<li class="toclevel-'.$level.'"><a href="'.JRoute::_('index.php?option='.$this->option.a.'scope='.$this->scope.a.'pagename='.$this->pagename).'#'.
