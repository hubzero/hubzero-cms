...
defined('_JEXEC') or die( 'Restricted access' );
 ...
 /**
 * XDocumentRenderer_RSS is a feed that implements RSS 2.0 Specification that includes support for iTunes tags
 * 
...
class XDocumentRendererRSS extends JDocumentRenderer
{
	/**
	 * Renderer mime type
	 *
