...
<div class="captcha-block">
	<table summary="<?php echo JText::_('PLG_HUBZERO_IMAGECAPTCHA'); ?>">
		<tbody>
			<tr>
				<td>
					<img id="captchaCode<?php echo $this->total; ?>" src="<?php echo JURI::base(); ?>index.php?option=<?php echo $this->option; ?>&amp;task=<?php echo $this->task; ?>&amp;no_html=1&amp;showCaptcha=True&amp;instanceNo=<?php echo $this->total; ?>" alt="CAPTCHA Image" />
				</td>
				<td>
					...
					{
						var captchaSrc = "<?php echo JURI::base(); ?>index.php?option=<?php echo $this->option; ?>&task=<?php echo $this->task; ?>&no_html=1&showCaptcha=True&instanceNo="+instanceNo+"&time="+ new Date().getTime();
