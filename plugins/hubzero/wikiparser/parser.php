...
class WikiParser
{
	 ...
	 * @param      integer $section Numbered section. 0 pulls the text before the first heading; 
	 *                              other numbers will pull the given section along with its lower-level subsections.
