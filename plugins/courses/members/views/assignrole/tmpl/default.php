...
<form action="<?php echo JRoute::_('index.php?option='.$option.'&gid='.$this->course->get('cn')); ?>" method="post" id="hubForm<?php if ($this->no_html) { echo '-ajax'; }; ?>"> 
	<fieldset>
		...
		<label>
			...
			<?php
				...
				$current_roles = array();
				$roles = $u->getCourseMemberRoles($u->get('uidNumber'), $this->course->get('gidNumber'));
				if($roles) {
