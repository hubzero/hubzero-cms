...
<form name="editevent" action="" method="post" id="hubForm">
	<div class="explaination">
		<p>Here you can add events to your course calendar. These events are seperate from the HUB events.</p>
		<p><a href="<?php echo JRoute::_('index.php?option=com_courses&gid='.$this->course->get('cn').'&active=calendar'); ?>">&lsaquo; Back to Course Calendar</a></p>
	</div>
	<fieldset>
