	...
	<div class="container">
		...
		<div class="subscribe-content">
			...
			<label>
				...
				<img src="<?php echo Request::base(true); ?>/plugins/groups/calendar/images/swatch-gray.png" />
			...
			<?php foreach ($this->calendars as $calendar) : ?>
				...
				<label <?php echo (!$enabled) ? 'class="disabled"' : '' ?>>
					...
					<?php if ($calendar->get('color')) : ?>
						<img src="<?php echo Request::base(true); ?>/plugins/groups/calendar/images/swatch-<?php echo $calendar->get('color'); ?>.png" />
					<?php else : ?>
						<img src="<?php echo Request::base(true); ?>/plugins/groups/calendar/images/swatch-gray.png" />
					<?php endif; ?>
