...
<ul id="page_options">
	<li>
		<?php if (JRequest::getVar('action') == 'edit') : ?>
			<a class="btn date" title="" href="<?php echo JRoute::_('index.php?option='.$this->option.'&cn='.$this->group->cn.'&active=calendar&action=details&event_id='.$this->event->id); ?>">
...
<form name="editevent" action="index.php" method="post" id="hubForm">
	<fieldset>
		...
		<label><?php echo JText::_('Title:'); ?> <span class="required">Required</span>
			<input type="text" name="event[title]" value="<?php echo $this->event->title; ?>" />
		</label>
		...
		<label><?php echo JText::_('Details:'); ?> <span class="optional">Optional</span>
			<textarea name="content" rows="10"><?php echo $this->event->content; ?></textarea>
		...
		<label><?php echo JText::_('Location:'); ?> <span class="optional">Optional</span>
			<input type="text" name="event[adresse_info]" value="<?php echo $this->event->adresse_info; ?>" />
		</label>
		...
		<label><?php echo JText::_('Website:'); ?> <span class="optional">Optional</span>
			<input type="text" name="event[extra_info]" value="<?php echo $this->event->extra_info; ?>" />
		</label>
