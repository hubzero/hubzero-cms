...
<div class="bulletin full <?php echo $this->row->type; ?>" id="b<?php echo $this->row->id; ?>" data-id="<?php echo $this->row->id; ?>" data-closeup-url="<?php echo JRoute::_($base . '&scope=posts/' . $this->row->id); ?>" data-width="600" data-height="350">
	<div class="content">
...
<?php if ($this->row->created_by == $this->juser->get('id')) { ?>
				<a class="edit" data-id="<?php echo $this->row->id; ?>" href="<?php echo JRoute::_($base . '&task=edit&bulletin=' . $this->row->id); ?>">
					<span><?php echo JText::_('Edit'); ?></span>
				</a>
<?php } else { ?>
				<a class="vote <?php echo ($this->row->voted) ? 'unlike' : 'like'; ?>" data-id="<?php echo $this->row->id; ?>" data-text-like="<?php echo JText::_('Like'); ?>" data-text-unlike="<?php echo JText::_('Unlike'); ?>" href="<?php echo JRoute::_($base . '&task=vote&bulletin=' . $this->row->id); ?>">
					<span><?php echo ($this->row->voted) ? JText::_('Unlike') : JText::_('Like'); ?></span>
				</a>
<?php } ?>
				<a class="comment" data-id="<?php echo $this->row->id; ?>" href="<?php echo JRoute::_($base . '&task=comment&bulletin=' . $this->row->id); ?>">
					<span><?php echo JText::_('Comment'); ?></span>
				</a>
				<a class="repost" data-id="<?php echo $this->row->id; ?>" href="<?php echo JRoute::_($base . '&task=repost&bulletin=' . $this->row->id); ?>">
...
<?php if ($this->post->original && $this->row->created_by == $this->juser->get('id') || $this->params->get('access-delete-bulletin')) { ?>
				<a class="delete" data-id="<?php echo $this->row->id; ?>" href="<?php echo JRoute::_($base . '&task=delete&bulletin=' . $this->row->id); ?>">
					<span><?php echo JText::_('Delete'); ?></span>
				</a>
<?php } else if ($this->post->created_by == $this->juser->get('id') || $this->params->get('access-edit-bulletin')) { ?>
				<a class="unpost" data-id="<?php echo $this->row->id; ?>" href="<?php echo JRoute::_($base . '&task=unpost&bulletin=' . $this->row->id); ?>">
