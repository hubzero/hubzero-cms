...
if($this->total > $this->filters['limit']) { 
	...
	<p><a href="<?php echo JRoute::_('index.php?option=com_groups'.a.'gid='.$this->gid.a.'active=projects').'?action=updates'.a.'limit='.$limit.a.'prev='.$this->filters['limit'].'#more';  ?>"><?php echo JText::_('COM_PROJECTS_VIEW_OLDER_ENTRIES'); ?></a></p>
