		...
		<form action="<?php echo Route::url($base . '?action=save'); ?>" method="post" id="hubForm" class="add-citation">
			...
			<fieldset>
				...
				<div class="grid">
					<div class="col span6">
						<label for="type">
							<?php echo Lang::txt('PLG_GROUPS_CITATIONS_TYPE'); ?>: <span class="required">Required</span>
			...
			<?php echo Lang::txt('PLG_GROUPS_CITATIONS_MANUALLY_FORMAT_FORMAT'); ?>:
				<select id="format_type" name="format_type">
					...
					<?php echo Lang::txt('PLG_GROUPS_CITATIONS_MANUALLY_FORMAT_APA'); ?></option>
					<option value="ieee" <?php echo ($this->row->format == 'ieee') ? 'selected="selected"' : ''; ?>>
					<?php echo Lang::txt('PLG_GROUPS_CITATIONS_MANUALLY_FORMAT_IEEE'); ?></option>
				</select>
			</label>
			<label for="formatted">
			...
			<fieldset>
				...
				<label>
					...
					<?php echo Lang::txt('PLG_GROUPS_CITATIONS_AFFILIATED_WITH_YOUR_ORG'); ?>
				</label>
				<label>
					<input type="checkbox" class="option" name="fundedby" id="fundedby" value="1"<?php if ($this->row->fundedby) { echo ' checked="checked"'; } ?> />
					<?php echo Lang::txt('PLG_GROUPS_CITATIONS_FUNDED_BY_YOUR_ORG'); ?>
				</label>
			</fieldset>
