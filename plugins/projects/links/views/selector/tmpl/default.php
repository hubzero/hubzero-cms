...
<script src="/plugins/projects/links/js/selector.js"></script>
	<h3><?php echo JText::_('PLG_PROJECTS_LINKS_SELECTOR'); ?> 	<span class="abox-controls">
			<a class="btn btn-success active" id="b-save"><?php echo JText::_('PLG_PROJECTS_LINKS_SELECTOR_SAVE_SELECTION'); ?></a>
			<?php if ($this->ajax) { ?>
	...
	<form id="select-form" class="select-form" method="post" enctype="multipart/form-data" action="<?php echo $url; ?>">
		<fieldset >	
			...
			<div id="import-link">
				<label>
					<?php echo $label . ':'; ?>
				<input type="text" name="url[]" size="40" id="parse-url" placeholder="http:// OR doi:" value="" />
