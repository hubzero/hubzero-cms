...
?>
	...
	<?php if($this->canedit) { ?>
	<span class="c-edit"><a href="<?php echo $this->url.'?vid='.$this->vid.a.'uid='.$author->user_id.a.'move='.$this->move.a.'action=editauthor'.a.'owner='.$this->owner; ?>" class="showinbox"><?php echo JText::_('PLG_PROJECTS_PUBLICATIONS_AUTHORS_EDIT'); ?></a></span>
	<?php } ?>
	<span class="a-wrap">
