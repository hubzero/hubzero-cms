...
?>
	...
	<span class="c-edit"><a href="<?php echo $this->url . '?vid=' . $this->vid . '&amp;ima=' . urlencode($this->ima) . '&amp;move=' . $this->move . '&amp;action=editimage&amp;ajax=1&amp;no_html=1'; ?>" class="showinbox"><?php echo Lang::txt('PLG_PROJECTS_PUBLICATIONS_GALLERY_EDIT'); ?></a></span>
<?php } ?>
