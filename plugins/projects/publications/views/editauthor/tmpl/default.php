...
<h3><?php echo $this->author->id
	? Lang::txt('PLG_PROJECTS_PUBLICATIONS_AUTHORS_EDIT_AUTHOR')
	: Lang::txt('PLG_PROJECTS_PUBLICATIONS_AUTHORS_ADD_AUTHOR'); ?></h3>
<?php
			...
			<div class="author-edit">
				...
				<?php if (!$this->author->username) { ?>
					<label for="email">
						...
						<input type="text" name="email" class="long" value="<?php echo $this->author->invited_email ? $this->author->invited_email : ''; ?>" maxlength="255" /><span class="optional"><?php echo Lang::txt('OPTIONAL'); ?></span>
					</label>
					<div class="clear"></div>
				<?php } ?>
				<label for="credit">
					<span class="leftshift faded"><?php echo ucfirst(Lang::txt('PLG_PROJECTS_PUBLICATIONS_AUTHORS_AUTHOR_CREDIT')); ?>:</span>
					<input type="text" name="credit" class="long" value="<?php echo htmlspecialchars($this->author->credit); ?>" maxlength="255"  /><span class="optional"><?php echo Lang::txt('OPTIONAL'); ?></span>
				</label>
				<div class="clear"></div>
				<p class="hint"><?php echo ($this->author->username)
					? Lang::txt('PLG_PROJECTS_PUBLICATIONS_AUTHORS_EDIT_TIPS')
					: Lang::txt('PLG_PROJECTS_PUBLICATIONS_AUTHORS_EDIT_UNCONFIRMED_TIPS') ; ?></p>
