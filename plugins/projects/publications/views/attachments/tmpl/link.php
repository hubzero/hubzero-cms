...
?>
	<li>
		...
		<?php if ($viewer == 'edit') { ?>
			<span>
				<a href="<?php echo $data->editUrl . '/?action=edititem&amp;aid=' . $data->id . '&amp;p=' . $data->props; ?>" class="showinbox item-edit" title="<?php echo strtolower(JText::_('PLG_PROJECTS_PUBLICATIONS_EDIT_LINK_TITLE')); ?>">&nbsp;</a>
