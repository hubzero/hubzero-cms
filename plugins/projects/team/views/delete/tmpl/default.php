...
?>
<div id="abox-content">
<h3><?php echo Lang::txt('COM_PROJECTS_DELETE_TEAM_MEMBERS'); ?></h3>
<?php
...
<form id="hubForm-ajax" method="post" action="<?php echo Route::url('index.php?option=' . $this->option . '&alias=' . $this->model->get('alias')); ?>">
	<fieldset >
		...
		<p class="anote"><?php echo Lang::txt('COM_PROJECTS_DELETE_TEAM_MEMBERS_NOTE'); ?></p>
		<p><?php echo Lang::txt('COM_PROJECTS_DELETE_TEAM_MEMBERS_CONFIRM'); ?></p>
		...
		<?php if ($self) { ?><p class="warning"><?php echo Lang::txt('COM_PROJECTS_TEAM_WARNING_SELF_DELETE'); ?></p><?php } ?>
		<p class="submitarea">
			<input type="submit" value="<?php echo Lang::txt('COM_PROJECTS_DELETE'); ?>" class="btn" />
