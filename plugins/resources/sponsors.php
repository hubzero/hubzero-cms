...
class plgResourcesSponsors extends Hubzero_Plugin
{
	...
	/**
	 * Short description for 'plgResourcesRecommendations'
	 * 
	 ...
	 * @return     void
	 */
	public function plgResourcesSponsors(&$subject, $config)
	{
		parent::__construct($subject, $config);

		// Load plugin parameters
		$this->_plugin = JPluginHelper::getPlugin( 'resources', 'sponsors' );
		$this->loadLanguage();
	...
	/**
	 * Short description for 'onResourcesSubAreas'
	 * 
	 * Long description (if any) ...
	 * 
	...
	/**
	 * Short description for 'onResourcesSub'
	 * 
	 * Long description (if any) ...
	 * 
	 * @param      object $resource Parameter description (if any) ...
	 * @param      unknown $option Parameter description (if any) ...
	 * @param      integer $miniview Parameter description (if any) ...
	 * @return     array Return description (if any) ...
	 */
