...
require_once(JPATH_ROOT . DS . 'administrator' . DS . 'components' . DS . 'com_resources' . DS . 'tables' . DS . 'review.php');
...
class ResourcesModelReview extends \Hubzero\Base\Model
{
	...
	public function creator($property=null)
	{
		...
		{
			$this->_creator = Hubzero_User_Profile::getInstance($this->get('user_id'));
		}
		if ($property)
		{
