/**
 * @package     hubzero-cms
 * @file        plugins/publications/favorite/favorite.js
...
jQuery(document).ready(function(jq){
	...
	if (fav.length) {
		fav.on('click', function(e) {
			...
			var rid = $('#rid').val();
			$.get('index.php?option=com_publications&task=plugin&trigger=onPublicationsFavorite&no_html=1&rid='+rid, {}, function(data) {
				$('#fav-this').html(data);
