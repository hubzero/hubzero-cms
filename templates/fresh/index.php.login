...
if (($juser->id > 1) or 
	(strpos(JURI::current(), 'login')) or
	(strpos(JURI::current(), 'register')) or
	(strpos(JURI::current(), 'lostpassword')) or
	(strpos(JURI::current(), 'lostusername')) or
	(strpos(JURI::current(), 'changepassword')) or
	(strpos(JURI::current(), 'registration/confirm'))
)  { 
?>	
...
<?php } ?>	
	...
	<div id="mainwrap">
    <div id="uc"><div>Beta 1.0</div></div>
	<jdoc:include type="modules" name="notices" />
        ...
        echo "\t\t\t".'<li id="sitemap"><a href="/sitemap" title="Sitemap"><span>Sitemap</span></a></li>'."\n";
