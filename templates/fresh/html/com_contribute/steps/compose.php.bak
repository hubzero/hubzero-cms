...
<?php } ?>
	<form action="index.php" method="post" id="hubForm">
		...
		<div class="explaination">
			<h4><?php echo JText::_('COM_CONTRIBUTE_COMPOSE_CUSTOM_FIELDS_TITLE'); ?></h4>
...
?>
			<label>
				<?php $fieldName = 'nbtag['.$field[0].']'; echo stripslashes($field[1]); ?>: <?php echo ($field[3] == 1) ? '<span class="required">'.JText::_('COM_CONTRIBUTE_REQUIRED').'</span>': ''; ?>
				<?php if ($field[2] == 'text') { ?>
				...
				<?php } else if (stripslashes($field[1]) == "Full Text") { 
