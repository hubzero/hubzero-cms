...
<link rel="stylesheet" type="text/css" media="print" href="<?php echo $this->baseurl ?>/templates/newpulse/css/print.css" />
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->baseurl ?>/templates/newpulse/css/dummy.css" id="dummy_css" />
<!--[if lte IE 7]>
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->baseurl ?>/templates/newpulse/css/ie7win.css" />
<![endif]-->
<!--[if lte IE 6]>
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->baseurl ?>/templates/newpulse/css/ie6win.css" />
<![endif]-->
...
if (!$juser->get('guest')) {
	...
	echo "\t\t\t".'<li id="username"><a href="/members/'.$juser->get('id').'" title="My Account">'.$juser->get('name').' ('.$juser->get('username').')</a> &#8226; <a href="'.JRoute::_('index.php?option=com_members&id='.$juser->get('id').'&active=messages&task=inbox').'" id="usermessages">'.count($rows).' New Messages</a></li>'."\n";
	...
	//echo "\t\t\t".'<li id="myhub"><a href="/myhub" title="My HUB"><span>My HUB</span></a></li>'."\n";
