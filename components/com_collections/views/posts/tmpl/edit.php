...
<fieldset class="filters">
	...
	<ul>
		<li>
			<a class="collections count" href="<?php echo JRoute::_($base . '&task=all'); ?>">
				<span><?php echo JText::sprintf('<strong>%s</strong> collections', $this->counts['collections']); ?></span>
			</a>
		</li>
		<li>
			<a class="posts count" href="<?php echo JRoute::_($base . '&task=posts'); ?>">
				<span><?php echo JText::sprintf('<strong>%s</strong> posts', $this->counts['posts']); ?></span>
			</a>
		</li>
	</ul>
	<div class="clear"></div>
	<p>
		<label for="filter-search">
			...
			<input type="text" name="search" id="filter-search" value="" placeholder="<?php echo JText::_('Search posts'); ?>" />
		</label>
...
<?php if ($this->entry->get('original')) { ?>
		...
		<?php if (JPluginHelper::isEnabled('system', 'jquery')) { ?>
					...
					<script src="/components/com_collections/assets/js/fileupload.jquery.js"></script>
		<?php } else { ?>
					<label for="upload">
						<?php echo JText::_('File:'); ?>
						<input type="file" name="upload" id="upload" />
			...
			?>
					<p class="item-asset">
						...
						<span class="asset-description">
							...
							<a class="delete" href="<?php echo JRoute::_($base . '&post=' . $this->entry->get('id') . '&task=edit&remove=' . $asset->get('id')); ?>" title="<?php echo JText::_('Delete this asset'); ?>">
...
<?php } ?>
	...
	<p class="submit">
		<input type="submit" value="<?php echo JText::_(strtoupper($this->option) . '_SAVE'); ?>" />
		<?php if ($item->get('id')) { ?>
