		...
		<?php 
			...
			<div id="edit-project-content" class="withleft">
				...
				<div id="cancel-project">
					<p><span class="prominent"><?php echo JText::_('COM_PROJECTS_CANCEL_PROJECT_NEED'); ?></span> <?php echo JText::_('COM_PROJECTS_CANCEL_YOU_CAN'); ?> <a href="<?php echo JRoute::_('index.php?option='.$this->option.a.$goto.a.'task=suspend'); ?>" id="suspend"><?php echo JText::_('COM_PROJECTS_CANCEL_PROJECT_SUSPEND'); ?></a> <?php echo JText::_('COM_PROJECTS_CANCEL_THIS_PROJECT'); ?><?php echo JText::_('COM_PROJECTS_CANCEL_LEAVE_OPTION'); ?>; <?php echo JText::_('COM_PROJECTS_CANCEL_OR_YOU_CAN'); ?> <a href="<?php echo JRoute::_('index.php?option=com_feedback'.a.'task=report_problems'); ?>"><?php echo JText::_('COM_PROJECTS_CANCEL_CONTACT_ADMIN'); ?></a> <?php echo JText::_('COM_PROJECTS_CANCEL_PERMANENTLY'); ?>.</p>
				</div>
				<?php } ?>
