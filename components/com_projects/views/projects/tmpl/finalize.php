		...
		<div class="pinfo">
			<div class="grid">
				...
				<div class="col span6 omega">
					...
					<p class="actionlink"><a href="<?php echo JRoute::_('index.php?option=' . $this->option . '&task=setup&' . $goto) . '/?step=1'; ?>">&laquo; <?php echo JText::_('COM_PROJECTS_CHANGE_THIS_INFO'); ?></a></p>
				</div>
			</div>
		</div>
		<div class="clear"></div>
