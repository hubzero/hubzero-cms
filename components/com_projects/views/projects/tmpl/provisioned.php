			...
			<div class="grid">
				<div class="col span6 first">
					...
					<ul id="activate-features">
						...
						<li id="andmore">
							<a href="<?php echo JRoute::_('index.php?option=' . $this->option . '&task=features'); ?>"><?php echo JText::_('COM_PROJECTS_ACTIVATE_AND_MORE'); ?></a>
						</li>
					</ul>
				</div>
					...
					<div id="activate-body">
						...
						<form action="<?php echo JRoute::_('index.php?option=com_projects&alias=' . $this->project->alias . '&task=activate'); ?>" method="post" id="activate-form" enctype="multipart/form-data">
							...
							<div id="activate-summary">
								...
								<p>
									<span class="activate-label"><?php echo JText::_('COM_PROJECTS_TEAM'); ?>:</span> <?php echo $this->team; ?>
								</p>
							</div>
							<fieldset>
								<label>
									<span class="pub-info-pop tooltips" title="<?php echo JText::_('COM_PROJECTS_PROJECT_TITLE').' :: ' . JText::_('COM_PROJECTS_HINTS_TITLE'); ?>">&nbsp;</span>
