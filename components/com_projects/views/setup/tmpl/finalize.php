...
<section class="main section" id="setup">
	...
	<div class="setup-wrap">
		<form id="hubForm" method="post" action="index.php">
			...
			<fieldset>
				...
				$this->view('_form')
				     ...
				     ->display();
				?>
				<legend><?php echo JText::_('COM_PROJECTS_SETUP_BEFORE_COMPLETE'); ?></legend>
				<p class="notice"><?php echo JText::_('COM_PROJECTS_SETUP_TERMS_WHY_ASK'); ?></p>
		...
		<?php if ($this->config->get('grantinfo', 0)) { ?>
			...
			<fieldset>
				<legend><?php echo JText::_('COM_PROJECTS_SETUP_TERMS_GRANT_INFO'); ?></legend>
			...
			<div class="clear"></div>
			<fieldset>
				<legend><?php echo JText::_('COM_PROJECTS_SETUP_TERMS'); ?></legend>
				<label class="terms-label">
					<h4><?php echo JText::_('COM_PROJECTS_SETUP_TERMS_QUESTION_AGREE'); ?> <a href="<?php echo $privacylink; ?>" rel="external" ><?php echo JText::_('COM_PROJECTS_SETUP_TERMS'); ?></a>? <span class="required"><?php echo JText::_('REQUIRED'); ?></span></h4>
			...
			<div class="submitarea">
				<input type="submit" value="<?php echo JText::_('COM_PROJECTS_SAVE_AND_CONTINUE'); ?>" class="btn btn-success" id="btn-finalize" />
			</div>
		<form>
	</div>
</section>