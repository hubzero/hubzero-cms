			...
			<div class="report-content">
				...
				<div class="groupblock element-choice">
					<div class="columns three first">
						<label class="block">
							<input type="checkbox" name="data[]" value="id" /> <?php echo JText::_('Publication ID'); ?>
						</label>
						<label class="block">
							<input type="checkbox" name="data[]" value="title" checked="checked" /> <?php echo JText::_('Publication title'); ?>
						</label>
						<label class="block">
							<input type="checkbox" name="data[]" value="author" /> <?php echo JText::_('First author'); ?>
						</label>
						<label class="block">
							<input type="checkbox" name="data[]" value="version" /> <?php echo JText::_('Version label'); ?>
						</label>
						<label class="block">
					...
					<div class="columns three second">
						...
						<label class="block">
							<input type="checkbox" name="data[]" value="views" /> <?php echo JText::_('Number of page views'); ?>
						</label>
						<label class="block">
							<input type="checkbox" name="data[]" value="citations" /> <?php echo JText::_('Number of citations'); ?>
						</label>
					</div>
					<div class="clear"></div>
				</div>
