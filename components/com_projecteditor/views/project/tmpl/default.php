...
<input type="hidden" name="type" value="<?php echo $this->iProjectTypeId; ?>" checked />
        ...
        <div id="about" style="padding-top:1em;">
          ...
          <table cellpadding="1" cellspacing="1" style="border-bottom:0px;border-top:0px;">
            <tr id="people">
              <td style="width:1px">
                <p class="editorParagraph">
                  <label for="txtOwner" class="editorLabel">PI:<span class="requiredfieldmarker">*</span></label>
            ...
            <tr id="administrator">
              <td style="width:1px">
                <p class="editorParagraph">
                  <label for="txtOwner" class="editorLabel">Administrator:<span class="requiredfieldmarker">*</span></label>
            ...
            <tr id="organization">
              ...
              <td>
                ...
                <div id="organizationAdd" class="editorInputFloat editorInputButton">
                  <a href="javascript:void(0);" title="Add another organization" style="border-bottom: 0px" onClick="addInputViaMootools('/projecteditor/addorganization?format=ajax', 'organization[]', 'txtOrganization', 'organizationPicked');"><img src="/components/com_projecteditor/images/icons/addButton.png" border="0"/></a>
                </div>
                <div class="clear"></div>
