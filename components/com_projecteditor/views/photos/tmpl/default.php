          ...
          <table cellpadding="1" cellspacing="1" style="border-bottom:0px;border-top:0px;margin-top:20px;">
            <tr id="Photos">
              <td nowrap>
                ...
                <p><a title="Formats: PNG, JPG, or GIF" class="modal" href="/warehouse/projecteditor/uploadform?format=ajax&projid=<?php echo $this->iProjectId; ?>&experimentId=<?php echo $this->iExperimentId; ?>&path=<?php echo $this->strPath; ?>&uploadType=<?php echo $this->uploadType; ?>">Upload Photos</a></p>
              </td>
              <td width="100%">
                <div id="photoType" style="margin-bottom:10px;">
                  <div id="selectPhoto" class="editorInputFloat editorInputMargin">
                    Photo Type:
                  </div>
