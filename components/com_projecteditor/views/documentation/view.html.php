...
$firephp->log('com_projecteditor/documentation/view.html.php');
*/

class ProjectEditorViewDocumentation extends JView{

  function display($tpl = null){
    /* @var $oModel ProjectEditorModelDocumentation */
    ...
    if(!$oExperiment){
      ...
      $strSubTab = JRequest::getVar('subtab', 'documentation');
      ...
      $strPath = $oProject->getPathname() ."/Documentation";
...
//      $this->assignRef( "strSubTabs", $strSubTabHtml );
      ...
      $strPath = $oExperiment->getPathname() ."/Documentation";
    ...
    JFactory::getApplication()->getPathway()->addItem("Documentation","javascript:void(0)");
