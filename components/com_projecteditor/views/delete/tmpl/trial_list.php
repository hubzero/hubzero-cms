...
<form id="frmPopout" action="/warehouse/projecteditor/removeentity" method="post">
    ...
    <div class="information"><b><?php echo $this->className; ?>:</b> List of Trials</div>

    <table style="border:0px">
      <tr>
        <td colspan="2">
          Showing <?php echo $this->iDataFileCount; ?> trials.
          <div id="deleteLog">
            <table style="border:0px">
              <thead>
                <th>Trial</th>
      ...
      <tr>
        <td colspan="2">
          ...
          ?>
            ...
            I agree with deleting the trials.  Selecting the checkbox, shows the delete button.

            <!--
            We are unable to delete the repetitions until <b><u>ALL</u></b> files have been removed.
            -->
          <? } ?>
