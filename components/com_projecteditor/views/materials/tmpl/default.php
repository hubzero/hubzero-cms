...
<div class="innerwrap">
  ...
  <div id="warehouseWindow" style="padding-top:20px;">
    <div id="title" style="padding-bottom:1em;">
      <span style="font-size:16px;font-weight:bold;"><? echo $oExperiment->getProject()->getTitle(); ?></span>
    </div>
          ...
          <table cellpadding="1" cellspacing="1" style="border-bottom:0px;border-top:0px;margin-top:20px;">
            <tr id="specimenMaterial">
              <td nowrap>
                ...
                <p>
                  <a href="javascript:void(0);" onClick="document.getElementById('materialErrors').innerHTML='';getMootools('/warehouse/projecteditor/editmaterial?format=ajax&projectId=<?php echo $iProjectId; ?>&experimentId=<?php echo $iExperimentId; ?>', 'experimentInfo')">New Material</a>
                </p>
              </td>
              <td width="100%">
                <div id="experimentInfo" class="editorInputSizeFull2">
