...
class ProjectEditorViewDocuments extends JView{

  function display($tpl = null){
    /* @var $oModel ProjectEditorModelDocuments */
    ...
    if(!$oExperiment){
      ...
      $strSubTab = JRequest::getVar('subtab', 'documents');
      ...
      $strPath = $oProject->getPathname() ."/Documents";
      ...
      $strPath = $oExperiment->getPathname() ."/Documents";
