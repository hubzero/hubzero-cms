...
class ProjectEditorViewCurateConfirmProject extends JView{
	
  function display($tpl = null){
    /*
     * 1. Get the current model
     */
    /* @var $oPreviewModel ProjectEditorModelCurateConfirmProject */
    ...
    $oNCCuratedObject = unserialize($_SESSION[NCCuratedObjectsPeer::TABLE_NAME]);
    ...
    $this->assignRef( "strTitle", $oNCCuratedObject->getTitle() );
    $this->assignRef( "strShortTitle", $oNCCuratedObject->getShortTitle() );
    $this->assignRef( "strDescription", $oNCCuratedObject->getDescription() );
    $this->assignRef( "strCurationState", $oNCCuratedObject->getCurationState() );
    $this->assignRef( "strConformanceLevel", $oNCCuratedObject->getConformanceLevel() );
    $this->assignRef( "strObjectStatus", $oNCCuratedObject->getObjectStatus() );
    $this->assignRef( "strCreationDate", $oNCCuratedObject->getCreationDate() );
