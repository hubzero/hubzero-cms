      ...
      <div class="withleft">
        <div class="aside">
          <ul>
            ...
            <li><a href="/warehouse/projecteditor/project/<?php echo $oProject->getId(); ?>/moreanalysis" class="new-message"><span>Analysis</span></a></li>
            <li class="active"><a href="/warehouse/projecteditor/project/<?php echo $oProject->getId(); ?>/moredocs" class="new-message"><span>Documents</span></a></li>
          </ul>
        </div><!-- / .aside -->
        <div class="subject">
