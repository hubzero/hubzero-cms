...
<?php 
  ...
  $strAction = "/warehouse/projecteditor/project/".$oProject->getId()."/analysis";
  if($oExperiment){
    $strAction = "/warehouse/projecteditor/project/".$oProject->getId()."/experiment/".$oExperiment->getId()."/analysis";
  }
            ...
            <tr id="drawings">
              <td nowrap>
                <p class="editorParagraph">
                  <label for="actags" class="editorLabel">Analysis:</label>
                  <a style="border-bottom:0px;" href="#" onclick="return false;"
                     class="Tips3" title="Analysis :: Please provide analysis documents related to the project or experiment.">
                     <img alt="" src="<?php echo $this->baseurl."/templates/fresh/images/icons/helptab.png" ?>" />
                  </a>
                </p>
                <p><a title="Upload analysis file" class="modal" href="/warehouse/projecteditor/uploadform?format=ajax&projid=<?php echo $this->iProjectId; ?>&experimentId=<?php echo $this->iExperimentId; ?>&path=<?php echo $this->strPath; ?>&uploadType=<?php echo $this->uploadType; ?>">Upload File</a></p>
              </td>
              <td width="100%">
