                    ...
                    <?php
                      ...
                      ?>
                        <tr class="<?php echo $strBgColor; ?>">
                          ...
                          <td nowrap>[<a class="modal" href="/warehouse/projecteditor/editanalysis?format=ajax&projectId=<?php echo $this->iProjectId; ?>&experimentId=<?php echo $this->iExperimentId; ?>&dataFileId=<?php echo $oDataFile->getId(); ?>&path=<?php echo get_friendlyPath($strPath); ?>&requestType=<?php echo $this->uploadType; ?>">Edit</a>]&nbsp&nbsp;<!--[Delete]--></td>
                        </tr>
                      <?php
                      }
                    ?>
