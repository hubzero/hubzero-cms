                    ...
                    <?php
                      ...
                      ?>
                        <tr class="<?php echo $strBgColor; ?>">
                          ...
                          <td><a title="<?php echo $oDataFile->getFriendlyPath(); ?>" href="<?php echo $strDocumentUrl; ?>"><?php echo $strTitle; ?></a></td>
                          ...
                          <td nowrap>
                            [<a class="modal" href="/warehouse/projecteditor/editvideo?format=ajax&projectId=<?php echo $this->iProjectId; ?>&experimentId=<?php echo $this->iExperimentId; ?>&dataFileId=<?php echo $oDataFile->getId(); ?>&path=<?php echo get_friendlyPath($strPath); ?>&requestType=<?php echo $this->uploadType; ?>&return=<?php echo $this->strReturnUrl; ?>&index=<?php echo $this->iPageIndex; ?>&display=<?php echo $this->iDisplay; ?>">Edit</a>]&nbsp&nbsp;
