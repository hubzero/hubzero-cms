...
class ProjectEditorViewSecurity extends JView{
	
  function display($tpl = null){
    /* @var $oModel ProjectEditorModelSecurity */
    ...
    JFactory::getApplication()->getPathway()->addItem("Security","javascript:void(0)");
