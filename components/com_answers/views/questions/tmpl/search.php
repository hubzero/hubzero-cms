						...
						<tr<?php echo ($cls) ? ' class="'.$cls.'"' : ''; ?>>
							...
							<?php } ?>
								<span class="entry-details">
									...
									<span class="entry-time"><time datetime="<?php echo $row->created; ?>"><?php echo JHTML::_('date', $row->created, ANSWERS_TIME_FORMAT, ANSWERS_DATE_TIMEZONE); ?></time></span> <span class="entry-date-on"><?php echo JText::_('COM_ANSWERS_DATETIME_ON'); ?></span> 
									<span class="entry-date"><time datetime="<?php echo $row->created; ?>"><?php echo JHTML::_('date', $row->created, ANSWERS_DATE_FORMAT, ANSWERS_DATE_TIMEZONE); ?></time></span>
