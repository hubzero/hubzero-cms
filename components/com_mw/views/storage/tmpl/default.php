...
<div id="content-header">
	<h2><?php echo JText::_('MW_STORAGE_MANAGEMENT'); ?></h2>
</div><!-- / #content-header -->

<div id="content-header-extra">
<?php 
echo MwHtml::writeMonitor($this->percentage, '', 0, 0, 0, 0);
...
<?php if ($this->exceeded) { ?>
		<p class="warning"><?php echo JText::_('MW_ERROR_STORAGE_EXCEEDED'); ?></p>
<?php } ?>
