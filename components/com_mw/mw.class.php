...
class MwSession extends JTable 
{
	...
	function load( $sess=null, $username=null ) 
	{
		if ($sess == null) {
			$sess = $this->sessnum;
		}
	...
	function loadSession( $sess=null, $authorized=null ) 
	{
		if ($sess == null) {
			$sess = $this->sessnum;
		}
	...
	function checkSession($sess=null, $authorized=null) 
	{
		if ($sess == null) {
			$sess = $this->sessnum;
		}
	...
	function getCount( $username=NULL, $appname=NULL ) 
	{
		if ($username == null) {
	...
	function getRecords( $username=null, $appname=null, $authorized=null) 
	{
		if ($username == null) {
			$username = $this->username;
		}
...
class MwViewperm extends JTable 
{
	...
	function loadViewperm( $sess=null, $username=null ) 
	{
		if ($sess == null) {
			$sess = $this->sessnum;
		}
	...
	function deleteViewperm( $sess=null, $username=null )
	{
		if ($sess == null) {
			$sess = $this->sessnum;
		}
...
class MiddlewareApp 
{
	...
	function MiddlewareApp( $a,$g,$d,$h,$u,$t,$c,$desc ) 
	{
		$this->appname  = $a; 
		$this->geometry = $g; 
		$this->depth    = $d;
