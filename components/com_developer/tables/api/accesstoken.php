...
/**
 * Developer access token table class
 */
class AccessToken extends \JTable
{
	/**
	 * Constructor
	 * 
	...
	{
		parent::__construct('#__developer_access_tokens', 'id', $db);
	}
	...
	public function _buildQuery($filters = array())
	{
		...
		{
			$where[] = "access_token=" . $this->_db->quote( $filters['access_token'] );
		}
