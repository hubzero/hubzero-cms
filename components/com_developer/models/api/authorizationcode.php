...
require_once dirname(dirname(__DIR__)) . DS . 'tables' . DS . 'api' . DS . 'authorizationcode.php';
...
class AuthorizationCode extends Model
{
	 ...
	 * @var  string
	 */
	protected $_tbl_name = '\\Components\\Developer\\Tables\\Api\\AuthorizationCode';
