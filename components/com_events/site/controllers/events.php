...
class Events extends SiteController
{
	...
	public function execute()
	{
		...
		$this->_task = ($this->_task) ? $this->_task : Request::getString('task', $this->config->getCfg('startview'));
	...
	public function detailsTask()
	{
		...
		$row->content = preg_replace_callback("/$UrlPtrn/", array('\Components\Events\Helpers\Html', 'autolink'), trim(stripslashes($row->content)));
