...
<header id="content-header">
	...
	<div id="content-header-extra">
		<p>
			<a href="<?php echo JRoute::_('index.php?option=' . $this->option); ?>" class="icon-store storefront btn"><?php echo JText::_('COM_STORE_STOREFRONT'); ?></a>
			<a class="icon-points mypoints btn" href="<?php echo JRoute::_('index.php?option=com_members&id=' . $this->juser->get('id') . '&active=points'); ?>"><?php echo JText::_('COM_STORE_MY_POINTS'); ?></a>
		</p>
