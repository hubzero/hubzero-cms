  ...
  <div id="warehouseWindow" style="padding-top:20px;">
    ...
    <div id="overview_section" class="main section" style="width:100%;float:left;">
      ...
      <div class="withleft">
        <div class="aside">
          <ul>
            <li><a href="/warehouse/more/<?php echo $oProject->getId(); ?>" class="sent"><span>Images</span></a></li>
            <li class="active"><a href="/warehouse/moreanalysis/<?php echo $oProject->getId(); ?>" class="new-message"><span>Analysis</span></a></li>
              ...
              <?php
                ...
                foreach($oDocumentDataFileArray as $iFileIndex=>$oDataFile){
                  ...
                  <tr class="<?php echo $strRow; ?>">
                    ...
                    <td>
                      <?php if($oExperiment): ?>
                        <a href="/warehouse/experiment/<?php echo $oExperiment->getId(); ?>/project/<?php echo $oProject->getId(); ?>" class="Tips3" title="<?php echo $oExperiment->getName(); ?> :: <?php echo $oExperiment->getTitle(); ?>"><?php echo $oExperiment->getTitle(); ?></a>
                      <?php endif; ?>
                    </td>
                    <td>
                      <?php if($oTrial){
