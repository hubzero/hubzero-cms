    ...
    switch($strSubTab){
      ...
      default:
        ...
        if($strTool != "None" && $strTool != ""){
          ...
          $iDataFileTotal = $oDataModel->findDataFilesCount( $iProjectId, $iExperimentId, $iTrialId );
          $strDataFileArray = $oDataModel->findDataFiles( $iLowerLimit, $iUpperLimit, $iProjectId, $iExperimentId, $iTrialId);
