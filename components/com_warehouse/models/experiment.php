...
class WarehouseModelExperiment extends WarehouseModelBase{
  ...
  public function findAdditionalExperimentPhoto($p_iProjectId, $p_iExperimentId, $p_iTrialId=0, $p_iRepetitionId=0, $p_iLowerLimit=0, $p_iUpperLimit = 24){
    return DataFilePeer::findAdditionalExperimentPhoto($p_iProjectId, $p_iExperimentId, $p_iTrialId, $p_iRepetitionId, $p_iLowerLimit, $p_iUpperLimit);
  }

  public function findAdditionalExperimentPhotoCount($p_iProjectId, $p_iExperimentId, $p_iTrialId=0, $p_iRepetitionId=0) {
    return DataFilePeer::findAdditionalExperimentPhotoCount($p_iProjectId, $p_iExperimentId, $p_iTrialId, $p_iRepetitionId);
  }
}
