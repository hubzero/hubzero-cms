...
<form action="<?php echo Route::url('index.php?option=com_members&controller=import&task=save'); ?>" method="post" name="adminForm" id="item-form" enctype="multipart/form-data">
	<div class="col width-60 fltlft">
		<fieldset class="adminform">
			...
			<div class="input-wrap">
				<label for="field-name"><?php echo Lang::txt('COM_MEMBERS_IMPORT_EDIT_FIELD_NAME'); ?></label>
		...
		<fieldset class="adminform">
			...
			<div class="input-wrap" data-hint="<?php echo Lang::txt('COM_MEMBERS_IMPORT_EDIT_FIELD_EMAILNEW_HINT'); ?>">
				...
				<select name="params[emailnew]" id="param-emailnew">
					<option value="0"<?php echo ($this->params->get('emailnew', 1) == 0) ? ' selected="selected"' : ''; ?>><?php echo Lang::txt('JNO'); ?></option>
					<option value="1"<?php echo ($this->params->get('emailnew', 1) == 1) ? ' selected="selected"' : ''; ?>><?php echo Lang::txt('JYES'); ?></option>
				</select>
	...
	<div class="col width-40 fltrt">
		...
		<fieldset class="adminform">
			...
			<div class="input-wrap" data-hint="<?php echo Lang::txt('COM_MEMBERS_IMPORT_EDIT_FIELD_DATA_MODE_HINT'); ?>">
				...
				<select name="import[mode]" id="field-importmode" disabled="disabled">
					...
					<option <?php if ($this->import->get('mode') == Lang::txt('COM_MEMBERS_IMPORT_EDIT_FIELD_DATA_MODE_PATCH')) { echo 'selected="selected"'; } ?> value="PATCH">
