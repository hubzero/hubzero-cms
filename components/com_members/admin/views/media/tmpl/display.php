		...
		<table class="formed">
			...
			if ($this->file && file_exists($this->path . DS . $this->file))
			{
				...
				<tr>
					...
					<td><a href="<?php echo Route::url('index.php?option=' . $this->option . '&controller=' . $this->controller . '&tmpl=component&task=remove&file=' . $this->file . '&id=' . $this->id . '&' . JUtility::getToken() . '=1'); ?>">[ <?php echo Lang::txt('JACTION_DELETE'); ?> ]</a></td>
				</tr>
			<?php } else { ?>
				<tr>
					<td colspan="4">
