...
<header id="content-header">
	<h2><?php echo JText::_('COM_MEMBERS_CREDENTIALS_REMIND'); ?></h2>
</header>

<section class="main section">
	<form action="<?php echo JRoute::_('index.php?option=com_members&controller=credentials&task=reminding'); ?>" method="post" name="hubForm" id="hubForm">
		<div class="explaination">
			<p class="info">
				If you already know your username, and only need your password reset,
				<a href="<?php echo JRoute::_('index.php?option=com_members&task=reset'); ?>">go here now</a>.
			</p>
		</div>
		<fieldset>
			...
			<p>
				<?php echo JText::_('COM_MEMBERS_CREDENTIALS_REMIND_EMAIL_DESCRIPTION'); ?>
			</p>
			<label for="email">
				<?php echo JText::_('COM_MEMBERS_CREDENTIALS_REMIND_EMAIL_LABEL'); ?>:
			...
			<div class="help">
				...
				<p>
					...
					<a href="<?php echo JRoute::_('index.php?option=com_members&task=reset'); ?>">password reset page</a>.
				</p>
