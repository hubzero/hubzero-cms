...
$path = rtrim($this->config->get("webpath"), "/") . DS . $uid . DS;
...
<div id="ajax-upload-container">
	<form action="index.php" method="post" enctype="multipart/form-data">
		...
		<div id="ajax-upload-left">
			<img id="picture-src" src="<?php echo $picture->src; ?>" alt="<?php echo $picture->name; ?>" data-default-pic="<?php echo $this->config->get("defaultpic"); ?>" />
			<?php if($this->profile->get("picture") != "") : ?>
			<a href="#" id="remove-picture">[Remove Picture]</a>
			<?php endif; ?>
		</div><!-- /#ajax-upload-left -->
		<div id="ajax-upload-right">
			<div id="ajax-uploader" data-action="/members/<?php echo $this->profile->get("uidNumber"); ?>/doajaxupload?no_html=1"></div>
			<table>
				<tbody>
					<tr>
