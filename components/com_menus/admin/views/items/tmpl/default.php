	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="5%">
					<?php echo $this->grid('sort', 'COM_MENUS_HEADING_HOME', 'a.home', $listDirn, $listOrder); ?>
				</th>
				<?php
				...
				?>
				<th width="5%">
					<?php echo $this->grid('sort', 'COM_MENUS_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
				</th>
				<?php endif;?>
				<th width="5%">
