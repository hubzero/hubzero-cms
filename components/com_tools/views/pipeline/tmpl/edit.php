...
<?php if ($this->id) { ?>
					...
					<?php if (isset($this->defaults['published']) && $this->defaults['published']) { ?>
						<a href="<?php echo JRoute::_('index.php?option=' . $this->option . '&controller=' . $this->controller . '&task=versions&app=' . $this->defaults['toolname']); ?>"><?php echo JText::_('ALL_VERSIONS'); ?></a>
					<?php } ?>
<?php } else { ?>
