...
<?php } ?>
		...
		<div id="app-content" class="<?php if ($readOnly) { echo 'view-only'; } ?>">
			...
			<applet id="theapp" class="thisapp<?php if (!empty($cls)) { echo ' ' . implode(' ', $cls); } ?>" code="VncViewer.class" archive="/components/com_tools/scripts/VncViewer-20150319-01.jar" width="<?php echo $this->output->width; ?>" height="<?php echo $this->output->height; ?>" MAYSCRIPT>
			...
			{
				var jar = "/components/com_tools/scripts/VncViewer-20150319-01.jar",
