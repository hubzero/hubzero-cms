...
class NewsfeedsController extends JControllerLegacy
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		// Load the submenu.
		NewsfeedsHelper::addSubmenu(Request::getCmd('view', 'newsfeeds'));

		$view		= Request::getCmd('view', 'newsfeeds');
		...
		if ($view == 'newsfeed' && $layout == 'edit' && !$this->checkEditId('com_newsfeeds.edit.newsfeed', $id)) {
			...
			$this->setRedirect(Route::url('index.php?option=com_newsfeeds&view=newsfeeds', false));
