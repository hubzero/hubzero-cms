...
<div id="content-header-extra">
	<p><a href="<?php echo JRoute::_('index.php?option=' . $this->option . '&section=' . $this->section->alias . '&category=' . $this->category->alias); ?>"><?php echo JText::_('&larr; All discussions'); ?></a></p>
</div>
<div class="clear"></div>
