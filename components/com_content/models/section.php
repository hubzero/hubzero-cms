...
class ContentModelSection extends JModel
{
	...
	function _buildQuery($state = 1)
	{
		...
		$query = 'SELECT a.id, a.title, a.alias, a.title_alias, a.introtext, a.fulltxt, a.sectionid, a.state, a.catid, a.created, a.created_by, a.created_by_alias, a.modified, a.modified_by,' .
				...
				' CHAR_LENGTH( a.`fulltxt` ) AS readmore, u.name AS author, u.usertype, cc.title AS category, g.name AS groups, u.email as author_email'.$voting['select'] .
				' FROM #__content AS a' .
