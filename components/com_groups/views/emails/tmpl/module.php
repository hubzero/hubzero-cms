														...
														<table style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
															<tbody>
																...
																<tr>
																	...
																	<td style="text-align: left; padding: 0 0.5em;" align="left">@ <?php echo JHTML::_('date', $this->object->get('created'), JText::_('TIME_FORMAT_HZ1')); ?> on <?php echo JHTML::_('date', $this->object->get('created'), JText::_('DATE_FORMAT_HZ1')); ?></td>
																</tr>
																<tr>
																	...
																	<td style="text-align: left; padding: 0 0.5em;" align="left">
																		<?php 
																			$profile = Hubzero_User_Profile::getInstance( $this->object->get('created_by') ); 
															...
															<tbody>
																...
																<tr>
																	<td style="text-align: left;font-weight: bold;" align="left">
																		<?php echo JText::_('Module Content:'); ?>
																	</td>
																</tr>
																<tr>
