...
$message  = JText::sprintf('COM_GROUPS_EMAIL_MEMBERSHIP_CANCELLED_DETAILS',$this->sitename)."\n\n";
$message .= "\t".' '.JText::_('COM_GROUPS_GROUP').': '. $this->group->get('description') .' ('.$this->group->get('cn').')'."\n";
$message .= "\t".' '.JText::_('COM_GROUPS_EMAIL_MEMBERSHIP_CANCELLED').':'."\n";
$message .= "\t\t". $this->juser->get('name')."\n";
$message .= "\t\t". $this->juser->get('username') .' ('. $this->juser->get('email') . ')'."\n\n";
$message .= JText::_('COM_GROUPS_EMAIL_MEMBERSHIP_CANCELLED_LINK')."\n";
