...
<div id="features_banner">
	...
	<div id="banner_screen_shot">
		<img src="/components/com_groups/images/new_group_banner.png">
	</div>
</div>
...
<div class="section features">
	...
	<div class="four columns second third fourth">
		<div class="three columns first">
			<p><a class="screenshot" href="/components/com_groups/images/screen_shot1.jpg"><img src="/components/com_groups/images/screen_shot1.jpg" alt="New Group Design" width="100%" /></a></p>
		</div><!-- / .three columns first -->
		<div class="three columns second">
			<p><a class="screenshot" href="/components/com_groups/images/screen_shot2.jpg"><img src="/components/com_groups/images/screen_shot2.jpg" alt="New Group Design" width="100%" /></a></p>
		</div><!-- / .two columns second -->
		<div class="three columns third">
			<p><a class="screenshot" href="/components/com_groups/images/screen_shot3.jpg"><img src="/components/com_groups/images/screen_shot3.jpg" alt="New Group Design" width="100%" /></a></p>
		</div><!-- / .two columns second -->
	...
	<div class="four columns second third fourth">
		<div class="two columns first">
			...
			<p><img src="/components/com_groups/images/group_identity.png" width="50%" /></p>
		</div><!-- / .three columns first -->
