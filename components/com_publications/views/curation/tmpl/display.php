...
<div class="main section curation">
	...
	<div class="container">
		<ul class="entries-menu filter-options">
			<li><a<?php echo ($this->filters['curator'] != 'owner') ? ' class="active"' : ''; ?> href="<?php echo JRoute::_($route); ?>" title="All">All</a></li>
			<li><a<?php echo ($this->filters['curator'] == 'owner') ? ' class="active"' : ''; ?> href="<?php echo JRoute::_($route . '&assigned=1'); ?>" title="Assigned to me">Assigned to me</a></li>
		</ul>
