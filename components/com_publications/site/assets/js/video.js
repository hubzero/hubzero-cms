...
HUB.Video = {
	...
	{    
		...
		if( paused ) {
			$jQ("#play-pause").css('background','url(/components/com_resources/site/assets/img/pause.png)'); 
			if( click ) 
				player.play();
		} else {
			$jQ("#play-pause").css('background','url(/components/com_resources/site/assets/img/play.png)');
			if( click )
				player.pause();
		}  
	},
