 ...
 */
class JoomdleViewassignment extends JView {
	...
	$this->assignRef('params', $params);
	 ...
	 $id = $params->get( 'assignment_id' );
	 if (!$id)
		 $id =  JRequest::getVar( 'assignment_id' );

	 $id = (int) $id;
	
	$this->assignment_info = JoomdleHelperContent::getSCORMQuizInfo($id);
	...
	$document->setTitle($this->assignment_info['fullname']);
