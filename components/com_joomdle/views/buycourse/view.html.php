 ...
 */
class JoomdleViewBuycourse extends JView {
	...
	$link = urlencode ("index.php?option=com_joomdle&view=buycourse&Itemid=$itemid");
	/* If user is logged, dont redirect */
	if (!$user_id)
	{
		$mainframe->redirect(JURI::base ()."index.php?option=com_user&view=register&link=$link");
	}
