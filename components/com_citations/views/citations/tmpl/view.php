				...
				<?php if($config->get('citation_openurl', 1)) : ?>
					<tr>
						...
						<td>
							...
							<p>If your local public or college library does not have this item in its collection, you may be able to request a copy through a service called "Interlibrary Load." Why not give them a call to see if they can help you?</p>
