			...
			<div id="page_sidebar">
				...
				<div id="page_identity">
					<a href="<?php echo $link; ?>" title="<?php echo $this->course->get('description'); ?> Home">
						<img src="<?php echo $src; ?>" alt="<?php echo $this->course->get('description'); ?> Logo" />
					</a>
				</div><!-- /#page_identity -->
				...
				<div id="page_info">
					<?php 
						...
						// Get the course creation date
						$gl = new XCourseLog( $database );
						$gl->getLog( $this->course->get('gidNumber'), 'first' );
