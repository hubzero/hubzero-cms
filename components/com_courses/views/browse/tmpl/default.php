...
<div id="content-header-extra">
	<ul id="useroptions">
		<li class="last"><a class="add" href="<?php echo JRoute::_('index.php?option='.$this->option.'&task=new'); ?>"><?php echo JText::_('COURSES_CREATE_COURSE'); ?></a></li>
	</ul>
...
<form action="<?php echo JRoute::_('index.php?option='.$this->option.'&task=browse'); ?>" method="get">
	<div class="main section">
		<div class="aside">
			<div class="container">
				<h3>Member Courses</h3>
				<p class="starter"><span class="starter-point"></span>When people create a course it will appear here.</p>
				<p>Use the sorting and filtering options to see courses listed alphabetically by their title, by their alias, or join policy.</p>
				<p>Use the 'Search' to find specific courses if you would like to check out their contributions or possibly join them.</p>
			</div><!-- / .container -->
