...
<form name="coursePages" action="index.php" method="POST" id="hubForm">
	<div class="explaination">
		<p>This is where you can manage any of your courses custom content pages. There is no limit to the number of custom pages and pages can contain text, images, links to files. The pages support wiki syntax that is used throughout the hub.</p>
		<p><a class="add" href="<?php echo JRoute::_($base_link.'&sub_task=add_page'); ?>">Add a New Course Page</a></p>
	</div>
	<fieldset>
		<h3>Manage Pages</h3>
		...
		<fieldset>
			...
			<table>
				...
				<?php } else { ?>
					<tr>
						<td colspan="7">Currently this course does not have an inactive pages.</td>
					</tr>
				<?php } ?>
			</table>
		</fieldset>
