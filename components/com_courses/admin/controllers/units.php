 ...
 */
class CoursesControllerUnits extends \Hubzero\Component\AdminController
{
	/**
	 * Execute a task
	 *
	...
	public function copyTask()
	{
		...
		if (!$unit->copy())
		{
			...
			$this->setRedirect(
				JRoute::_('index.php?option=' . $this->_option . '&controller=' . $this->_controller . '&offering=' . $unit->get('offering_id'), false),
