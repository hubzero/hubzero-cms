 ...
 * 
 */
class CoursesInstance extends JTable
{
	...
	public function buildQuery($filters=array())
	{
		...
		$query .= " INNER JOIN #__courses AS c ON c.gidNumber=ci.course_id";

		$where = array();

		if (isset($filters['course_cn']) && $filters['course_cn']) 
		{
			$where[] = "c.cn=" . $this->_db->Quote($filters['course_cn']);
		}
		else if (isset($filters['course_id']) && $filters['course_id']) 
		{
			$where[] = "c.gidNumber=" . $this->_db->Quote($filters['course_id']);
		}
