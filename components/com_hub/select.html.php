...
<form action="" method="post" id="hubForm">
	<div class="explaination">
		<p>Registering at <?php echo $hubShortName; ?> is easy: just sign in using an account you may already have
		at one of the listed sites/organizations or create a new <?php echo $hubShortName; ?> account.</p>
	...
	<fieldset>
		<br />
		<h3>Register with <br /><?php echo $hubShortName; ?></h3>
		<fieldset>
		...
		<fieldset>
			<br />
			<legend>Create a separate account for <?php echo $hubShortName; ?></legend>
			<p style="text-align:center;margin: 1em 0 0 0;">
