...
require_once(JPATH_COMPONENT_ADMINISTRATOR . DS . 'tables' . DS . 'custom.php');
require_once(JPATH_COMPONENT_ADMINISTRATOR . DS . 'tables' . DS . 'result.php');
require_once(JPATH_COMPONENT_ADMINISTRATOR . DS . 'tables' . DS . 'sets.php');
