...
<form id="frmProjects" action="#" method="post">
  <div class="contentpaneopen heading">
    ...
    <div style="width: 100%; padding-bottom: 20px;" id="viewWrapper">
      <div style="float: left;" id="optionHeading">
        <a onclick="javascript: history.go(-1);" href="javascript:void(0);">Return</a>
      </div>
  ...
  <input type="hidden" name="projectName" value="<?php echo $oProjectArray['PROJECT_NAME']; ?>"/>
  
  <div id="introduction" class="section">
    <div id="projectTop">
      <div id="projectTitle" style="font-size:16px;float:left;">
        <?php echo $oProjectArray['PROJECT_TITLE']; ?>
        <input type="hidden" id="txtProjectTitle" name="txtProjectTitle" value="<?php echo $oProjectArray['PROJECT_TITLE']; ?>"/>
      </div>
      <div id="projectButton" style="float: left; right: 0pt; position: absolute; padding-right: 25px;">
        <?php if($oProjectArray['CURATED_ID'] == 0): ?>
          <input type="button" id="btnSubmitObject" value="Submit Project" onClick="validateObject('frmProjects', '/curate?task=project');"/>
        <?php endif; ?> 
      </div>
      <div class="clear"></div>
    </div>
    ...
    <div id="projectInfo" style="100%">
      ...
      <div id="projectContactName" class="projectInfoColumn">
        Name: <?php echo $this->contactNameAjax; ?>
      </div>
  ...
  <div class="main section">
    <div id="documentsTitle" style="float:left;">
      ...
      <a href="javascript:void(0);" onClick="curateAll(<?php echo sizeof($oProjectDocumentArray); ?>);">Select All</a> | 
      <a href="javascript:void(0);" onClick="completeAll(<?php echo sizeof($oProjectDocumentArray); ?>)">Complete All</a>
    </div>  
    <div id="buttons" align="right">
      <input type="button" id="btnDownload" value="Download" onClick="validateDownload('frmProjects', '/curate?task=download', <?php echo sizeof($oProjectDocumentArray); ?>);" style="margin-right:15px;"/>
      <input type="button" id="btnSubmit" value="Submit Documents" onClick="validateDocuments('frmProjects', '/curate?task=documents', <?php echo sizeof($oProjectDocumentArray); ?>);"/>
    </div>
    <div class="clear"></div>
