...
class JString
{
	 ...
	 */
	static function strpos($str, $search, $offset = FALSE)
	{
		if ( $offset === FALSE ) {
	 ...
	 */
	static function strrpos($str, $search){
	 ...
	 */
	static function substr($str, $offset, $length = FALSE)
	{
		if ( $length === FALSE ) {
	...
	*/
	static function ltrim( $str, $charlist = FALSE )
	{
	...
	*/
	static function rtrim( $str, $charlist = FALSE )
	{
		jimport('phputf8.trim');
		if ( $charlist === FALSE ) {
	...
	*/
	static function trim( $str, $charlist = FALSE )
	{
		jimport('phputf8.trim');
		if ( $charlist === FALSE ) {
	...
	*/
	 ...
	 * @since 1.5
	 */
	static function transcode($source, $from_encoding, $to_encoding) {
